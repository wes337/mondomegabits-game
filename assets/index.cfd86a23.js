(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const d of document.querySelectorAll('link[rel="modulepreload"]'))c(d);new MutationObserver(d=>{for(const S of d)if(S.type==="childList")for(const N of S.addedNodes)N.tagName==="LINK"&&N.rel==="modulepreload"&&c(N)}).observe(document,{childList:!0,subtree:!0});function i(d){const S={};return d.integrity&&(S.integrity=d.integrity),d.referrerpolicy&&(S.referrerPolicy=d.referrerpolicy),d.crossorigin==="use-credentials"?S.credentials="include":d.crossorigin==="anonymous"?S.credentials="omit":S.credentials="same-origin",S}function c(d){if(d.ep)return;d.ep=!0;const S=i(d);fetch(d.href,S)}})();const nt={};function Ma(a){nt.context=a}const Oa=(a,r)=>a===r,pt=Symbol("solid-proxy"),In=Symbol("solid-track"),ln={equals:Oa};let na=sa;const st=1,un=2,aa={owned:null,cleanups:null,context:null,owner:null};var We=null;let dt=null,_e=null,$e=null,it=null,Mn=0;function sn(a,r){const i=_e,c=We,d=a.length===0,S=d?aa:{owned:null,cleanups:null,context:null,owner:r||c},N=d?a:()=>a(()=>ft(()=>Pn(S)));We=S,_e=null;try{return xt(N,!0)}finally{_e=i,We=c}}function rt(a,r){r=r?Object.assign({},ln,r):ln;const i={value:a,observers:null,observerSlots:null,comparator:r.equals||void 0},c=d=>(typeof d=="function"&&(d=d(i.value)),ra(i,d));return[ia.bind(i),c]}function Oe(a,r,i){const c=Nn(a,r,!1,st);Vt(c)}function Ht(a,r,i){na=La;const c=Nn(a,r,!1,st);c.user=!0,it?it.push(c):Vt(c)}function Me(a,r,i){i=i?Object.assign({},ln,i):ln;const c=Nn(a,r,!0,0);return c.observers=null,c.observerSlots=null,c.comparator=i.equals||void 0,Vt(c),ia.bind(c)}function Na(a){return xt(a,!1)}function ft(a){let r,i=_e;return _e=null,r=a(),_e=i,r}function yn(a){Ht(()=>ft(a))}function On(a){return We===null||(We.cleanups===null?We.cleanups=[a]:We.cleanups.push(a)),a}function oa(){return _e}function ia(){const a=dt;if(this.sources&&(this.state||a))if(this.state===st||a)Vt(this);else{const r=$e;$e=null,xt(()=>hn(this),!1),$e=r}if(_e){const r=this.observers?this.observers.length:0;_e.sources?(_e.sources.push(this),_e.sourceSlots.push(r)):(_e.sources=[this],_e.sourceSlots=[r]),this.observers?(this.observers.push(_e),this.observerSlots.push(_e.sources.length-1)):(this.observers=[_e],this.observerSlots=[_e.sources.length-1])}return this.value}function ra(a,r,i){let c=a.value;return(!a.comparator||!a.comparator(c,r))&&(a.value=r,a.observers&&a.observers.length&&xt(()=>{for(let d=0;d<a.observers.length;d+=1){const S=a.observers[d],N=dt&&dt.running;N&&dt.disposed.has(S),(N&&!S.tState||!N&&!S.state)&&(S.pure?$e.push(S):it.push(S),S.observers&&la(S)),N||(S.state=st)}if($e.length>1e6)throw $e=[],new Error},!1)),r}function Vt(a){if(!a.fn)return;Pn(a);const r=We,i=_e,c=Mn;_e=We=a,Pa(a,a.value,c),_e=i,We=r}function Pa(a,r,i){let c;try{c=a.fn(r)}catch(d){a.pure&&(a.state=st),ua(d)}(!a.updatedAt||a.updatedAt<=i)&&(a.updatedAt!=null&&"observers"in a?ra(a,c):a.value=c,a.updatedAt=i)}function Nn(a,r,i,c=st,d){const S={fn:a,state:c,updatedAt:null,owned:null,sources:null,sourceSlots:null,cleanups:null,value:r,owner:We,context:null,pure:i};return We===null||We!==aa&&(We.owned?We.owned.push(S):We.owned=[S]),S}function cn(a){const r=dt;if(a.state===0||r)return;if(a.state===un||r)return hn(a);if(a.suspense&&ft(a.suspense.inFallback))return a.suspense.effects.push(a);const i=[a];for(;(a=a.owner)&&(!a.updatedAt||a.updatedAt<Mn);)(a.state||r)&&i.push(a);for(let c=i.length-1;c>=0;c--)if(a=i[c],a.state===st||r)Vt(a);else if(a.state===un||r){const d=$e;$e=null,xt(()=>hn(a,i[0]),!1),$e=d}}function xt(a,r){if($e)return a();let i=!1;r||($e=[]),it?i=!0:it=[],Mn++;try{const c=a();return Ra(i),c}catch(c){$e||(it=null),ua(c)}}function Ra(a){if($e&&(sa($e),$e=null),a)return;const r=it;it=null,r.length&&xt(()=>na(r),!1)}function sa(a){for(let r=0;r<a.length;r++)cn(a[r])}function La(a){let r,i=0;for(r=0;r<a.length;r++){const c=a[r];c.user?a[i++]=c:cn(c)}for(nt.context&&Ma(),r=0;r<i;r++)cn(a[r])}function hn(a,r){const i=dt;a.state=0;for(let c=0;c<a.sources.length;c+=1){const d=a.sources[c];d.sources&&(d.state===st||i?d!==r&&cn(d):(d.state===un||i)&&hn(d,r))}}function la(a){const r=dt;for(let i=0;i<a.observers.length;i+=1){const c=a.observers[i];(!c.state||r)&&(c.state=un,c.pure?$e.push(c):it.push(c),c.observers&&la(c))}}function Pn(a){let r;if(a.sources)for(;a.sources.length;){const i=a.sources.pop(),c=a.sourceSlots.pop(),d=i.observers;if(d&&d.length){const S=d.pop(),N=i.observerSlots.pop();c<d.length&&(S.sourceSlots[N]=c,d[c]=S,i.observerSlots[c]=N)}}if(a.owned){for(r=0;r<a.owned.length;r++)Pn(a.owned[r]);a.owned=null}if(a.cleanups){for(r=0;r<a.cleanups.length;r++)a.cleanups[r]();a.cleanups=null}a.state=0,a.context=null}function Da(a){return a instanceof Error||typeof a=="string"?a:new Error("Unknown error")}function ua(a){throw a=Da(a),a}const Ba=Symbol("fallback");function Xn(a){for(let r=0;r<a.length;r++)a[r]()}function Ga(a,r,i={}){let c=[],d=[],S=[],N=0,T=r.length>1?[]:null;return On(()=>Xn(S)),()=>{let O=a()||[],G,H;return O[In],ft(()=>{let ne=O.length,le,ce,ve,ye,pe,he,be,Z,fe;if(ne===0)N!==0&&(Xn(S),S=[],c=[],d=[],N=0,T&&(T=[])),i.fallback&&(c=[Ba],d[0]=sn(Te=>(S[0]=Te,i.fallback())),N=1);else if(N===0){for(d=new Array(ne),H=0;H<ne;H++)c[H]=O[H],d[H]=sn(J);N=ne}else{for(ve=new Array(ne),ye=new Array(ne),T&&(pe=new Array(ne)),he=0,be=Math.min(N,ne);he<be&&c[he]===O[he];he++);for(be=N-1,Z=ne-1;be>=he&&Z>=he&&c[be]===O[Z];be--,Z--)ve[Z]=d[be],ye[Z]=S[be],T&&(pe[Z]=T[be]);for(le=new Map,ce=new Array(Z+1),H=Z;H>=he;H--)fe=O[H],G=le.get(fe),ce[H]=G===void 0?-1:G,le.set(fe,H);for(G=he;G<=be;G++)fe=c[G],H=le.get(fe),H!==void 0&&H!==-1?(ve[H]=d[G],ye[H]=S[G],T&&(pe[H]=T[G]),H=ce[H],le.set(fe,H)):S[G]();for(H=he;H<ne;H++)H in ve?(d[H]=ve[H],S[H]=ye[H],T&&(T[H]=pe[H],T[H](H))):d[H]=sn(J);d=d.slice(0,N=ne),c=O.slice(0)}return d});function J(ne){if(S[H]=ne,T){const[le,ce]=rt(H);return T[H]=ce,r(O[H],le)}return r(O[H])}}}function j(a,r){return ft(()=>a(r||{}))}function Ft(a){const r="fallback"in a&&{fallback:()=>a.fallback};return Me(Ga(()=>a.each,a.children,r||void 0))}function ze(a){let r=!1;const i=a.keyed,c=Me(()=>a.when,void 0,{equals:(d,S)=>r?d===S:!d==!S});return Me(()=>{const d=c();if(d){const S=a.children,N=typeof S=="function"&&S.length>0;return r=i||N,N?ft(()=>S(d)):S}return a.fallback})}function Ha(a,r){return Me(a,void 0,r?void 0:{equals:r})}function Fa(a,r,i){let c=i.length,d=r.length,S=c,N=0,T=0,O=r[d-1].nextSibling,G=null;for(;N<d||T<S;){if(r[N]===i[T]){N++,T++;continue}for(;r[d-1]===i[S-1];)d--,S--;if(d===N){const H=S<c?T?i[T-1].nextSibling:i[S-T]:O;for(;T<S;)a.insertBefore(i[T++],H)}else if(S===T)for(;N<d;)(!G||!G.has(r[N]))&&r[N].remove(),N++;else if(r[N]===i[S-1]&&i[T]===r[d-1]){const H=r[--d].nextSibling;a.insertBefore(i[T++],r[N++].nextSibling),a.insertBefore(i[--S],H),r[d]=i[S]}else{if(!G){G=new Map;let J=T;for(;J<S;)G.set(i[J],J++)}const H=G.get(r[N]);if(H!=null)if(T<H&&H<S){let J=N,ne=1,le;for(;++J<d&&J<S&&!((le=G.get(r[J]))==null||le!==H+ne);)ne++;if(ne>H-T){const ce=r[N];for(;T<H;)a.insertBefore(i[T++],ce)}else a.replaceChild(i[T++],r[N++])}else N++;else r[N++].remove()}}}const Jn="_$DX_DELEGATE";function Wa(a,r,i){let c;return sn(d=>{c=d,r===document?a():Y(r,a(),r.firstChild?null:void 0,i)}),()=>{c(),r.textContent=""}}function se(a,r,i){const c=document.createElement("template");c.innerHTML=a;let d=c.content.firstChild;return i&&(d=d.firstChild),d}function mt(a,r=window.document){const i=r[Jn]||(r[Jn]=new Set);for(let c=0,d=a.length;c<d;c++){const S=a[c];i.has(S)||(i.add(S),r.addEventListener(S,$a))}}function Wt(a,r,i){i==null?a.removeAttribute(r):a.setAttribute(r,i)}function Ke(a,r){r==null?a.removeAttribute("class"):a.className=r}function za(a,r,i,c){if(c)Array.isArray(i)?(a[`$$${r}`]=i[0],a[`$$${r}Data`]=i[1]):a[`$$${r}`]=i;else if(Array.isArray(i)){const d=i[0];a.addEventListener(r,i[0]=S=>d.call(a,i[1],S))}else a.addEventListener(r,i)}function Ct(a,r,i){return ft(()=>a(r,i))}function Y(a,r,i,c){if(i!==void 0&&!c&&(c=[]),typeof r!="function")return dn(a,r,c,i);Oe(d=>dn(a,r(),d,i),c)}function $a(a){const r=`$$${a.type}`;let i=a.composedPath&&a.composedPath()[0]||a.target;for(a.target!==i&&Object.defineProperty(a,"target",{configurable:!0,value:i}),Object.defineProperty(a,"currentTarget",{configurable:!0,get(){return i||document}}),nt.registry&&!nt.done&&(nt.done=!0,document.querySelectorAll("[id^=pl-]").forEach(c=>c.remove()));i!==null;){const c=i[r];if(c&&!i.disabled){const d=i[`${r}Data`];if(d!==void 0?c.call(i,d,a):c.call(i,a),a.cancelBubble)return}i=i.host&&i.host!==i&&i.host instanceof Node?i.host:i.parentNode}}function dn(a,r,i,c,d){for(nt.context&&!i&&(i=[...a.childNodes]);typeof i=="function";)i=i();if(r===i)return i;const S=typeof r,N=c!==void 0;if(a=N&&i[0]&&i[0].parentNode||a,S==="string"||S==="number"){if(nt.context)return i;if(S==="number"&&(r=r.toString()),N){let T=i[0];T&&T.nodeType===3?T.data=r:T=document.createTextNode(r),i=Tt(a,i,c,T)}else i!==""&&typeof i=="string"?i=a.firstChild.data=r:i=a.textContent=r}else if(r==null||S==="boolean"){if(nt.context)return i;i=Tt(a,i,c)}else{if(S==="function")return Oe(()=>{let T=r();for(;typeof T=="function";)T=T();i=dn(a,T,i,c)}),()=>i;if(Array.isArray(r)){const T=[],O=i&&Array.isArray(i);if(Cn(T,r,i,d))return Oe(()=>i=dn(a,T,i,c,!0)),()=>i;if(nt.context){if(!T.length)return i;for(let G=0;G<T.length;G++)if(T[G].parentNode)return i=T}if(T.length===0){if(i=Tt(a,i,c),N)return i}else O?i.length===0?Qn(a,T,c):Fa(a,i,T):(i&&Tt(a),Qn(a,T));i=T}else if(r instanceof Node){if(nt.context&&r.parentNode)return i=N?[r]:r;if(Array.isArray(i)){if(N)return i=Tt(a,i,c,r);Tt(a,i,null,r)}else i==null||i===""||!a.firstChild?a.appendChild(r):a.replaceChild(r,a.firstChild);i=r}}return i}function Cn(a,r,i,c){let d=!1;for(let S=0,N=r.length;S<N;S++){let T=r[S],O=i&&i[S];if(T instanceof Node)a.push(T);else if(!(T==null||T===!0||T===!1))if(Array.isArray(T))d=Cn(a,T,O)||d;else if(typeof T=="function")if(c){for(;typeof T=="function";)T=T();d=Cn(a,Array.isArray(T)?T:[T],Array.isArray(O)?O:[O])||d}else a.push(T),d=!0;else{const G=String(T);O&&O.nodeType===3&&O.data===G?a.push(O):a.push(document.createTextNode(G))}}return d}function Qn(a,r,i){for(let c=0,d=r.length;c<d;c++)a.insertBefore(r[c],i)}function Tt(a,r,i,c){if(i===void 0)return a.textContent="";const d=c||document.createTextNode("");if(r.length){let S=!1;for(let N=r.length-1;N>=0;N--){const T=r[N];if(d!==T){const O=T.parentNode===a;!S&&!N?O?a.replaceChild(d,T):a.insertBefore(d,i):O&&T.remove()}else S=!0}}else a.insertBefore(d,i);return[d]}const xn=Symbol("store-raw"),zt=Symbol("store-node"),Va=Symbol("store-name");function ca(a,r){let i=a[pt];if(!i&&(Object.defineProperty(a,pt,{value:i=new Proxy(a,Ka)}),!Array.isArray(a))){const c=Object.keys(a),d=Object.getOwnPropertyDescriptors(a);for(let S=0,N=c.length;S<N;S++){const T=c[S];if(d[T].get){const O=d[T].get.bind(i);Object.defineProperty(a,T,{get:O})}}}return i}function pn(a){let r;return a!=null&&typeof a=="object"&&(a[pt]||!(r=Object.getPrototypeOf(a))||r===Object.prototype||Array.isArray(a))}function $t(a,r=new Set){let i,c,d,S;if(i=a!=null&&a[xn])return i;if(!pn(a)||r.has(a))return a;if(Array.isArray(a)){Object.isFrozen(a)?a=a.slice(0):r.add(a);for(let N=0,T=a.length;N<T;N++)d=a[N],(c=$t(d,r))!==d&&(a[N]=c)}else{Object.isFrozen(a)?a=Object.assign({},a):r.add(a);const N=Object.keys(a),T=Object.getOwnPropertyDescriptors(a);for(let O=0,G=N.length;O<G;O++)S=N[O],!T[S].get&&(d=a[S],(c=$t(d,r))!==d&&(a[S]=c))}return a}function fn(a){let r=a[zt];return r||Object.defineProperty(a,zt,{value:r={}}),r}function _n(a,r,i){return a[r]||(a[r]=da(i))}function Ua(a,r){const i=Reflect.getOwnPropertyDescriptor(a,r);return!i||i.get||!i.configurable||r===pt||r===zt||r===Va||(delete i.value,delete i.writable,i.get=()=>a[pt][r]),i}function ha(a){if(oa()){const r=fn(a);(r._||(r._=da()))()}}function Ya(a){return ha(a),Reflect.ownKeys(a)}function da(a){const[r,i]=rt(a,{equals:!1,internal:!0});return r.$=i,r}const Ka={get(a,r,i){if(r===xn)return a;if(r===pt)return i;if(r===In)return ha(a),i;const c=fn(a),d=c.hasOwnProperty(r);let S=d?c[r]():a[r];if(r===zt||r==="__proto__")return S;if(!d){const N=Object.getOwnPropertyDescriptor(a,r);oa()&&(typeof S!="function"||a.hasOwnProperty(r))&&!(N&&N.get)&&(S=_n(c,r,S)())}return pn(S)?ca(S):S},has(a,r){if(r===xn||r===pt||r===In||r===zt||r==="__proto__")return!0;const i=fn(a)[r];return i&&i(),r in a},set(){return!0},deleteProperty(){return!0},ownKeys:Ya,getOwnPropertyDescriptor:Ua};function mn(a,r,i,c=!1){if(!c&&a[r]===i)return;const d=a[r],S=a.length;i===void 0?delete a[r]:a[r]=i;let N=fn(a),T;(T=_n(N,r,d))&&T.$(()=>i),Array.isArray(a)&&a.length!==S&&(T=_n(N,"length",S))&&T.$(a.length),(T=N._)&&T.$()}function pa(a,r){const i=Object.keys(r);for(let c=0;c<i.length;c+=1){const d=i[c];mn(a,d,r[d])}}function ja(a,r){if(typeof r=="function"&&(r=r(a)),r=$t(r),Array.isArray(r)){if(a===r)return;let i=0,c=r.length;for(;i<c;i++){const d=r[i];a[i]!==d&&mn(a,i,d)}mn(a,"length",c)}else pa(a,r)}function Gt(a,r,i=[]){let c,d=a;if(r.length>1){c=r.shift();const N=typeof c,T=Array.isArray(a);if(Array.isArray(c)){for(let O=0;O<c.length;O++)Gt(a,[c[O]].concat(r),i);return}else if(T&&N==="function"){for(let O=0;O<a.length;O++)c(a[O],O)&&Gt(a,[O].concat(r),i);return}else if(T&&N==="object"){const{from:O=0,to:G=a.length-1,by:H=1}=c;for(let J=O;J<=G;J+=H)Gt(a,[J].concat(r),i);return}else if(r.length>1){Gt(a[c],r,[c].concat(i));return}d=a[c],i=[c].concat(i)}let S=r[0];typeof S=="function"&&(S=S(d,i),S===d)||c===void 0&&S==null||(S=$t(S),c===void 0||pn(d)&&pn(S)&&!Array.isArray(S)?pa(d,S):mn(a,c,S))}function qa(...[a,r]){const i=$t(a||{}),c=Array.isArray(i),d=ca(i);function S(...N){Na(()=>{c&&N.length===1?ja(i,N[0]):Gt(i,N)})}return[d,S]}const Za={user:{id:"",name:""},connected:!1,lobby:[],room:null,rooms:{},game:void 0,focus:{current:null,hover:null,spotlight:null},target:{from:null,to:null},chatExpanded:!1,chatInput:""},on=new WebSocket("wss://mondo-megabits.herokuapp.com");function Ge(){const[a,r]=qa(Za),i=c=>{on.send(JSON.stringify(c))};return on.onopen=()=>{r({connected:!0}),setInterval(()=>{i({type:"ping"})},4e4)},on.onclose=()=>{r({connected:!1})},on.onmessage=c=>{const{type:d,params:S}=JSON.parse(c.data);switch(d){case"connected":{r({user:{name:"",id:S.id}});break}case"lobby":{r({lobby:S.users,room:null,rooms:S.otherRooms||[]});break}case"join":{const{roomCode:N,users:T}=S;r(O=>({lobby:O.lobby.filter(G=>G.id!==O.user.id),room:{code:N,users:T,chatMessages:O.room?.chatMessages||[]}}));break}case"leave":{const{userId:N}=S;r({room:N===a.user.id?null:{...a.room,users:a.room.users.filter(T=>T.id!==N)}});break}case"leave-game":{const{roomCode:N,users:T}=S;r({game:null,room:{code:N,users:T,chatMessages:a.room?.chatMessages||[]}});break}case"chat":{if(S.chatMessage.user.id!==a.user.id){r(N=>({room:{...N.room,chatMessages:[...N.room?.chatMessages||[],S.chatMessage]}}));break}break}case"ready":{const{userId:N,status:T}=S;r(O=>({room:{...O.room,users:O.room.users.map(G=>G.id!==N?G:{...G,status:T})}}));break}case"game":{const{game:N}=S;r({game:N});break}case"target":{const{target:N}=S;r({target:N});break}default:{console.log("Got unknown message type: ",d);break}}},{state:a,setState:r,sendMessage:i}}const Xa=se('<div class="connect"><div class="video"><video autoplay="true" loop="true" playsinline="true" muted><source type="video/mp4; codecs=&quot;av01.0.13M.10&quot;" src="https://cdn.mondomegabits.com/logo/Mondo flashing logo_r3 - strobe.mp4"></video></div><form><label>Puppet Master Handle:</label><input type="text" minlength="3" maxlength="30"><button class="connect-button button" type="submit">Connect</button></form></div>');function Ja(){let a;const{sendMessage:r,setState:i}=Ge(),[c,d]=rt(""),[S,N]=rt(!1);yn(()=>{a.focus()});const T=O=>{O.preventDefault();const G=c().trim().slice(0,30);if(G.length===0){N(!0);return}r({type:"lobby",params:{userName:G}}),i(H=>({user:{...H.user,name:G}}))};return(()=>{const O=Xa.cloneNode(!0),G=O.firstChild,H=G.nextSibling,J=H.firstChild,ne=J.nextSibling;H.addEventListener("submit",T),ne.addEventListener("change",ce=>d(ce.target.value));const le=a;return typeof le=="function"?Ct(le,ne):a=ne,Oe(()=>Ke(H,`puppet-master-handle-input${S()?" error":""}`)),Oe(()=>ne.value=c()),O})()}const Qa=se('<button type="button"><div class="circle"></div><div class="label"></div></button>');function It(a){const r=()=>{let i="circle-button button";return a.color&&(i+=` ${a.color}`),a.small&&(i+=" small"),a.disabled&&(i+=" disabled"),i};return(()=>{const i=Qa.cloneNode(!0),c=i.firstChild,d=c.nextSibling;return za(i,"click",a.onClick,!0),Y(d,()=>a.label),Oe(S=>{const N=r(),T=a.disabled;return N!==S._v$&&Ke(i,S._v$=N),T!==S._v$2&&(i.disabled=S._v$2=T),S},{_v$:void 0,_v$2:void 0}),i})()}mt(["click"]);const eo=se('<div class="modal"><div class="join-room panel"><form><label>Room code:</label><input type="text"><div class="modal-footer"><button class="button" type="submit">OK</button><button class="button" type="button">Cancel</button></div></form></div></div>'),to=se('<div class="lobby"><div class="rooms grunge"><div class="headers yellow"><div class="header">Code</div><div class="header">Users</div><div class="header">Status</div></div><hr class="tall"></div><div class="users"><span class="yellow">/// </span>Puppet Masters Online:<hr class="top"><ul class="list"></ul><hr class="bottom"></div><div class="footer panel"></div></div>'),no=se('<div class="room"><div class="room-code teal"></div><div class="room-users white"> / </div><div></div><div class="room-join"></div></div>'),ao=se("<li></li>");function oo(){const{state:a,sendMessage:r}=Ge(),[i,c]=rt(!1),[d,S]=rt(""),N=()=>{r({type:"create"})},T=O=>{O.preventDefault();const G=d();!G||r({type:"join",params:{roomCode:G}})};return(()=>{const O=to.cloneNode(!0),G=O.firstChild;G.firstChild.nextSibling;const J=G.nextSibling,ne=J.firstChild,le=ne.nextSibling,ce=le.nextSibling,ve=ce.nextSibling,ye=J.nextSibling;return Y(G,j(Ft,{get each(){return a.rooms},children:pe=>(()=>{const he=no.cloneNode(!0),be=he.firstChild,Z=be.nextSibling,fe=Z.firstChild,Te=Z.nextSibling,oe=Te.nextSibling;return Y(be,()=>pe.code),Y(Z,()=>pe.users,fe),Y(Z,()=>pe.maxUsers,null),Y(Te,()=>pe.status.toUpperCase()),Y(oe,j(It,{label:"Join",get disabled(){return pe.status!=="open"},onClick:()=>{r({type:"join",params:{roomCode:pe.code}})},color:"red",small:!0})),Oe(()=>Ke(Te,`room-status${pe.status==="full"?" red":""}`)),he})()}),null),Y(ve,j(Ft,{get each(){return a.lobby},children:pe=>(()=>{const he=ao.cloneNode(!0);return Y(he,()=>pe.name),Oe(()=>Ke(he,pe.id===a.user.id?"glow":"white")),he})()})),Y(ye,j(It,{label:"Create",onClick:N}),null),Y(ye,j(It,{label:"Join",onClick:()=>{c(!0),S("")}}),null),Y(O,j(ze,{get when(){return i()},get children(){const pe=eo.cloneNode(!0),he=pe.firstChild,be=he.firstChild,Z=be.firstChild,fe=Z.nextSibling,Te=fe.nextSibling,oe=Te.firstChild,ge=oe.nextSibling;return be.addEventListener("submit",T),fe.addEventListener("change",Ae=>S(Ae.target.value)),ge.$$click=()=>c(!1),Oe(()=>oe.disabled=d().length===0),Oe(()=>fe.value=d()),pe}}),null),O})()}mt(["click"]);const io=se('<div class="message system"><p class="red italic"><span class="white">[ </span><span class="white"> ]</span></p><div class="message-date yellow"></div></div>'),ro=se('<div class="chat"><div class="messages grunge"></div><form><input type="text"><button class="button" type="submit">Send</button></form></div>'),so=se('<div class="message"><p><span></span> </p><div class="message-date yellow"></div></div>');function fa(){let a,r;const{state:i,setState:c,sendMessage:d}=Ge();yn(()=>{r?.focus?.()}),Ht(()=>{!a||i.room?.chatMessages.length===0||(a.scrollTop=a.scrollHeight)});const S=T=>{T.preventDefault();const O=i.chatInput;if(O.length===0)return;const G={message:O,date:new Date().toLocaleTimeString("en-US")};c(H=>({room:{...H.room,chatMessages:[...H.room.chatMessages,{...G,user:H.user}]}})),d({type:"chat",params:{roomCode:i.room.code,chatMessage:G}}),c({chatInput:""})},N=T=>(()=>{const O=io.cloneNode(!0),G=O.firstChild,H=G.firstChild,J=H.nextSibling,ne=G.nextSibling;return Y(G,()=>T.message,J),Y(ne,()=>T.date),O})();return(()=>{const T=ro.cloneNode(!0),O=T.firstChild,G=O.nextSibling,H=G.firstChild,J=a;typeof J=="function"?Ct(J,O):a=O,Y(O,j(Ft,{get each(){return i.room.chatMessages},children:le=>le.user.id==="SYSTEM"?N(le):(()=>{const ce=so.cloneNode(!0),ve=ce.firstChild,ye=ve.firstChild;ye.nextSibling;const pe=ve.nextSibling;return Y(ye,()=>le.user.name),Y(ve,()=>le.message,null),Y(pe,()=>le.date),Oe(()=>Ke(ye,`message-user ${le.user.id===i.user.id?"teal":"white"}`)),ce})()})),G.addEventListener("submit",S),H.addEventListener("change",le=>c({chatInput:le.target.value}));const ne=r;return typeof ne=="function"?Ct(ne,H):r=H,Oe(()=>H.value=i.chatInput),T})()}const lo=se('<div class="countdown"><h1 class="white">Starting in:</h1><div class="count"><span class="glow"></span></div></div>');function uo(a){const[r,i]=rt(),[c,d]=rt(a.from),S=()=>{!r()&&c()>0&&i(setInterval(N,1e3))},N=()=>{let T=c()-1;d(T),T===0&&(clearInterval(r()),a.callback?.())};return yn(()=>{S()}),On(()=>{clearInterval(r())}),j(ze,{get when(){return c()>0},get children(){const T=lo.cloneNode(!0),O=T.firstChild,G=O.nextSibling,H=G.firstChild;return Y(H,c),T}})}const co=se('<div class="room"><div class="main"><div class="header"><div class="room-name"><hr class="dotted-double"><h1 class="wide color-change"></h1><hr class="dotted-double"></div></div></div><div class="users"><span class="yellow">/// </span>Puppet Masters In Room:<hr class="top"><ul class="list"></ul><hr class="bottom"></div><div class="footer panel"></div></div>'),ho=se('<li><div class="name"><span></span></div><div class="status"><div class="check"><span class="red">[</span><span class="yellow"></span><span class="red">]</span></div></div></li>');function po(){const[a,r]=rt(!1),{state:i,setState:c,sendMessage:d}=Ge(),S=Me(()=>!i.room?.users?.find(H=>H.status!=="ready")),N=Me(()=>i.room?.users?.find(H=>H.id===i.user.id&&H.status==="ready")),T=()=>{d({type:"leave"})},O=()=>{d({type:"start"}),c({focus:{current:null,hover:null,spotlight:null,target:{from:null,to:null}}})},G=()=>{const H=!N(),J=H?"ready":"waiting";d({type:"ready",params:{roomCode:i.room.code,status:J}}),r(H)};return(()=>{const H=co.cloneNode(!0),J=H.firstChild,ne=J.firstChild,le=ne.firstChild,ce=le.firstChild,ve=ce.nextSibling,ye=J.nextSibling,pe=ye.firstChild,he=pe.nextSibling,be=he.nextSibling,Z=be.nextSibling,fe=ye.nextSibling;return Y(ve,()=>i.room.code),Y(ne,j(ze,{get when(){return S()},get children(){return j(uo,{from:3,callback:O})}}),null),Y(J,j(fa,{}),null),Y(Z,j(Ft,{get each(){return i.room.users},children:Te=>(()=>{const oe=ho.cloneNode(!0),ge=oe.firstChild,Ae=ge.firstChild,Le=ge.nextSibling,Ue=Le.firstChild,at=Ue.firstChild,yt=at.nextSibling;return Y(Ae,()=>Te.name),Y(yt,()=>Te.status==="ready"?"\u2713":" "),Y(Le,()=>Te.status.toUpperCase(),null),Oe(()=>Ke(Ae,Te.id===i.user.id?"glow":"white")),oe})()})),Y(fe,j(It,{get label(){return N()?"Unready":"Ready"},onClick:G,color:"red"}),null),Y(fe,j(It,{label:"Leave",onClick:T}),null),H})()}const fo=[{id:1,name:"Wireless Vaccine+-",faction:"FAKE TECH",rarity:4,frameSize:"C",type:"Item",subtype:"Weapon",bodyText:`"Not feeling well? Well, maybe it's 'cause you're always on that phone."
