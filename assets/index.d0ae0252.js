(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerpolicy&&(i.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?i.credentials="include":o.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=a(o);fetch(o.href,i)}})();const P={};function ut(e){P.context=e}const dt=(e,t)=>e===t,K=Symbol("solid-proxy"),ve=Symbol("solid-track"),le={equals:dt};let Le=je;const W=1,ce=2,We={owned:null,cleanups:null,context:null,owner:null};var R=null;let $=null,E=null,D=null,x=null,Ie=0;function se(e,t){const a=E,n=R,o=e.length===0,i=o?We:{owned:null,cleanups:null,context:null,owner:t||n},r=o?e:()=>e(()=>U(()=>Me(i)));R=i,E=null;try{return J(r,!0)}finally{E=a,R=n}}function F(e,t){t=t?Object.assign({},le,t):le;const a={value:e,observers:null,observerSlots:null,comparator:t.equals||void 0},n=o=>(typeof o=="function"&&(o=o(a.value)),_e(a,o));return[Ye.bind(a),n]}function N(e,t,a){const n=Ce(e,t,!1,W);ae(n)}function ze(e,t,a){Le=pt;const n=Ce(e,t,!1,W);n.user=!0,x?x.push(n):ae(n)}function C(e,t,a){a=a?Object.assign({},le,a):le;const n=Ce(e,t,!0,0);return n.observers=null,n.observerSlots=null,n.comparator=a.equals||void 0,ae(n),Ye.bind(n)}function mt(e){return J(e,!1)}function U(e){let t,a=E;return E=null,t=e(),E=a,t}function $e(e){ze(()=>U(e))}function Ke(e){return R===null||(R.cleanups===null?R.cleanups=[e]:R.cleanups.push(e)),e}function Ue(){return E}function Ye(){const e=$;if(this.sources&&(this.state||e))if(this.state===W||e)ae(this);else{const t=D;D=null,J(()=>ue(this),!1),D=t}if(E){const t=this.observers?this.observers.length:0;E.sources?(E.sources.push(this),E.sourceSlots.push(t)):(E.sources=[this],E.sourceSlots=[t]),this.observers?(this.observers.push(E),this.observerSlots.push(E.sources.length-1)):(this.observers=[E],this.observerSlots=[E.sources.length-1])}return this.value}function _e(e,t,a){let n=e.value;return(!e.comparator||!e.comparator(n,t))&&(e.value=t,e.observers&&e.observers.length&&J(()=>{for(let o=0;o<e.observers.length;o+=1){const i=e.observers[o],r=$&&$.running;r&&$.disposed.has(i),(r&&!i.tState||!r&&!i.state)&&(i.pure?D.push(i):x.push(i),i.observers&&qe(i)),r||(i.state=W)}if(D.length>1e6)throw D=[],new Error},!1)),t}function ae(e){if(!e.fn)return;Me(e);const t=R,a=E,n=Ie;E=R=e,yt(e,e.value,n),E=a,R=t}function yt(e,t,a){let n;try{n=e.fn(t)}catch(o){e.pure&&(e.state=W),Ve(o)}(!e.updatedAt||e.updatedAt<=a)&&(e.updatedAt!=null&&"observers"in e?_e(e,n):e.value=n,e.updatedAt=a)}function Ce(e,t,a,n=W,o){const i={fn:e,state:n,updatedAt:null,owned:null,sources:null,sourceSlots:null,cleanups:null,value:t,owner:R,context:null,pure:a};return R===null||R!==We&&(R.owned?R.owned.push(i):R.owned=[i]),i}function he(e){const t=$;if(e.state===0||t)return;if(e.state===ce||t)return ue(e);if(e.suspense&&U(e.suspense.inFallback))return e.suspense.effects.push(e);const a=[e];for(;(e=e.owner)&&(!e.updatedAt||e.updatedAt<Ie);)(e.state||t)&&a.push(e);for(let n=a.length-1;n>=0;n--)if(e=a[n],e.state===W||t)ae(e);else if(e.state===ce||t){const o=D;D=null,J(()=>ue(e,a[0]),!1),D=o}}function J(e,t){if(D)return e();let a=!1;t||(D=[]),x?a=!0:x=[],Ie++;try{const n=e();return ft(a),n}catch(n){D||(x=null),Ve(n)}}function ft(e){if(D&&(je(D),D=null),e)return;const t=x;x=null,t.length&&J(()=>Le(t),!1)}function je(e){for(let t=0;t<e.length;t++)he(e[t])}function pt(e){let t,a=0;for(t=0;t<e.length;t++){const n=e[t];n.user?e[a++]=n:he(n)}for(P.context&&ut(),t=0;t<a;t++)he(e[t])}function ue(e,t){const a=$;e.state=0;for(let n=0;n<e.sources.length;n+=1){const o=e.sources[n];o.sources&&(o.state===W||a?o!==t&&he(o):(o.state===ce||a)&&ue(o,t))}}function qe(e){const t=$;for(let a=0;a<e.observers.length;a+=1){const n=e.observers[a];(!n.state||t)&&(n.state=ce,n.pure?D.push(n):x.push(n),n.observers&&qe(n))}}function Me(e){let t;if(e.sources)for(;e.sources.length;){const a=e.sources.pop(),n=e.sourceSlots.pop(),o=a.observers;if(o&&o.length){const i=o.pop(),r=a.observerSlots.pop();n<o.length&&(i.sourceSlots[r]=n,o[n]=i,a.observerSlots[n]=r)}}if(e.owned){for(t=0;t<e.owned.length;t++)Me(e.owned[t]);e.owned=null}if(e.cleanups){for(t=0;t<e.cleanups.length;t++)e.cleanups[t]();e.cleanups=null}e.state=0,e.context=null}function gt(e){return e instanceof Error||typeof e=="string"?e:new Error("Unknown error")}function Ve(e){throw e=gt(e),e}const bt=Symbol("fallback");function Pe(e){for(let t=0;t<e.length;t++)e[t]()}function wt(e,t,a={}){let n=[],o=[],i=[],r=0,s=t.length>1?[]:null;return Ke(()=>Pe(i)),()=>{let c=e()||[],l,h;return c[ve],U(()=>{let f=c.length,k,S,p,T,d,w,g,v,A;if(f===0)r!==0&&(Pe(i),i=[],n=[],o=[],r=0,s&&(s=[])),a.fallback&&(n=[bt],o[0]=se(M=>(i[0]=M,a.fallback())),r=1);else if(r===0){for(o=new Array(f),h=0;h<f;h++)n[h]=c[h],o[h]=se(m);r=f}else{for(p=new Array(f),T=new Array(f),s&&(d=new Array(f)),w=0,g=Math.min(r,f);w<g&&n[w]===c[w];w++);for(g=r-1,v=f-1;g>=w&&v>=w&&n[g]===c[v];g--,v--)p[v]=o[g],T[v]=i[g],s&&(d[v]=s[g]);for(k=new Map,S=new Array(v+1),h=v;h>=w;h--)A=c[h],l=k.get(A),S[h]=l===void 0?-1:l,k.set(A,h);for(l=w;l<=g;l++)A=n[l],h=k.get(A),h!==void 0&&h!==-1?(p[h]=o[l],T[h]=i[l],s&&(d[h]=s[l]),h=S[h],k.set(A,h)):i[l]();for(h=w;h<f;h++)h in p?(o[h]=p[h],i[h]=T[h],s&&(s[h]=d[h],s[h](h))):o[h]=se(m);o=o.slice(0,r=f),n=c.slice(0)}return o});function m(f){if(i[h]=f,s){const[k,S]=F(h);return s[h]=S,t(c[h],k)}return t(c[h])}}}function y(e,t){return U(()=>e(t||{}))}function Q(e){const t="fallback"in e&&{fallback:()=>e.fallback};return C(wt(()=>e.each,e.children,t||void 0))}function B(e){let t=!1;const a=e.keyed,n=C(()=>e.when,void 0,{equals:(o,i)=>t?o===i:!o==!i});return C(()=>{const o=n();if(o){const i=e.children,r=typeof i=="function"&&i.length>0;return t=a||r,r?U(()=>i(o)):i}return e.fallback})}function Tt(e,t){return C(e,void 0,t?void 0:{equals:t})}function vt(e,t,a){let n=a.length,o=t.length,i=n,r=0,s=0,c=t[o-1].nextSibling,l=null;for(;r<o||s<i;){if(t[r]===a[s]){r++,s++;continue}for(;t[o-1]===a[i-1];)o--,i--;if(o===r){const h=i<n?s?a[s-1].nextSibling:a[i-s]:c;for(;s<i;)e.insertBefore(a[s++],h)}else if(i===s)for(;r<o;)(!l||!l.has(t[r]))&&t[r].remove(),r++;else if(t[r]===a[i-1]&&a[s]===t[o-1]){const h=t[--o].nextSibling;e.insertBefore(a[s++],t[r++].nextSibling),e.insertBefore(a[--i],h),t[o]=a[i]}else{if(!l){l=new Map;let m=s;for(;m<i;)l.set(a[m],m++)}const h=l.get(t[r]);if(h!=null)if(s<h&&h<i){let m=r,f=1,k;for(;++m<o&&m<i&&!((k=l.get(t[m]))==null||k!==h+f);)f++;if(f>h-s){const S=t[r];for(;s<h;)e.insertBefore(a[s++],S)}else e.replaceChild(a[s++],t[r++])}else r++;else t[r++].remove()}}}const Be="_$DX_DELEGATE";function kt(e,t,a){let n;return se(o=>{n=o,t===document?e():u(t,e(),t.firstChild?null:void 0,a)}),()=>{n(),t.textContent=""}}function b(e,t,a){const n=document.createElement("template");n.innerHTML=e;let o=n.content.firstChild;return a&&(o=o.firstChild),o}function pe(e,t=window.document){const a=t[Be]||(t[Be]=new Set);for(let n=0,o=e.length;n<o;n++){const i=e[n];a.has(i)||(a.add(i),t.addEventListener(i,At))}}function ke(e,t,a){a==null?e.removeAttribute(t):e.setAttribute(t,a)}function H(e,t){t==null?e.removeAttribute("class"):e.className=t}function St(e,t,a,n){if(n)Array.isArray(a)?(e[`$$${t}`]=a[0],e[`$$${t}Data`]=a[1]):e[`$$${t}`]=a;else if(Array.isArray(a)){const o=a[0];e.addEventListener(t,a[0]=i=>o.call(e,a[1],i))}else e.addEventListener(t,a)}function ne(e,t,a){return U(()=>e(t,a))}function u(e,t,a,n){if(a!==void 0&&!n&&(n=[]),typeof t!="function")return de(e,t,n,a);N(o=>de(e,t(),o,a),n)}function At(e){const t=`$$${e.type}`;let a=e.composedPath&&e.composedPath()[0]||e.target;for(e.target!==a&&Object.defineProperty(e,"target",{configurable:!0,value:a}),Object.defineProperty(e,"currentTarget",{configurable:!0,get(){return a||document}}),P.registry&&!P.done&&(P.done=!0,document.querySelectorAll("[id^=pl-]").forEach(n=>n.remove()));a!==null;){const n=a[t];if(n&&!a.disabled){const o=a[`${t}Data`];if(o!==void 0?n.call(a,o,e):n.call(a,e),e.cancelBubble)return}a=a.host&&a.host!==a&&a.host instanceof Node?a.host:a.parentNode}}function de(e,t,a,n,o){for(P.context&&!a&&(a=[...e.childNodes]);typeof a=="function";)a=a();if(t===a)return a;const i=typeof t,r=n!==void 0;if(e=r&&a[0]&&a[0].parentNode||e,i==="string"||i==="number"){if(P.context)return a;if(i==="number"&&(t=t.toString()),r){let s=a[0];s&&s.nodeType===3?s.data=t:s=document.createTextNode(t),a=_(e,a,n,s)}else a!==""&&typeof a=="string"?a=e.firstChild.data=t:a=e.textContent=t}else if(t==null||i==="boolean"){if(P.context)return a;a=_(e,a,n)}else{if(i==="function")return N(()=>{let s=t();for(;typeof s=="function";)s=s();a=de(e,s,a,n)}),()=>a;if(Array.isArray(t)){const s=[],c=a&&Array.isArray(a);if(Se(s,t,a,o))return N(()=>a=de(e,s,a,n,!0)),()=>a;if(P.context){if(!s.length)return a;for(let l=0;l<s.length;l++)if(s[l].parentNode)return a=s}if(s.length===0){if(a=_(e,a,n),r)return a}else c?a.length===0?Fe(e,s,n):vt(e,a,s):(a&&_(e),Fe(e,s));a=s}else if(t instanceof Node){if(P.context&&t.parentNode)return a=r?[t]:t;if(Array.isArray(a)){if(r)return a=_(e,a,n,t);_(e,a,null,t)}else a==null||a===""||!e.firstChild?e.appendChild(t):e.replaceChild(t,e.firstChild);a=t}}return a}function Se(e,t,a,n){let o=!1;for(let i=0,r=t.length;i<r;i++){let s=t[i],c=a&&a[i];if(s instanceof Node)e.push(s);else if(!(s==null||s===!0||s===!1))if(Array.isArray(s))o=Se(e,s,c)||o;else if(typeof s=="function")if(n){for(;typeof s=="function";)s=s();o=Se(e,Array.isArray(s)?s:[s],Array.isArray(c)?c:[c])||o}else e.push(s),o=!0;else{const l=String(s);c&&c.nodeType===3&&c.data===l?e.push(c):e.push(document.createTextNode(l))}}return o}function Fe(e,t,a){for(let n=0,o=t.length;n<o;n++)e.insertBefore(t[n],a)}function _(e,t,a,n){if(a===void 0)return e.textContent="";const o=n||document.createTextNode("");if(t.length){let i=!1;for(let r=t.length-1;r>=0;r--){const s=t[r];if(o!==s){const c=s.parentNode===e;!i&&!r?c?e.replaceChild(o,s):e.insertBefore(o,a):c&&s.remove()}else i=!0}}else e.insertBefore(o,a);return[o]}const Ae=Symbol("store-raw"),ee=Symbol("store-node"),Et=Symbol("store-name");function Je(e,t){let a=e[K];if(!a&&(Object.defineProperty(e,K,{value:a=new Proxy(e,Mt)}),!Array.isArray(e))){const n=Object.keys(e),o=Object.getOwnPropertyDescriptors(e);for(let i=0,r=n.length;i<r;i++){const s=n[i];if(o[s].get){const c=o[s].get.bind(a);Object.defineProperty(e,s,{get:c})}}}return a}function me(e){let t;return e!=null&&typeof e=="object"&&(e[K]||!(t=Object.getPrototypeOf(e))||t===Object.prototype||Array.isArray(e))}function te(e,t=new Set){let a,n,o,i;if(a=e!=null&&e[Ae])return a;if(!me(e)||t.has(e))return e;if(Array.isArray(e)){Object.isFrozen(e)?e=e.slice(0):t.add(e);for(let r=0,s=e.length;r<s;r++)o=e[r],(n=te(o,t))!==o&&(e[r]=n)}else{Object.isFrozen(e)?e=Object.assign({},e):t.add(e);const r=Object.keys(e),s=Object.getOwnPropertyDescriptors(e);for(let c=0,l=r.length;c<l;c++)i=r[c],!s[i].get&&(o=e[i],(n=te(o,t))!==o&&(e[i]=n))}return e}function ye(e){let t=e[ee];return t||Object.defineProperty(e,ee,{value:t={}}),t}function Ee(e,t,a){return e[t]||(e[t]=Xe(a))}function It(e,t){const a=Reflect.getOwnPropertyDescriptor(e,t);return!a||a.get||!a.configurable||t===K||t===ee||t===Et||(delete a.value,delete a.writable,a.get=()=>e[K][t]),a}function Ze(e){if(Ue()){const t=ye(e);(t._||(t._=Xe()))()}}function Ct(e){return Ze(e),Reflect.ownKeys(e)}function Xe(e){const[t,a]=F(e,{equals:!1,internal:!0});return t.$=a,t}const Mt={get(e,t,a){if(t===Ae)return e;if(t===K)return a;if(t===ve)return Ze(e),a;const n=ye(e),o=n.hasOwnProperty(t);let i=o?n[t]():e[t];if(t===ee||t==="__proto__")return i;if(!o){const r=Object.getOwnPropertyDescriptor(e,t);Ue()&&(typeof i!="function"||e.hasOwnProperty(t))&&!(r&&r.get)&&(i=Ee(n,t,i)())}return me(i)?Je(i):i},has(e,t){if(t===Ae||t===K||t===ve||t===ee||t==="__proto__")return!0;const a=ye(e)[t];return a&&a(),t in e},set(){return!0},deleteProperty(){return!0},ownKeys:Ct,getOwnPropertyDescriptor:It};function fe(e,t,a,n=!1){if(!n&&e[t]===a)return;const o=e[t],i=e.length;a===void 0?delete e[t]:e[t]=a;let r=ye(e),s;(s=Ee(r,t,o))&&s.$(()=>a),Array.isArray(e)&&e.length!==i&&(s=Ee(r,"length",i))&&s.$(e.length),(s=r._)&&s.$()}function Qe(e,t){const a=Object.keys(t);for(let n=0;n<a.length;n+=1){const o=a[n];fe(e,o,t[o])}}function Rt(e,t){if(typeof t=="function"&&(t=t(e)),t=te(t),Array.isArray(t)){if(e===t)return;let a=0,n=t.length;for(;a<n;a++){const o=t[a];e[a]!==o&&fe(e,a,o)}fe(e,"length",n)}else Qe(e,t)}function X(e,t,a=[]){let n,o=e;if(t.length>1){n=t.shift();const r=typeof n,s=Array.isArray(e);if(Array.isArray(n)){for(let c=0;c<n.length;c++)X(e,[n[c]].concat(t),a);return}else if(s&&r==="function"){for(let c=0;c<e.length;c++)n(e[c],c)&&X(e,[c].concat(t),a);return}else if(s&&r==="object"){const{from:c=0,to:l=e.length-1,by:h=1}=n;for(let m=c;m<=l;m+=h)X(e,[m].concat(t),a);return}else if(t.length>1){X(e[n],t,[n].concat(a));return}o=e[n],a=[n].concat(a)}let i=t[0];typeof i=="function"&&(i=i(o,a),i===o)||n===void 0&&i==null||(i=te(i),n===void 0||me(o)&&me(i)&&!Array.isArray(i)?Qe(o,i):fe(e,n,i))}function Dt(...[e,t]){const a=te(e||{}),n=Array.isArray(a),o=Je(a);function i(...r){mt(()=>{n&&r.length===1?Rt(a,r[0]):X(a,r)})}return[o,i]}const Nt={user:{id:"",name:""},connected:!1,lobby:[],room:null,rooms:{},game:void 0,focus:{current:null,hover:null}},j=new WebSocket("wss://mondo-megabits.herokuapp.com");function O(){const[e,t]=Dt(Nt);return j.onopen=()=>{t({connected:!0});var n=setInterval(function(){if(j.readyState!=1){clearInterval(n);return}j.send('{type:"ping"}')},55e3)},j.onclose=()=>{t({connected:!1})},j.onmessage=n=>{const{type:o,params:i}=JSON.parse(n.data);switch(o){case"connected":{t({user:{name:"",id:i.id}});break}case"lobby":{t({lobby:i.users,room:null,rooms:i.otherRooms||[]});break}case"join":{const{roomCode:r,users:s}=i;t(c=>({lobby:c.lobby.filter(l=>l.id!==c.user.id),room:{code:r,users:s,chatMessages:[]}}));break}case"leave":{const{userId:r}=i;t({room:r===e.user.id?null:{...e.room,users:e.room.users.filter(s=>s.id!==r)}});break}case"leave-game":{const{roomCode:r,users:s}=i;t({game:null,room:{code:r,users:s,chatMessages:e.room?.chatMessages||[]}});break}case"chat":{if(i.chatMessage.user.id!==e.user.id){t(r=>({room:{...r.room,chatMessages:[...r.room.chatMessages,i.chatMessage]}}));break}break}case"ready":{const{userId:r,status:s}=i;t(c=>({room:{...c.room,users:c.room.users.map(l=>l.id!==r?l:{...l,status:s})}}));break}case"game":{const{game:r}=i;t({game:r});break}default:{console.log("Got unknown message type: ",o);break}}},{state:e,setState:t,sendMessage:n=>{j.send(JSON.stringify(n))}}}const Ht=b('<div class="connect"><div class="video"><video autoplay="true" loop="true" playsinline="true" muted><source type="video/mp4; codecs=&quot;av01.0.13M.10&quot;" src="https://cdn.mondomegabits.com/logo/Mondo flashing logo_r3 - strobe.mp4"></video></div><form class="puppet-master-handle-input"><label>Puppet Master Handle:</label><input type="text"><button class="connect-button button" type="submit">Connect</button></form></div>');function Gt(){let e;const{sendMessage:t,setState:a}=O(),[n,o]=F("");$e(()=>{e.focus()});const i=r=>{r.preventDefault(),n().length!==0&&(t({type:"lobby",params:{userName:n()}}),a(s=>({user:{...s.user,name:n()}})))};return(()=>{const r=Ht.cloneNode(!0),s=r.firstChild,c=s.nextSibling,l=c.firstChild,h=l.nextSibling;c.addEventListener("submit",i),h.addEventListener("change",f=>o(f.target.value));const m=e;return typeof m=="function"?ne(m,h):e=h,N(()=>h.value=n()),r})()}const Ot=b('<button type="button"><div class="circle"></div><div class="label"></div></button>');function V({label:e,onClick:t,disabled:a,color:n,small:o}){const i=()=>{let r="circle-button button";return n&&(r+=` ${n}`),o&&(r+=" small"),a&&(r+=" disabled"),r};return(()=>{const r=Ot.cloneNode(!0),s=r.firstChild,c=s.nextSibling;return St(r,"click",t,!0),r.disabled=a,u(c,e),N(()=>H(r,i())),r})()}pe(["click"]);const Pt=b('<div class="modal"><div class="join-room panel"><form><label>Room code:</label><input type="text"><div class="modal-footer"><button class="button" type="submit">OK</button><button class="button" type="button">Cancel</button></div></form></div></div>'),Bt=b('<div class="lobby"><div class="rooms"><div class="headers yellow"><div class="header">Code</div><div class="header">Users</div><div class="header">Status</div></div><hr class="tall"></div><div class="users"><span class="yellow">/// </span>Puppet Masters Online:<hr class="top"><ul class="list"></ul><hr class="bottom"></div><div class="footer panel"></div></div>'),Ft=b('<div class="room"><div class="room-code teal"></div><div class="room-users white"> / </div><div></div><div class="room-join"></div></div>'),xt=b("<li></li>");function Lt(){const{state:e,sendMessage:t}=O(),[a,n]=F(!1),[o,i]=F(""),r=()=>{t({type:"create"})},s=c=>{c.preventDefault();const l=o();!l||t({type:"join",params:{roomCode:l}})};return(()=>{const c=Bt.cloneNode(!0),l=c.firstChild;l.firstChild.nextSibling;const m=l.nextSibling,f=m.firstChild,k=f.nextSibling,S=k.nextSibling,p=S.nextSibling,T=m.nextSibling;return u(l,y(Q,{get each(){return e.rooms},children:d=>(()=>{const w=Ft.cloneNode(!0),g=w.firstChild,v=g.nextSibling,A=v.firstChild,M=v.nextSibling,G=M.nextSibling;return u(g,()=>d.code),u(v,()=>d.users,A),u(v,()=>d.maxUsers,null),u(M,()=>d.status.toUpperCase()),u(G,y(V,{label:"Join",get disabled(){return d.status!=="open"},onClick:()=>{t({type:"join",params:{roomCode:d.code}})},color:"red",small:!0})),N(()=>H(M,`room-status${d.status==="full"?" red":""}`)),w})()}),null),u(p,y(Q,{get each(){return e.lobby},children:d=>(()=>{const w=xt.cloneNode(!0);return u(w,()=>d.name),N(()=>H(w,d.id===e.user.id?"glow":"white")),w})()})),u(T,y(V,{label:"Create",onClick:r}),null),u(T,y(V,{label:"Join",onClick:()=>{n(!0),i("")}}),null),u(c,y(B,{get when(){return a()},get children(){const d=Pt.cloneNode(!0),w=d.firstChild,g=w.firstChild,v=g.firstChild,A=v.nextSibling,M=A.nextSibling,G=M.firstChild,Y=G.nextSibling;return g.addEventListener("submit",s),A.addEventListener("change",z=>i(z.target.value)),Y.$$click=()=>n(!1),N(()=>G.disabled=o().length===0),N(()=>A.value=o()),d}}),null),c})()}pe(["click"]);const Wt=b('<div class="chat"><div class="messages"></div><form><input type="text"><button class="button" type="submit">Send</button></form></div>'),zt=b('<div class="message"><p><span></span> </p><div class="message-date yellow"></div></div>');function et(){let e;const{state:t,setState:a,sendMessage:n}=O(),[o,i]=F("");ze(()=>{!e||t.room?.chatMessages.length===0||(e.scrollTop=e.scrollHeight)});const r=s=>{s.preventDefault();const c=o();if(c.length===0)return;const l={message:c,date:new Date().toISOString()};a(h=>({room:{...h.room,chatMessages:[...h.room.chatMessages,{...l,user:h.user}]}})),n({type:"chat",params:{roomCode:t.room.code,chatMessage:l}}),i("")};return(()=>{const s=Wt.cloneNode(!0),c=s.firstChild,l=c.nextSibling,h=l.firstChild,m=e;return typeof m=="function"?ne(m,c):e=c,u(c,y(Q,{get each(){return t.room.chatMessages},children:f=>(()=>{const k=zt.cloneNode(!0),S=k.firstChild,p=S.firstChild;p.nextSibling;const T=S.nextSibling;return u(p,()=>f.user.name),u(S,()=>f.message,null),u(T,()=>new Date(f.date).toLocaleTimeString("en-US")),N(()=>H(p,`message-user ${f.user.id===t.user.id?"teal":"white"}`)),k})()})),l.addEventListener("submit",r),h.addEventListener("change",f=>i(f.target.value)),N(()=>h.value=o()),s})()}const $t=b('<div class="countdown"><h1 class="white">Starting in:</h1><div class="count"><span class="glow"></span></div></div>');function Kt({from:e=5,callback:t=()=>{}}){const[a,n]=F(),[o,i]=F(e),r=()=>{!a()&&o()>0&&n(setInterval(s,1e3))},s=()=>{let c=o()-1;i(c),c===0&&(clearInterval(a()),t?.())};return $e(()=>{r()}),Ke(()=>{clearInterval(a())}),y(B,{get when(){return o()>0},get children(){const c=$t.cloneNode(!0),l=c.firstChild,h=l.nextSibling,m=h.firstChild;return u(m,o),c}})}const Ut=b('<div class="room"><div class="main"><div class="header"><div class="room-name"><hr class="dotted-double"><h1 class="wide color-change"></h1><hr class="dotted-double"></div></div></div><div class="users"><span class="yellow">/// </span>Puppet Masters In Room:<hr class="top"><ul class="list"></ul><hr class="bottom"></div><div class="footer panel"></div></div>'),Yt=b('<li><div class="name"><span></span></div><div class="status"><div class="check"><span class="red">[</span><span class="yellow"></span><span class="red">]</span></div></div></li>');function _t(){const[e,t]=F(!1),{state:a,sendMessage:n}=O(),o=C(()=>!a.room.users.find(l=>l.status!=="ready")),i=C(()=>a.room.users.find(l=>l.id===a.user.id&&l.status==="ready")),r=()=>{n({type:"leave"})},s=()=>{n({type:"start"})},c=()=>{const l=!i(),h=l?"ready":"waiting";n({type:"ready",params:{roomCode:a.room.code,status:h}}),t(l)};return(()=>{const l=Ut.cloneNode(!0),h=l.firstChild,m=h.firstChild,f=m.firstChild,k=f.firstChild,S=k.nextSibling,p=h.nextSibling,T=p.firstChild,d=T.nextSibling,w=d.nextSibling,g=w.nextSibling,v=p.nextSibling;return u(S,()=>a.room.code),u(m,y(B,{get when(){return o()},get children(){return y(Kt,{callback:s})}}),null),u(h,y(et,{}),null),u(g,y(Q,{get each(){return a.room.users},children:A=>(()=>{const M=Yt.cloneNode(!0),G=M.firstChild,Y=G.firstChild,z=G.nextSibling,ge=z.firstChild,be=ge.firstChild,we=be.nextSibling;return u(Y,()=>A.name),u(we,()=>A.status==="ready"?"\u2713":" "),u(z,()=>A.status.toUpperCase(),null),N(()=>H(Y,A.id===a.user.id?"glow":"white")),M})()})),u(v,y(V,{get label(){return i()?"Unready":"Ready"},onClick:c,color:"red"}),null),u(v,y(V,{label:"Leave",onClick:r}),null),l})()}const jt=[{id:1,name:"Wireless Vaccine+-",faction:"FAKE TECH",rarity:4,frameSize:"C",type:"Item",subtype:"Weapon",bodyText:`"Not feeling well? Well, maybe it's 'cause you're always on that phone."
...
Long Warp: Play one round of Rock-Paper-Scissors with your opponent. If you win, receive 1x Teleportation Token, giving you a free instant dodge from an attack of your choice. If you lose, discard the top card of your deck.`,variantId:131,fileStem:"0094a"}],qt=e=>`https://mondomegabits.com/card/img/95/${e.fileStem}.jpg`,Vt=e=>{const t=jt.find(a=>a.id.toString()===e.toString());return qt(t)},Jt=e=>e.replace(/-([a-z])/g,t=>t[1].toUpperCase());const tt=""+new URL("card-back.1c57677c.png",import.meta.url).href;const Zt=b("<div draggable><img></div>");function at({card:e,opponent:t,location:a}){const{state:n,setState:o,sendMessage:i}=O(),r=a==="hand"&&t||e.faceDown,s=C(()=>["battle-zone","the-think-tank","buffer-zone"].includes(a)),c=()=>{t||i({type:"tap",params:{cardUuid:e.uuid,gameCode:n.game.id,roomCode:n.room.code}})},l=d=>{t||d.dataTransfer.setData("text",e.uuid)},h=()=>{t&&r||(n.focus.current?.uuid===e.uuid?m():o(d=>({focus:{...d.focus,current:e}})))},m=()=>{t&&r||o(d=>({focus:{...d.focus,current:null}}))},f=()=>{t&&r||o(d=>({focus:{...d.focus,hover:e}}))},k=()=>{t&&r||o(d=>({focus:{...d.focus,hover:null}}))},S=()=>{s()&&c()},p=d=>{switch(d.detail){case 1:h();break;case 2:S();break}},T=()=>{let d="card";return t&&(d+=" opponent"),n.focus.current?.uuid===e.uuid&&(d+=" focus"),e.tapped&&(d+=" tapped"),d};return(()=>{const d=Zt.cloneNode(!0),w=d.firstChild;return d.addEventListener("dragstart",l),d.addEventListener("pointerleave",k),d.addEventListener("pointerenter",f),d.$$click=p,N(g=>{const v=T(),A=e.uuid,M=r?tt:Vt(e.id);return v!==g._v$&&H(d,g._v$=v),A!==g._v$2&&ke(w,"id",g._v$2=A),M!==g._v$3&&ke(w,"src",g._v$3=M),g},{_v$:void 0,_v$2:void 0,_v$3:void 0}),d})()}pe(["click"]);const Xt=b("<div></div>");function xe({opponent:e}){const{state:t}=O(),a=C(()=>t.game.puppetMasters.find(({id:o})=>o===t.user.id)?.hand),n=C(()=>t.game.puppetMasters.find(({id:o})=>o!==t.user.id)?.hand);return(()=>{const o=Xt.cloneNode(!0);return H(o,`hand${e?" opponent":""}`),u(o,y(Q,{get each(){return e?n():a()},children:i=>y(at,{card:i,faceDown:e,opponent:e,location:"hand"})})),o})()}const Qt=b('<div class="name teal"></div>'),ea=b('<div class="cost yellow"><span class="white">Cost:</span> </div>'),ta=b('<div class="type"><span class="white">Type:</span> </div>'),aa=b('<div class="subtype"><span class="white">Subtype:</span> </div>'),na=b('<div class="faction"><span class="white">Faction:</span> </div>'),oa=b('<div class="body-text"></div>'),ia=b('<div class="card-focus"><div class="focused-card"></div></div>');function ra(){const{state:e}=O(),t=C(()=>e.focus.hover||e.focus.current);return(()=>{const a=ia.cloneNode(!0),n=a.firstChild;return u(n,y(B,{get when(){return t()},get children(){return[(()=>{const o=Qt.cloneNode(!0);return u(o,()=>t().name),o})(),(()=>{const o=ea.cloneNode(!0);return o.firstChild.nextSibling,u(o,()=>t().cost,null),o})(),(()=>{const o=ta.cloneNode(!0);return o.firstChild.nextSibling,u(o,()=>t().type,null),o})(),(()=>{const o=aa.cloneNode(!0);return o.firstChild.nextSibling,u(o,()=>t().subType,null),o})(),(()=>{const o=na.cloneNode(!0);return o.firstChild.nextSibling,u(o,()=>t().faction,null),o})(),(()=>{const o=oa.cloneNode(!0);return u(o,()=>t().bodyText),o})()]}})),a})()}const sa=b("<div></div>");function q({name:e,opponent:t}){let a;const{state:n,sendMessage:o}=O(),i=C(()=>{const l=n.game.puppetMasters.find(f=>t?f.id!==n.user.id:f.id===n.user.id),h=Jt(e);return l.board[h]||[]}),r=l=>{t||(l.preventDefault(),a.classList.add("drag-over"))},s=()=>{t||a.classList.remove("drag-over")},c=l=>{if(t)return;l.preventDefault(),a.classList.remove("drag-over");const h=l.dataTransfer.getData("text");o({type:"play",params:{cardUuid:h,destination:e,gameCode:n.game.id,roomCode:n.room.code}})};return(()=>{const l=sa.cloneNode(!0);l.addEventListener("drop",c),l.addEventListener("dragleave",s),l.addEventListener("dragover",r);const h=a;return typeof h=="function"?ne(h,l):a=l,H(l,`zone panel grunge ${e}${t?" opponent":""}`),u(l,()=>i().map(m=>y(at,{card:m,opponent:t,location:e}))),l})()}const la=b('<div><div class="card-pile-label"></div><div class="card-back"><div class="card-count"></div><img></div></div>');function re({name:e,cards:t,opponent:a,canView:n}){let o;const{state:i,sendMessage:r}=O(),s=m=>{m.preventDefault(),o.classList.add("drag-over")},c=()=>{o.classList.remove("drag-over")},l=m=>{m.preventDefault(),o.classList.remove("drag-over");const f=m.dataTransfer.getData("text");r({type:"move",params:{cardUuid:f,destination:e,gameCode:i.game.id,roomCode:i.room.code}})},h=()=>{switch(e){case"deck":return"Deck";case"discard-pile":return"Discard";default:return""}};return(()=>{const m=la.cloneNode(!0),f=m.firstChild,k=f.nextSibling,S=k.firstChild,p=S.nextSibling;m.addEventListener("drop",l),m.addEventListener("dragleave",c),m.addEventListener("dragover",s);const T=o;return typeof T=="function"?ne(T,m):o=m,H(m,`card-pile ${e}${a?" opponent":""}`),u(f,h),u(S,()=>t.length),ke(p,"src",tt),N(()=>H(p,t.length===0?"empty":"")),m})()}const ca=b('<div class="header grunge"></div>'),ha=b('<div class="opponent"><fieldset><legend class="white"></legend><div class="stats"><div class="stat panel"><div class="stat-label">Narrative</div><div class="stat-number"></div></div><div class="stat panel"><div class="stat-label">Funding</div><div class="stat-number"></div></div></div><div class="card-piles"></div></fieldset></div>'),ua=b('<button class="end-turn-button button">End My Turn</button>'),da=b('<div class="middle grunge"><hr class="dotted-double"></div>'),ma=b('<div class="game-board"><div class="left-side-bar grunge"><div class="turn panel"><div class="turn-label"></div><div class="turn-number"></div></div><div class="me"><fieldset><legend class="white"></legend><div class="card-piles"></div><div class="stats"><div class="stat panel"><div class="stat-label">Narrative</div><div class="stat-number"></div></div><div class="stat panel"><div class="stat-label">Funding</div><div class="stat-number"></div></div></div></fieldset></div></div><div></div><div><div class="options"></div><div class="game-chat"><button class="expand-button button"></button></div></div><div class="footer panel grunge"></div></div>');function ya(){let e;const[t,a]=F(!1),{state:n,setState:o,sendMessage:i}=O(),r=C(()=>n.game.puppetMasters.find(({id:p})=>p===n.user.id)),s=p=>n.room.users.find(T=>T.id===p)?.name,c=C(()=>n.game.puppetMasters.length===1),l=C(()=>c()?null:n.game.puppetMasters.find(({id:p})=>p!==n.user.id)),h=C(()=>{if(c())return null;const p=l()?.id;return s(p)}),m=C(()=>n.game.turn.player===n.user.id),f=()=>{i({type:"leave-game"})},k=()=>{i({type:"end-turn",params:{gameCode:n.game.id,roomCode:n.room.code}})},S=p=>{p.target.id!==n.focus.current?.uuid&&e.contains(p.target)&&o(d=>({focus:{...d.focus,current:null}}))};return(()=>{const p=ma.cloneNode(!0),T=p.firstChild,d=T.firstChild,w=d.firstChild,g=w.nextSibling,v=d.nextSibling,A=v.firstChild,M=A.firstChild,G=M.nextSibling,Y=G.nextSibling,z=Y.firstChild,ge=z.firstChild,be=ge.nextSibling,we=z.nextSibling,nt=we.firstChild,ot=nt.nextSibling,L=T.nextSibling,oe=L.nextSibling,Re=oe.firstChild,Te=Re.nextSibling,De=Te.firstChild,it=oe.nextSibling;p.$$click=S,u(p,y(B,{get when(){return!c()},get children(){const I=ca.cloneNode(!0);return u(I,y(xe,{opponent:!0})),I}}),T),u(T,y(B,{get when(){return!c()},get children(){const I=ha.cloneNode(!0),ie=I.firstChild,Z=ie.firstChild,He=Z.nextSibling,Ge=He.firstChild,rt=Ge.firstChild,st=rt.nextSibling,lt=Ge.nextSibling,ct=lt.firstChild,ht=ct.nextSibling,Oe=He.nextSibling;return u(Z,h),u(st,()=>l().narrative),u(ht,()=>l().funding),u(Oe,y(re,{name:"deck",get cards(){return l().deck}}),null),u(Oe,y(re,{name:"discard-pile",get cards(){return l().discardPile}}),null),I}}),d),u(w,(()=>{const I=Tt(()=>!!m(),!0);return()=>I()?"Your Turn":`${h()}'s Turn`})()),u(g,()=>n.game.turn.number),u(d,y(B,{get when(){return m()},get children(){const I=ua.cloneNode(!0);return I.$$click=k,I}}),null),u(M,()=>n.user.name),u(G,y(re,{name:"deck",get cards(){return r().deck}}),null),u(G,y(re,{name:"discard-pile",get cards(){return r().discardPile}}),null),u(be,()=>r().narrative),u(ot,()=>r().funding);const Ne=e;return typeof Ne=="function"?ne(Ne,L):e=L,u(L,y(B,{get when(){return!c()},get children(){return[y(q,{name:"the-think-tank",opponent:!0}),y(q,{name:"buffer-zone",opponent:!0}),y(q,{name:"battle-zone",opponent:!0}),da.cloneNode(!0)]}}),null),u(L,y(q,{name:"battle-zone"}),null),u(L,y(q,{name:"buffer-zone"}),null),u(L,y(q,{name:"the-think-tank"}),null),u(Re,y(V,{label:"Leave",onClick:f,small:!0})),u(oe,y(ra,{}),Te),De.$$click=()=>a(I=>!I),u(De,()=>t()?"Hide Chat":"Show Chat"),u(Te,y(B,{get when(){return t()},get children(){return y(et,{})}}),null),u(it,y(xe,{})),N(I=>{const ie=`main${c()?" solo-play":""}`,Z=`right-side-bar grunge${t()?" chat-expanded":""}`;return ie!==I._v$&&H(L,I._v$=ie),Z!==I._v$2&&H(oe,I._v$2=Z),I},{_v$:void 0,_v$2:void 0}),p})()}pe(["click"]);const fa=b('<div class="app"></div>'),pa=b('<div class="orientation"><h3>Please turn your device sideways to landscape mode.</h3></div>');function ga(){const{state:e}=O();screen?.orientation?.lock?.("landscape");const t=C(()=>!!e.room||!!e.lobby.find(n=>n.id===e.user.id)),a=()=>e.game?y(ya,{}):e.room?y(_t,{}):y(Lt,{});return[(()=>{const n=fa.cloneNode(!0);return u(n,y(B,{get when(){return t()},get fallback(){return y(Gt,{})},get children(){return a()}})),n})(),pa.cloneNode(!0)]}kt(()=>y(ga,{}),document.getElementById("root"));
