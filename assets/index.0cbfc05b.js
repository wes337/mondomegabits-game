(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function a(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerpolicy&&(i.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?i.credentials="include":o.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=a(o);fetch(o.href,i)}})();const B={};function Ze(e){B.context=e}const Qe=(e,t)=>e===t,$=Symbol("solid-proxy"),pe=Symbol("solid-track"),le={equals:Qe};let Me=Oe;const L=1,ce=2,Re={owned:null,cleanups:null,context:null,owner:null};var M=null;let W=null,E=null,R=null,F=null,Te=0;function se(e,t){const a=E,n=M,o=e.length===0,i=o?Re:{owned:null,cleanups:null,context:null,owner:t||n},s=o?e:()=>e(()=>z(()=>Se(i)));M=i,E=null;try{return V(s,!0)}finally{E=a,M=n}}function x(e,t){t=t?Object.assign({},le,t):le;const a={value:e,observers:null,observerSlots:null,comparator:t.equals||void 0},n=o=>(typeof o=="function"&&(o=o(a.value)),Ge(a,o));return[Pe.bind(a),n]}function C(e,t,a){const n=ke(e,t,!1,L);te(n)}function De(e,t,a){Me=nt;const n=ke(e,t,!1,L);n.user=!0,F?F.push(n):te(n)}function I(e,t,a){a=a?Object.assign({},le,a):le;const n=ke(e,t,!0,0);return n.observers=null,n.observerSlots=null,n.comparator=a.equals||void 0,te(n),Pe.bind(n)}function et(e){return V(e,!1)}function z(e){let t,a=E;return E=null,t=e(),E=a,t}function ve(e){De(()=>z(e))}function Ne(e){return M===null||(M.cleanups===null?M.cleanups=[e]:M.cleanups.push(e)),e}function He(){return E}function Pe(){const e=W;if(this.sources&&(this.state||e))if(this.state===L||e)te(this);else{const t=R;R=null,V(()=>he(this),!1),R=t}if(E){const t=this.observers?this.observers.length:0;E.sources?(E.sources.push(this),E.sourceSlots.push(t)):(E.sources=[this],E.sourceSlots=[t]),this.observers?(this.observers.push(E),this.observerSlots.push(E.sources.length-1)):(this.observers=[E],this.observerSlots=[E.sources.length-1])}return this.value}function Ge(e,t,a){let n=e.value;return(!e.comparator||!e.comparator(n,t))&&(e.value=t,e.observers&&e.observers.length&&V(()=>{for(let o=0;o<e.observers.length;o+=1){const i=e.observers[o],s=W&&W.running;s&&W.disposed.has(i),(s&&!i.tState||!s&&!i.state)&&(i.pure?R.push(i):F.push(i),i.observers&&Be(i)),s||(i.state=L)}if(R.length>1e6)throw R=[],new Error},!1)),t}function te(e){if(!e.fn)return;Se(e);const t=M,a=E,n=Te;E=M=e,tt(e,e.value,n),E=a,M=t}function tt(e,t,a){let n;try{n=e.fn(t)}catch(o){e.pure&&(e.state=L),Fe(o)}(!e.updatedAt||e.updatedAt<=a)&&(e.updatedAt!=null&&"observers"in e?Ge(e,n):e.value=n,e.updatedAt=a)}function ke(e,t,a,n=L,o){const i={fn:e,state:n,updatedAt:null,owned:null,sources:null,sourceSlots:null,cleanups:null,value:t,owner:M,context:null,pure:a};return M===null||M!==Re&&(M.owned?M.owned.push(i):M.owned=[i]),i}function ue(e){const t=W;if(e.state===0||t)return;if(e.state===ce||t)return he(e);if(e.suspense&&z(e.suspense.inFallback))return e.suspense.effects.push(e);const a=[e];for(;(e=e.owner)&&(!e.updatedAt||e.updatedAt<Te);)(e.state||t)&&a.push(e);for(let n=a.length-1;n>=0;n--)if(e=a[n],e.state===L||t)te(e);else if(e.state===ce||t){const o=R;R=null,V(()=>he(e,a[0]),!1),R=o}}function V(e,t){if(R)return e();let a=!1;t||(R=[]),F?a=!0:F=[],Te++;try{const n=e();return at(a),n}catch(n){R||(F=null),Fe(n)}}function at(e){if(R&&(Oe(R),R=null),e)return;const t=F;F=null,t.length&&V(()=>Me(t),!1)}function Oe(e){for(let t=0;t<e.length;t++)ue(e[t])}function nt(e){let t,a=0;for(t=0;t<e.length;t++){const n=e[t];n.user?e[a++]=n:ue(n)}for(B.context&&Ze(),t=0;t<a;t++)ue(e[t])}function he(e,t){const a=W;e.state=0;for(let n=0;n<e.sources.length;n+=1){const o=e.sources[n];o.sources&&(o.state===L||a?o!==t&&ue(o):(o.state===ce||a)&&he(o,t))}}function Be(e){const t=W;for(let a=0;a<e.observers.length;a+=1){const n=e.observers[a];(!n.state||t)&&(n.state=ce,n.pure?R.push(n):F.push(n),n.observers&&Be(n))}}function Se(e){let t;if(e.sources)for(;e.sources.length;){const a=e.sources.pop(),n=e.sourceSlots.pop(),o=a.observers;if(o&&o.length){const i=o.pop(),s=a.observerSlots.pop();n<o.length&&(i.sourceSlots[s]=n,o[n]=i,a.observerSlots[n]=s)}}if(e.owned){for(t=0;t<e.owned.length;t++)Se(e.owned[t]);e.owned=null}if(e.cleanups){for(t=0;t<e.cleanups.length;t++)e.cleanups[t]();e.cleanups=null}e.state=0,e.context=null}function ot(e){return e instanceof Error||typeof e=="string"?e:new Error("Unknown error")}function Fe(e){throw e=ot(e),e}const it=Symbol("fallback");function Ee(e){for(let t=0;t<e.length;t++)e[t]()}function rt(e,t,a={}){let n=[],o=[],i=[],s=0,r=t.length>1?[]:null;return Ne(()=>Ee(i)),()=>{let u=e()||[],l,c;return u[pe],z(()=>{let f=u.length,v,S,k,A,w,b,y,T,g;if(f===0)s!==0&&(Ee(i),i=[],n=[],o=[],s=0,r&&(r=[])),a.fallback&&(n=[it],o[0]=se(N=>(i[0]=N,a.fallback())),s=1);else if(s===0){for(o=new Array(f),c=0;c<f;c++)n[c]=u[c],o[c]=se(d);s=f}else{for(k=new Array(f),A=new Array(f),r&&(w=new Array(f)),b=0,y=Math.min(s,f);b<y&&n[b]===u[b];b++);for(y=s-1,T=f-1;y>=b&&T>=b&&n[y]===u[T];y--,T--)k[T]=o[y],A[T]=i[y],r&&(w[T]=r[y]);for(v=new Map,S=new Array(T+1),c=T;c>=b;c--)g=u[c],l=v.get(g),S[c]=l===void 0?-1:l,v.set(g,c);for(l=b;l<=y;l++)g=n[l],c=v.get(g),c!==void 0&&c!==-1?(k[c]=o[l],A[c]=i[l],r&&(w[c]=r[l]),c=S[c],v.set(g,c)):i[l]();for(c=b;c<f;c++)c in k?(o[c]=k[c],i[c]=A[c],r&&(r[c]=w[c],r[c](c))):o[c]=se(d);o=o.slice(0,s=f),n=u.slice(0)}return o});function d(f){if(i[c]=f,r){const[v,S]=x(c);return r[c]=S,t(u[c],v)}return t(u[c])}}}function m(e,t){return z(()=>e(t||{}))}function X(e){const t="fallback"in e&&{fallback:()=>e.fallback};return I(rt(()=>e.each,e.children,t||void 0))}function O(e){let t=!1;const a=e.keyed,n=I(()=>e.when,void 0,{equals:(o,i)=>t?o===i:!o==!i});return I(()=>{const o=n();if(o){const i=e.children,s=typeof i=="function"&&i.length>0;return t=a||s,s?z(()=>i(o)):i}return e.fallback})}function st(e,t){return I(e,void 0,t?void 0:{equals:t})}function lt(e,t,a){let n=a.length,o=t.length,i=n,s=0,r=0,u=t[o-1].nextSibling,l=null;for(;s<o||r<i;){if(t[s]===a[r]){s++,r++;continue}for(;t[o-1]===a[i-1];)o--,i--;if(o===s){const c=i<n?r?a[r-1].nextSibling:a[i-r]:u;for(;r<i;)e.insertBefore(a[r++],c)}else if(i===r)for(;s<o;)(!l||!l.has(t[s]))&&t[s].remove(),s++;else if(t[s]===a[i-1]&&a[r]===t[o-1]){const c=t[--o].nextSibling;e.insertBefore(a[r++],t[s++].nextSibling),e.insertBefore(a[--i],c),t[o]=a[i]}else{if(!l){l=new Map;let d=r;for(;d<i;)l.set(a[d],d++)}const c=l.get(t[s]);if(c!=null)if(r<c&&c<i){let d=s,f=1,v;for(;++d<o&&d<i&&!((v=l.get(t[d]))==null||v!==c+f);)f++;if(f>c-r){const S=t[s];for(;r<c;)e.insertBefore(a[r++],S)}else e.replaceChild(a[r++],t[s++])}else s++;else t[s++].remove()}}}const Ie="_$DX_DELEGATE";function ct(e,t,a){let n;return se(o=>{n=o,t===document?e():h(t,e(),t.firstChild?null:void 0,a)}),()=>{n(),t.textContent=""}}function p(e,t,a){const n=document.createElement("template");n.innerHTML=e;let o=n.content.firstChild;return a&&(o=o.firstChild),o}function K(e,t=window.document){const a=t[Ie]||(t[Ie]=new Set);for(let n=0,o=e.length;n<o;n++){const i=e[n];a.has(i)||(a.add(i),t.addEventListener(i,ht))}}function Z(e,t,a){a==null?e.removeAttribute(t):e.setAttribute(t,a)}function P(e,t){t==null?e.removeAttribute("class"):e.className=t}function ut(e,t,a,n){if(n)Array.isArray(a)?(e[`$$${t}`]=a[0],e[`$$${t}Data`]=a[1]):e[`$$${t}`]=a;else if(Array.isArray(a)){const o=a[0];e.addEventListener(t,a[0]=i=>o.call(e,a[1],i))}else e.addEventListener(t,a)}function q(e,t,a){return z(()=>e(t,a))}function h(e,t,a,n){if(a!==void 0&&!n&&(n=[]),typeof t!="function")return de(e,t,n,a);C(o=>de(e,t(),o,a),n)}function ht(e){const t=`$$${e.type}`;let a=e.composedPath&&e.composedPath()[0]||e.target;for(e.target!==a&&Object.defineProperty(e,"target",{configurable:!0,value:a}),Object.defineProperty(e,"currentTarget",{configurable:!0,get(){return a||document}}),B.registry&&!B.done&&(B.done=!0,document.querySelectorAll("[id^=pl-]").forEach(n=>n.remove()));a!==null;){const n=a[t];if(n&&!a.disabled){const o=a[`${t}Data`];if(o!==void 0?n.call(a,o,e):n.call(a,e),e.cancelBubble)return}a=a.host&&a.host!==a&&a.host instanceof Node?a.host:a.parentNode}}function de(e,t,a,n,o){for(B.context&&!a&&(a=[...e.childNodes]);typeof a=="function";)a=a();if(t===a)return a;const i=typeof t,s=n!==void 0;if(e=s&&a[0]&&a[0].parentNode||e,i==="string"||i==="number"){if(B.context)return a;if(i==="number"&&(t=t.toString()),s){let r=a[0];r&&r.nodeType===3?r.data=t:r=document.createTextNode(t),a=Y(e,a,n,r)}else a!==""&&typeof a=="string"?a=e.firstChild.data=t:a=e.textContent=t}else if(t==null||i==="boolean"){if(B.context)return a;a=Y(e,a,n)}else{if(i==="function")return C(()=>{let r=t();for(;typeof r=="function";)r=r();a=de(e,r,a,n)}),()=>a;if(Array.isArray(t)){const r=[],u=a&&Array.isArray(a);if(ge(r,t,a,o))return C(()=>a=de(e,r,a,n,!0)),()=>a;if(B.context){if(!r.length)return a;for(let l=0;l<r.length;l++)if(r[l].parentNode)return a=r}if(r.length===0){if(a=Y(e,a,n),s)return a}else u?a.length===0?Ce(e,r,n):lt(e,a,r):(a&&Y(e),Ce(e,r));a=r}else if(t instanceof Node){if(B.context&&t.parentNode)return a=s?[t]:t;if(Array.isArray(a)){if(s)return a=Y(e,a,n,t);Y(e,a,null,t)}else a==null||a===""||!e.firstChild?e.appendChild(t):e.replaceChild(t,e.firstChild);a=t}}return a}function ge(e,t,a,n){let o=!1;for(let i=0,s=t.length;i<s;i++){let r=t[i],u=a&&a[i];if(r instanceof Node)e.push(r);else if(!(r==null||r===!0||r===!1))if(Array.isArray(r))o=ge(e,r,u)||o;else if(typeof r=="function")if(n){for(;typeof r=="function";)r=r();o=ge(e,Array.isArray(r)?r:[r],Array.isArray(u)?u:[u])||o}else e.push(r),o=!0;else{const l=String(r);u&&u.nodeType===3&&u.data===l?e.push(u):e.push(document.createTextNode(l))}}return o}function Ce(e,t,a){for(let n=0,o=t.length;n<o;n++)e.insertBefore(t[n],a)}function Y(e,t,a,n){if(a===void 0)return e.textContent="";const o=n||document.createTextNode("");if(t.length){let i=!1;for(let s=t.length-1;s>=0;s--){const r=t[s];if(o!==r){const u=r.parentNode===e;!i&&!s?u?e.replaceChild(o,r):e.insertBefore(o,a):u&&r.remove()}else i=!0}}else e.insertBefore(o,a);return[o]}const be=Symbol("store-raw"),Q=Symbol("store-node"),dt=Symbol("store-name");function xe(e,t){let a=e[$];if(!a&&(Object.defineProperty(e,$,{value:a=new Proxy(e,ft)}),!Array.isArray(e))){const n=Object.keys(e),o=Object.getOwnPropertyDescriptors(e);for(let i=0,s=n.length;i<s;i++){const r=n[i];if(o[r].get){const u=o[r].get.bind(a);Object.defineProperty(e,r,{get:u})}}}return a}function me(e){let t;return e!=null&&typeof e=="object"&&(e[$]||!(t=Object.getPrototypeOf(e))||t===Object.prototype||Array.isArray(e))}function ee(e,t=new Set){let a,n,o,i;if(a=e!=null&&e[be])return a;if(!me(e)||t.has(e))return e;if(Array.isArray(e)){Object.isFrozen(e)?e=e.slice(0):t.add(e);for(let s=0,r=e.length;s<r;s++)o=e[s],(n=ee(o,t))!==o&&(e[s]=n)}else{Object.isFrozen(e)?e=Object.assign({},e):t.add(e);const s=Object.keys(e),r=Object.getOwnPropertyDescriptors(e);for(let u=0,l=s.length;u<l;u++)i=s[u],!r[i].get&&(o=e[i],(n=ee(o,t))!==o&&(e[i]=n))}return e}function ye(e){let t=e[Q];return t||Object.defineProperty(e,Q,{value:t={}}),t}function we(e,t,a){return e[t]||(e[t]=We(a))}function mt(e,t){const a=Reflect.getOwnPropertyDescriptor(e,t);return!a||a.get||!a.configurable||t===$||t===Q||t===dt||(delete a.value,delete a.writable,a.get=()=>e[$][t]),a}function Le(e){if(He()){const t=ye(e);(t._||(t._=We()))()}}function yt(e){return Le(e),Reflect.ownKeys(e)}function We(e){const[t,a]=x(e,{equals:!1,internal:!0});return t.$=a,t}const ft={get(e,t,a){if(t===be)return e;if(t===$)return a;if(t===pe)return Le(e),a;const n=ye(e),o=n.hasOwnProperty(t);let i=o?n[t]():e[t];if(t===Q||t==="__proto__")return i;if(!o){const s=Object.getOwnPropertyDescriptor(e,t);He()&&(typeof i!="function"||e.hasOwnProperty(t))&&!(s&&s.get)&&(i=we(n,t,i)())}return me(i)?xe(i):i},has(e,t){if(t===be||t===$||t===pe||t===Q||t==="__proto__")return!0;const a=ye(e)[t];return a&&a(),t in e},set(){return!0},deleteProperty(){return!0},ownKeys:yt,getOwnPropertyDescriptor:mt};function fe(e,t,a,n=!1){if(!n&&e[t]===a)return;const o=e[t],i=e.length;a===void 0?delete e[t]:e[t]=a;let s=ye(e),r;(r=we(s,t,o))&&r.$(()=>a),Array.isArray(e)&&e.length!==i&&(r=we(s,"length",i))&&r.$(e.length),(r=s._)&&r.$()}function $e(e,t){const a=Object.keys(t);for(let n=0;n<a.length;n+=1){const o=a[n];fe(e,o,t[o])}}function pt(e,t){if(typeof t=="function"&&(t=t(e)),t=ee(t),Array.isArray(t)){if(e===t)return;let a=0,n=t.length;for(;a<n;a++){const o=t[a];e[a]!==o&&fe(e,a,o)}fe(e,"length",n)}else $e(e,t)}function J(e,t,a=[]){let n,o=e;if(t.length>1){n=t.shift();const s=typeof n,r=Array.isArray(e);if(Array.isArray(n)){for(let u=0;u<n.length;u++)J(e,[n[u]].concat(t),a);return}else if(r&&s==="function"){for(let u=0;u<e.length;u++)n(e[u],u)&&J(e,[u].concat(t),a);return}else if(r&&s==="object"){const{from:u=0,to:l=e.length-1,by:c=1}=n;for(let d=u;d<=l;d+=c)J(e,[d].concat(t),a);return}else if(t.length>1){J(e[n],t,[n].concat(a));return}o=e[n],a=[n].concat(a)}let i=t[0];typeof i=="function"&&(i=i(o,a),i===o)||n===void 0&&i==null||(i=ee(i),n===void 0||me(o)&&me(i)&&!Array.isArray(i)?$e(o,i):fe(e,n,i))}function gt(...[e,t]){const a=ee(e||{}),n=Array.isArray(a),o=xe(a);function i(...s){et(()=>{n&&s.length===1?pt(a,s[0]):J(a,s)})}return[o,i]}const bt={user:{id:"",name:""},connected:!1,lobby:[],room:null,rooms:{},game:void 0,focus:{current:null,hover:null,spotlight:null},chatExpanded:!1},ie=new WebSocket("wss://mondo-megabits.herokuapp.com");function D(){const[e,t]=gt(bt),a=n=>{ie.send(JSON.stringify(n))};return ie.onopen=()=>{t({connected:!0}),setInterval(()=>{a({type:"ping"})},4e4)},ie.onclose=()=>{t({connected:!1})},ie.onmessage=n=>{const{type:o,params:i}=JSON.parse(n.data);switch(o){case"connected":{t({user:{name:"",id:i.id}});break}case"lobby":{t({lobby:i.users,room:null,rooms:i.otherRooms||[]});break}case"join":{const{roomCode:s,users:r}=i;t(u=>({lobby:u.lobby.filter(l=>l.id!==u.user.id),room:{code:s,users:r,chatMessages:u.room?.chatMessages||[]}}));break}case"leave":{const{userId:s}=i;t({room:s===e.user.id?null:{...e.room,users:e.room.users.filter(r=>r.id!==s)}});break}case"leave-game":{const{roomCode:s,users:r}=i;t({game:null,room:{code:s,users:r,chatMessages:e.room?.chatMessages||[]}});break}case"chat":{if(i.chatMessage.user.id!==e.user.id){t(s=>({room:{...s.room,chatMessages:[...s.room?.chatMessages||[],i.chatMessage]}}));break}break}case"ready":{const{userId:s,status:r}=i;t(u=>({room:{...u.room,users:u.room.users.map(l=>l.id!==s?l:{...l,status:r})}}));break}case"game":{const{game:s}=i;t({game:s});break}default:{console.log("Got unknown message type: ",o);break}}},{state:e,setState:t,sendMessage:a}}const wt=p('<div class="connect"><div class="video"><video autoplay="true" loop="true" playsinline="true" muted><source type="video/mp4; codecs=&quot;av01.0.13M.10&quot;" src="https://cdn.mondomegabits.com/logo/Mondo flashing logo_r3 - strobe.mp4"></video></div><form class="puppet-master-handle-input"><label>Puppet Master Handle:</label><input type="text"><button class="connect-button button" type="submit">Connect</button></form></div>');function Tt(){let e;const{sendMessage:t,setState:a}=D(),[n,o]=x("");ve(()=>{e.focus()});const i=s=>{s.preventDefault(),n().length!==0&&(t({type:"lobby",params:{userName:n()}}),a(r=>({user:{...r.user,name:n()}})))};return(()=>{const s=wt.cloneNode(!0),r=s.firstChild,u=r.nextSibling,l=u.firstChild,c=l.nextSibling;u.addEventListener("submit",i),c.addEventListener("change",f=>o(f.target.value));const d=e;return typeof d=="function"?q(d,c):e=c,C(()=>c.value=n()),s})()}const vt=p('<button type="button"><div class="circle"></div><div class="label"></div></button>');function j({label:e,onClick:t,disabled:a,color:n,small:o}){const i=()=>{let s="circle-button button";return n&&(s+=` ${n}`),o&&(s+=" small"),a&&(s+=" disabled"),s};return(()=>{const s=vt.cloneNode(!0),r=s.firstChild,u=r.nextSibling;return ut(s,"click",t,!0),s.disabled=a,h(u,e),C(()=>P(s,i())),s})()}K(["click"]);const kt=p('<div class="modal"><div class="join-room panel"><form><label>Room code:</label><input type="text"><div class="modal-footer"><button class="button" type="submit">OK</button><button class="button" type="button">Cancel</button></div></form></div></div>'),St=p('<div class="lobby"><div class="rooms grunge"><div class="headers yellow"><div class="header">Code</div><div class="header">Users</div><div class="header">Status</div></div><hr class="tall"></div><div class="users"><span class="yellow">/// </span>Puppet Masters Online:<hr class="top"><ul class="list"></ul><hr class="bottom"></div><div class="footer panel"></div></div>'),At=p('<div class="room"><div class="room-code teal"></div><div class="room-users white"> / </div><div></div><div class="room-join"></div></div>'),Et=p("<li></li>");function It(){const{state:e,sendMessage:t}=D(),[a,n]=x(!1),[o,i]=x(""),s=()=>{t({type:"create"})},r=u=>{u.preventDefault();const l=o();!l||t({type:"join",params:{roomCode:l}})};return(()=>{const u=St.cloneNode(!0),l=u.firstChild;l.firstChild.nextSibling;const d=l.nextSibling,f=d.firstChild,v=f.nextSibling,S=v.nextSibling,k=S.nextSibling,A=d.nextSibling;return h(l,m(X,{get each(){return e.rooms},children:w=>(()=>{const b=At.cloneNode(!0),y=b.firstChild,T=y.nextSibling,g=T.firstChild,N=T.nextSibling,G=N.nextSibling;return h(y,()=>w.code),h(T,()=>w.users,g),h(T,()=>w.maxUsers,null),h(N,()=>w.status.toUpperCase()),h(G,m(j,{label:"Join",get disabled(){return w.status!=="open"},onClick:()=>{t({type:"join",params:{roomCode:w.code}})},color:"red",small:!0})),C(()=>P(N,`room-status${w.status==="full"?" red":""}`)),b})()}),null),h(k,m(X,{get each(){return e.lobby},children:w=>(()=>{const b=Et.cloneNode(!0);return h(b,()=>w.name),C(()=>P(b,w.id===e.user.id?"glow":"white")),b})()})),h(A,m(j,{label:"Create",onClick:s}),null),h(A,m(j,{label:"Join",onClick:()=>{n(!0),i("")}}),null),h(u,m(O,{get when(){return a()},get children(){const w=kt.cloneNode(!0),b=w.firstChild,y=b.firstChild,T=y.firstChild,g=T.nextSibling,N=g.nextSibling,G=N.firstChild,H=G.nextSibling;return y.addEventListener("submit",r),g.addEventListener("change",U=>i(U.target.value)),H.$$click=()=>n(!1),C(()=>G.disabled=o().length===0),C(()=>g.value=o()),w}}),null),u})()}K(["click"]);const Ct=p('<div class="message system"><p class="red italic"><span class="white">[ </span><span class="white"> ]</span></p><div class="message-date yellow"></div></div>'),Mt=p('<div class="chat"><div class="messages grunge"></div><form><input type="text"><button class="button" type="submit">Send</button></form></div>'),Rt=p('<div class="message"><p><span></span> </p><div class="message-date yellow"></div></div>');function ze(){let e,t;const{state:a,setState:n,sendMessage:o}=D(),[i,s]=x("");ve(()=>{t?.focus?.()}),De(()=>{!e||a.room?.chatMessages.length===0||(e.scrollTop=e.scrollHeight)});const r=l=>{l.preventDefault();const c=i();if(c.length===0)return;const d={message:c,date:new Date().toLocaleTimeString("en-US")};n(f=>({room:{...f.room,chatMessages:[...f.room.chatMessages,{...d,user:f.user}]}})),o({type:"chat",params:{roomCode:a.room.code,chatMessage:d}}),s("")},u=l=>(()=>{const c=Ct.cloneNode(!0),d=c.firstChild,f=d.firstChild,v=f.nextSibling,S=d.nextSibling;return h(d,()=>l.message,v),h(S,()=>l.date),c})();return(()=>{const l=Mt.cloneNode(!0),c=l.firstChild,d=c.nextSibling,f=d.firstChild,v=e;typeof v=="function"?q(v,c):e=c,h(c,m(X,{get each(){return a.room.chatMessages},children:k=>k.user.id==="SYSTEM"?u(k):(()=>{const A=Rt.cloneNode(!0),w=A.firstChild,b=w.firstChild;b.nextSibling;const y=w.nextSibling;return h(b,()=>k.user.name),h(w,()=>k.message,null),h(y,()=>k.date),C(()=>P(b,`message-user ${k.user.id===a.user.id?"teal":"white"}`)),A})()})),d.addEventListener("submit",r),f.addEventListener("change",k=>s(k.target.value));const S=t;return typeof S=="function"?q(S,f):t=f,C(()=>f.value=i()),l})()}const Dt=p('<div class="countdown"><h1 class="white">Starting in:</h1><div class="count"><span class="glow"></span></div></div>');function Nt({from:e=5,callback:t=()=>{}}){const[a,n]=x(),[o,i]=x(e),s=()=>{!a()&&o()>0&&n(setInterval(r,1e3))},r=()=>{let u=o()-1;i(u),u===0&&(clearInterval(a()),t?.())};return ve(()=>{s()}),Ne(()=>{clearInterval(a())}),m(O,{get when(){return o()>0},get children(){const u=Dt.cloneNode(!0),l=u.firstChild,c=l.nextSibling,d=c.firstChild;return h(d,o),u}})}const Ht=p('<div class="room"><div class="main"><div class="header"><div class="room-name"><hr class="dotted-double"><h1 class="wide color-change"></h1><hr class="dotted-double"></div></div></div><div class="users"><span class="yellow">/// </span>Puppet Masters In Room:<hr class="top"><ul class="list"></ul><hr class="bottom"></div><div class="footer panel"></div></div>'),Pt=p('<li><div class="name"><span></span></div><div class="status"><div class="check"><span class="red">[</span><span class="yellow"></span><span class="red">]</span></div></div></li>');function Gt(){const[e,t]=x(!1),{state:a,sendMessage:n}=D(),o=I(()=>!a.room?.users?.find(l=>l.status!=="ready")),i=I(()=>a.room?.users?.find(l=>l.id===a.user.id&&l.status==="ready")),s=()=>{n({type:"leave"})},r=()=>{n({type:"start"})},u=()=>{const l=!i(),c=l?"ready":"waiting";n({type:"ready",params:{roomCode:a.room.code,status:c}}),t(l)};return(()=>{const l=Ht.cloneNode(!0),c=l.firstChild,d=c.firstChild,f=d.firstChild,v=f.firstChild,S=v.nextSibling,k=c.nextSibling,A=k.firstChild,w=A.nextSibling,b=w.nextSibling,y=b.nextSibling,T=k.nextSibling;return h(S,()=>a.room.code),h(d,m(O,{get when(){return o()},get children(){return m(Nt,{callback:r})}}),null),h(c,m(ze,{}),null),h(y,m(X,{get each(){return a.room.users},children:g=>(()=>{const N=Pt.cloneNode(!0),G=N.firstChild,H=G.firstChild,U=G.nextSibling,ae=U.firstChild,ne=ae.firstChild,oe=ne.nextSibling;return h(H,()=>g.name),h(oe,()=>g.status==="ready"?"\u2713":" "),h(U,()=>g.status.toUpperCase(),null),C(()=>P(H,g.id===a.user.id?"glow":"white")),N})()})),h(T,m(j,{get label(){return i()?"Unready":"Ready"},onClick:u,color:"red"}),null),h(T,m(j,{label:"Leave",onClick:s}),null),l})()}const Ot=[{id:1,name:"Wireless Vaccine+-",faction:"FAKE TECH",rarity:4,frameSize:"C",type:"Item",subtype:"Weapon",bodyText:`"Not feeling well? Well, maybe it's 'cause you're always on that phone."
...
Long Warp: Play one round of Rock-Paper-Scissors with your opponent. If you win, receive 1x Teleportation Token, giving you a free instant dodge from an attack of your choice. If you lose, discard the top card of your deck.`,variantId:131,fileStem:"0094a"}],Bt=e=>`https://mondomegabits.com/card/img/95/${e.fileStem}.jpg`,Ke=e=>{const t=Ot.find(a=>a.id.toString()===e.toString());return Bt(t)},Ft=e=>e.replace(/-([a-z])/g,t=>t[1].toUpperCase()),Ue=""+new URL("card-back.1c57677c.png",import.meta.url).href;const xt=p('<button class="expand-card">\u21F1</button>'),Lt=p("<div draggable><img></div>");function Ye({card:e,opponent:t,location:a}){const{state:n,setState:o,sendMessage:i}=D(),s=a==="hand"&&t||e.faceDown,r=a!=="hand"&&!(s&&t),u=I(()=>["battle-zone","the-think-tank","buffer-zone"].includes(a)),l=()=>{t||i({type:"tap",params:{cardUuid:e.uuid,gameCode:n.game.id,roomCode:n.room.code}})},c=y=>{t||y.dataTransfer.setData("text",e.uuid)},d=()=>{t&&s||(n.focus.current?.uuid===e.uuid?f():o(y=>({focus:{...y.focus,current:e}})))},f=()=>{t&&s||o(y=>({focus:{...y.focus,current:null}}))},v=()=>{t&&s||o(y=>({focus:{...y.focus,hover:e}}))},S=()=>{t&&s||o(y=>({focus:{...y.focus,hover:null}}))},k=()=>{u()&&l()},A=y=>{switch(y.detail){case 1:d();break;case 2:k();break}},w=y=>{y.stopPropagation(),o(T=>({focus:{...T.focus,spotlight:e}}))},b=()=>{let y="card";return t&&(y+=" opponent"),n.focus.current?.uuid===e.uuid&&(y+=" focus"),e.tapped&&(y+=" tapped"),y};return(()=>{const y=Lt.cloneNode(!0),T=y.firstChild;return y.addEventListener("dragstart",c),y.addEventListener("pointerleave",S),y.addEventListener("pointerenter",v),y.$$click=A,h(y,m(O,{when:r,get children(){const g=xt.cloneNode(!0);return g.$$click=w,g}}),T),C(g=>{const N=b(),G=e.uuid,H=s?Ue:Ke(e.id);return N!==g._v$&&P(y,g._v$=N),G!==g._v$2&&Z(T,"id",g._v$2=G),H!==g._v$3&&Z(T,"src",g._v$3=H),g},{_v$:void 0,_v$2:void 0,_v$3:void 0}),y})()}K(["click"]);const Wt=p("<div></div>");function _e({opponent:e}){const{state:t}=D(),a=I(()=>t.game.puppetMasters.find(({id:o})=>o===t.user.id)?.hand),n=I(()=>t.game.puppetMasters.find(({id:o})=>o!==t.user.id)?.hand);return(()=>{const o=Wt.cloneNode(!0);return P(o,`hand${e?" opponent":""}`),h(o,m(X,{get each(){return e?n():a()},children:i=>m(Ye,{card:i,faceDown:e,opponent:e,location:"hand"})})),o})()}const $t=p('<div class="game-header grunge"></div>');function zt(){const{state:e}=D(),t=I(()=>e.game.puppetMasters.length===1);return m(O,{get when(){return!t()},get children(){const a=$t.cloneNode(!0);return h(a,m(_e,{opponent:!0})),a}})}const Kt=p('<div><div class="card-pile-label"></div><div class="card-back"><div class="card-count"></div><img></div></div>');function re({name:e,cards:t,opponent:a,canView:n}){let o;const{state:i,sendMessage:s}=D(),r=d=>{d.preventDefault(),o.classList.add("drag-over")},u=()=>{o.classList.remove("drag-over")},l=d=>{d.preventDefault(),o.classList.remove("drag-over");const f=d.dataTransfer.getData("text");s({type:"move",params:{cardUuid:f,destination:e,gameCode:i.game.id,roomCode:i.room.code}})},c=()=>{switch(e){case"deck":return"Deck";case"discard-pile":return"Discard";default:return""}};return(()=>{const d=Kt.cloneNode(!0),f=d.firstChild,v=f.nextSibling,S=v.firstChild,k=S.nextSibling;d.addEventListener("drop",l),d.addEventListener("dragleave",u),d.addEventListener("dragover",r);const A=o;return typeof A=="function"?q(A,d):o=d,P(d,`card-pile ${e}${a?" opponent":""}`),h(f,c),h(S,()=>t.length),Z(k,"src",Ue),C(()=>P(k,t.length===0?"empty":"")),d})()}const Ut=p('<div class="opponent"><fieldset><legend class="white"></legend><div class="stats"><div class="stat panel"><div class="stat-label">Narrative</div><div class="stat-number"></div></div><div class="stat panel"><div class="stat-label">Funding</div><div class="stat-number"></div></div></div><div class="card-piles"></div></fieldset></div>'),Yt=p('<button class="end-turn-button button">End My Turn</button>'),_t=p('<div class="left-side-bar grunge"><div class="turn panel"><div class="turn-label"></div><div class="turn-number"></div></div><div class="me"><fieldset><legend class="white"></legend><div class="card-piles"></div><div class="stats"><div class="stat panel"><div class="stat-label">Narrative</div><div class="stat-number"></div></div><div class="stat panel"><div class="stat-label">Funding</div><div class="stat-number"></div></div></div></fieldset></div></div>');function jt(){const{state:e,sendMessage:t}=D(),a=I(()=>e.game.puppetMasters.find(({id:l})=>l===e.user.id)),n=I(()=>e.game.puppetMasters.length===1),o=I(()=>e.game.turn.player===e.user.id),i=I(()=>n()?null:e.game.puppetMasters.find(({id:l})=>l!==e.user.id)),s=l=>e.room.users.find(c=>c.id===l)?.name,r=I(()=>{if(n())return null;const l=i()?.id;return s(l)}),u=()=>{t({type:"end-turn",params:{gameCode:e.game.id,roomCode:e.room.code}})};return(()=>{const l=_t.cloneNode(!0),c=l.firstChild,d=c.firstChild,f=d.nextSibling,v=c.nextSibling,S=v.firstChild,k=S.firstChild,A=k.nextSibling,w=A.nextSibling,b=w.firstChild,y=b.firstChild,T=y.nextSibling,g=b.nextSibling,N=g.firstChild,G=N.nextSibling;return h(l,m(O,{get when(){return!n()},get children(){const H=Ut.cloneNode(!0),U=H.firstChild,ae=U.firstChild,ne=ae.nextSibling,oe=ne.firstChild,je=oe.firstChild,qe=je.nextSibling,Ve=oe.nextSibling,Je=Ve.firstChild,Xe=Je.nextSibling,Ae=ne.nextSibling;return h(ae,r),h(qe,()=>i().narrative),h(Xe,()=>i().funding),h(Ae,m(re,{name:"deck",get cards(){return i().deck}}),null),h(Ae,m(re,{name:"discard-pile",get cards(){return i().discardPile}}),null),H}}),c),h(d,(()=>{const H=st(()=>!!o(),!0);return()=>H()?"Your Turn":`${r()}'s Turn`})()),h(f,()=>e.game.turn.number),h(c,m(O,{get when(){return o()},get children(){const H=Yt.cloneNode(!0);return H.$$click=u,H}}),null),h(k,()=>e.user.name),h(A,m(re,{name:"deck",get cards(){return a().deck}}),null),h(A,m(re,{name:"discard-pile",get cards(){return a().discardPile}}),null),h(T,()=>a().narrative),h(G,()=>a().funding),l})()}K(["click"]);const qt=p('<div class="name teal"></div>'),Vt=p('<div class="cost yellow"><span class="white">Cost:</span> </div>'),Jt=p('<div class="type"><span class="white">Type:</span> </div>'),Xt=p('<div class="subtype"><span class="white">Subtype:</span> </div>'),Zt=p('<div class="faction"><span class="white">Faction:</span> </div>'),Qt=p('<div class="body-text"></div>'),ea=p('<div class="card-focus"><div class="focused-card"></div></div>');function ta(){const{state:e}=D(),t=I(()=>e.focus.hover||e.focus.current);return(()=>{const a=ea.cloneNode(!0),n=a.firstChild;return h(n,m(O,{get when(){return t()},get children(){return[(()=>{const o=qt.cloneNode(!0);return h(o,()=>t().name),o})(),(()=>{const o=Vt.cloneNode(!0);return o.firstChild.nextSibling,h(o,()=>t().cost,null),o})(),(()=>{const o=Jt.cloneNode(!0);return o.firstChild.nextSibling,h(o,()=>t().type,null),o})(),(()=>{const o=Xt.cloneNode(!0);return o.firstChild.nextSibling,h(o,()=>t().subType,null),o})(),(()=>{const o=Zt.cloneNode(!0);return o.firstChild.nextSibling,h(o,()=>t().faction,null),o})(),(()=>{const o=Qt.cloneNode(!0);return h(o,()=>t().bodyText),o})()]}})),a})()}const aa=p('<div><div class="options"></div><div class="game-chat"><button class="expand-button button"></button></div></div>');function na(){const{state:e,setState:t,sendMessage:a}=D(),n=()=>{a({type:"leave-game"})};return(()=>{const o=aa.cloneNode(!0),i=o.firstChild,s=i.nextSibling,r=s.firstChild;return h(i,m(j,{label:"Leave",onClick:n,small:!0})),h(o,m(ta,{}),s),r.$$click=()=>t({chatExpanded:!e.chatExpanded}),h(r,()=>e.chatExpanded?"Hide Chat":"Show Chat"),h(s,m(O,{get when(){return e.chatExpanded},get children(){return m(ze,{})}}),null),C(()=>P(o,`right-side-bar grunge${e.chatExpanded?" chat-expanded":""}`)),o})()}K(["click"]);const oa=p('<div class="plasma"></div>'),ia=p("<div></div>");function ra(){return(()=>{const t=oa.cloneNode(!0);return h(t,()=>[...Array(10)].map((a,n)=>(()=>{const o=ia.cloneNode(!0);return P(o,`bubble x${n+1}`),o})())),t})()}const sa=p("<div></div>");function _({name:e,opponent:t}){let a;const{state:n,sendMessage:o}=D(),i=I(()=>{const l=n.game.puppetMasters.find(f=>t?f.id!==n.user.id:f.id===n.user.id),c=Ft(e);return l.board[c]||[]}),s=l=>{t||(l.preventDefault(),a.classList.add("drag-over"))},r=()=>{t||a.classList.remove("drag-over")},u=l=>{if(t)return;l.preventDefault(),a.classList.remove("drag-over");const c=l.dataTransfer.getData("text");o({type:"play",params:{cardUuid:c,destination:e,gameCode:n.game.id,roomCode:n.room.code}})};return(()=>{const l=sa.cloneNode(!0);l.addEventListener("drop",u),l.addEventListener("dragleave",r),l.addEventListener("dragover",s);const c=a;return typeof c=="function"?q(c,l):a=l,P(l,`zone panel grunge ${e}${t?" opponent":""}`),h(l,()=>i().map(d=>m(Ye,{card:d,opponent:t,location:e}))),l})()}const la=p('<div class="middle grunge"></div>'),ca=p("<div></div>");function ua(){let e;const{state:t}=D(),a=I(()=>t.game.puppetMasters.length===1);return(()=>{const n=ca.cloneNode(!0),o=e;return typeof o=="function"?q(o,n):e=n,h(n,m(O,{get when(){return!a()},get children(){return[m(_,{name:"the-think-tank",opponent:!0}),m(_,{name:"buffer-zone",opponent:!0}),m(_,{name:"battle-zone",opponent:!0}),(()=>{const i=la.cloneNode(!0);return h(i,m(ra,{})),i})()]}}),null),h(n,m(_,{name:"battle-zone"}),null),h(n,m(_,{name:"buffer-zone"}),null),h(n,m(_,{name:"the-think-tank"}),null),C(()=>P(n,`main-board ${a()?" solo-play":""}`)),n})()}const ha=p('<div class="game-footer panel grunge"></div>');function da(){return(()=>{const e=ha.cloneNode(!0);return h(e,m(_e,{})),e})()}const ma=p('<div class="card-spotlight"><img></div>');function ya(){const{state:e,setState:t}=D(),a=I(()=>e.focus.spotlight),n=()=>{t(r=>({focus:{...r.focus,spotlight:null}}))},o=r=>{const l=r.pageX,c=r.pageY,d=r.target.offsetLeft+r.target.clientWidth/2,f=r.target.offsetTop+r.target.clientHeight/2,v=(l-d)/(r.target.clientWidth/2),S=-((c-f)/(r.target.clientHeight/2));r.target.style.transform="perspective(400px) rotateY("+v*5+"deg) rotateX("+S*5+"deg)"},i=r=>{setTimeout(()=>{r.target.style.transition=""},100),r.target.style.transition="transform 0.1s"},s=r=>{r.target.style.transition="transform 0.1s",setTimeout(()=>{r.target.style.transition=""},100),r.target.style.transform="perspective(400px) rotateY(0deg) rotateX(0deg)"};return m(O,{get when(){return a()},get children(){const r=ma.cloneNode(!0),u=r.firstChild;return r.$$click=n,u.addEventListener("pointerleave",s),u.addEventListener("pointerenter",i),u.$$pointermove=o,C(l=>{const c=`${a().uuid}-spotlight`,d=Ke(a().id);return c!==l._v$&&Z(u,"id",l._v$=c),d!==l._v$2&&Z(u,"src",l._v$2=d),l},{_v$:void 0,_v$2:void 0}),r}})}K(["click","pointermove"]);const fa=p('<div class="game-board"></div>');function pa(){const{state:e,setState:t}=D(),a=n=>{n.target.id!==e.focus.current?.uuid&&mainRef.contains(n.target)&&t(i=>({focus:{...i.focus,current:null}}))};return[(()=>{const n=fa.cloneNode(!0);return n.$$click=a,h(n,m(zt,{}),null),h(n,m(jt,{}),null),h(n,m(ua,{}),null),h(n,m(na,{}),null),h(n,m(da,{}),null),n})(),m(ya,{})]}K(["click"]);const ga=p('<div class="app"></div>'),ba=p('<div class="orientation"><h3>Please turn your device sideways to landscape mode.</h3></div>');function wa(){const{state:e}=D();screen?.orientation?.lock?.("landscape");const t=I(()=>!!e.room||!!e.lobby.find(n=>n.id===e.user.id)),a=()=>e.game?m(pa,{}):e.room?m(Gt,{}):m(It,{});return[(()=>{const n=ga.cloneNode(!0);return h(n,m(O,{get when(){return t()},get fallback(){return m(Tt,{})},get children(){return a()}})),n})(),ba.cloneNode(!0)]}ct(()=>m(wa,{}),document.getElementById("root"));
