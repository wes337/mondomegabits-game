(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function a(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerpolicy&&(i.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?i.credentials="include":n.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(n){if(n.ep)return;n.ep=!0;const i=a(n);fetch(n.href,i)}})();const O={};function ct(e){O.context=e}const ht=(e,t)=>e===t,$=Symbol("solid-proxy"),ve=Symbol("solid-track"),le={equals:ht};let We=je;const W=1,ce=2,ze={owned:null,cleanups:null,context:null,owner:null};var M=null;let z=null,E=null,R=null,F=null,Ie=0;function se(e,t){const a=E,o=M,n=e.length===0,i=n?ze:{owned:null,cleanups:null,context:null,owner:t||o},r=n?e:()=>e(()=>K(()=>Re(i)));M=i,E=null;try{return J(r,!0)}finally{E=a,M=o}}function x(e,t){t=t?Object.assign({},le,t):le;const a={value:e,observers:null,observerSlots:null,comparator:t.equals||void 0},o=n=>(typeof n=="function"&&(n=n(a.value)),_e(a,n));return[Ye.bind(a),o]}function N(e,t,a){const o=Me(e,t,!1,W);ae(o)}function $e(e,t,a){We=yt;const o=Me(e,t,!1,W);o.user=!0,F?F.push(o):ae(o)}function I(e,t,a){a=a?Object.assign({},le,a):le;const o=Me(e,t,!0,0);return o.observers=null,o.observerSlots=null,o.comparator=a.equals||void 0,ae(o),Ye.bind(o)}function ut(e){return J(e,!1)}function K(e){let t,a=E;return E=null,t=e(),E=a,t}function Ce(e){$e(()=>K(e))}function Ke(e){return M===null||(M.cleanups===null?M.cleanups=[e]:M.cleanups.push(e)),e}function Ue(){return E}function Ye(){const e=z;if(this.sources&&(this.state||e))if(this.state===W||e)ae(this);else{const t=R;R=null,J(()=>ue(this),!1),R=t}if(E){const t=this.observers?this.observers.length:0;E.sources?(E.sources.push(this),E.sourceSlots.push(t)):(E.sources=[this],E.sourceSlots=[t]),this.observers?(this.observers.push(E),this.observerSlots.push(E.sources.length-1)):(this.observers=[E],this.observerSlots=[E.sources.length-1])}return this.value}function _e(e,t,a){let o=e.value;return(!e.comparator||!e.comparator(o,t))&&(e.value=t,e.observers&&e.observers.length&&J(()=>{for(let n=0;n<e.observers.length;n+=1){const i=e.observers[n],r=z&&z.running;r&&z.disposed.has(i),(r&&!i.tState||!r&&!i.state)&&(i.pure?R.push(i):F.push(i),i.observers&&qe(i)),r||(i.state=W)}if(R.length>1e6)throw R=[],new Error},!1)),t}function ae(e){if(!e.fn)return;Re(e);const t=M,a=E,o=Ie;E=M=e,dt(e,e.value,o),E=a,M=t}function dt(e,t,a){let o;try{o=e.fn(t)}catch(n){e.pure&&(e.state=W),Ve(n)}(!e.updatedAt||e.updatedAt<=a)&&(e.updatedAt!=null&&"observers"in e?_e(e,o):e.value=o,e.updatedAt=a)}function Me(e,t,a,o=W,n){const i={fn:e,state:o,updatedAt:null,owned:null,sources:null,sourceSlots:null,cleanups:null,value:t,owner:M,context:null,pure:a};return M===null||M!==ze&&(M.owned?M.owned.push(i):M.owned=[i]),i}function he(e){const t=z;if(e.state===0||t)return;if(e.state===ce||t)return ue(e);if(e.suspense&&K(e.suspense.inFallback))return e.suspense.effects.push(e);const a=[e];for(;(e=e.owner)&&(!e.updatedAt||e.updatedAt<Ie);)(e.state||t)&&a.push(e);for(let o=a.length-1;o>=0;o--)if(e=a[o],e.state===W||t)ae(e);else if(e.state===ce||t){const n=R;R=null,J(()=>ue(e,a[0]),!1),R=n}}function J(e,t){if(R)return e();let a=!1;t||(R=[]),F?a=!0:F=[],Ie++;try{const o=e();return mt(a),o}catch(o){R||(F=null),Ve(o)}}function mt(e){if(R&&(je(R),R=null),e)return;const t=F;F=null,t.length&&J(()=>We(t),!1)}function je(e){for(let t=0;t<e.length;t++)he(e[t])}function yt(e){let t,a=0;for(t=0;t<e.length;t++){const o=e[t];o.user?e[a++]=o:he(o)}for(O.context&&ct(),t=0;t<a;t++)he(e[t])}function ue(e,t){const a=z;e.state=0;for(let o=0;o<e.sources.length;o+=1){const n=e.sources[o];n.sources&&(n.state===W||a?n!==t&&he(n):(n.state===ce||a)&&ue(n,t))}}function qe(e){const t=z;for(let a=0;a<e.observers.length;a+=1){const o=e.observers[a];(!o.state||t)&&(o.state=ce,o.pure?R.push(o):F.push(o),o.observers&&qe(o))}}function Re(e){let t;if(e.sources)for(;e.sources.length;){const a=e.sources.pop(),o=e.sourceSlots.pop(),n=a.observers;if(n&&n.length){const i=n.pop(),r=a.observerSlots.pop();o<n.length&&(i.sourceSlots[r]=o,n[o]=i,a.observerSlots[o]=r)}}if(e.owned){for(t=0;t<e.owned.length;t++)Re(e.owned[t]);e.owned=null}if(e.cleanups){for(t=0;t<e.cleanups.length;t++)e.cleanups[t]();e.cleanups=null}e.state=0,e.context=null}function ft(e){return e instanceof Error||typeof e=="string"?e:new Error("Unknown error")}function Ve(e){throw e=ft(e),e}const pt=Symbol("fallback");function Be(e){for(let t=0;t<e.length;t++)e[t]()}function gt(e,t,a={}){let o=[],n=[],i=[],r=0,s=t.length>1?[]:null;return Ke(()=>Be(i)),()=>{let h=e()||[],c,l;return h[ve],K(()=>{let y=h.length,p,v,g,A,m,b,w,k,S;if(y===0)r!==0&&(Be(i),i=[],o=[],n=[],r=0,s&&(s=[])),a.fallback&&(o=[pt],n[0]=se(D=>(i[0]=D,a.fallback())),r=1);else if(r===0){for(n=new Array(y),l=0;l<y;l++)o[l]=h[l],n[l]=se(d);r=y}else{for(g=new Array(y),A=new Array(y),s&&(m=new Array(y)),b=0,w=Math.min(r,y);b<w&&o[b]===h[b];b++);for(w=r-1,k=y-1;w>=b&&k>=b&&o[w]===h[k];w--,k--)g[k]=n[w],A[k]=i[w],s&&(m[k]=s[w]);for(p=new Map,v=new Array(k+1),l=k;l>=b;l--)S=h[l],c=p.get(S),v[l]=c===void 0?-1:c,p.set(S,l);for(c=b;c<=w;c++)S=o[c],l=p.get(S),l!==void 0&&l!==-1?(g[l]=n[c],A[l]=i[c],s&&(m[l]=s[c]),l=v[l],p.set(S,l)):i[c]();for(l=b;l<y;l++)l in g?(n[l]=g[l],i[l]=A[l],s&&(s[l]=m[l],s[l](l))):n[l]=se(d);n=n.slice(0,r=y),o=h.slice(0)}return n});function d(y){if(i[l]=y,s){const[p,v]=x(l);return s[l]=v,t(h[l],p)}return t(h[l])}}}function f(e,t){return K(()=>e(t||{}))}function Q(e){const t="fallback"in e&&{fallback:()=>e.fallback};return I(gt(()=>e.each,e.children,t||void 0))}function B(e){let t=!1;const a=e.keyed,o=I(()=>e.when,void 0,{equals:(n,i)=>t?n===i:!n==!i});return I(()=>{const n=o();if(n){const i=e.children,r=typeof i=="function"&&i.length>0;return t=a||r,r?K(()=>i(n)):i}return e.fallback})}function bt(e,t){return I(e,void 0,t?void 0:{equals:t})}function wt(e,t,a){let o=a.length,n=t.length,i=o,r=0,s=0,h=t[n-1].nextSibling,c=null;for(;r<n||s<i;){if(t[r]===a[s]){r++,s++;continue}for(;t[n-1]===a[i-1];)n--,i--;if(n===r){const l=i<o?s?a[s-1].nextSibling:a[i-s]:h;for(;s<i;)e.insertBefore(a[s++],l)}else if(i===s)for(;r<n;)(!c||!c.has(t[r]))&&t[r].remove(),r++;else if(t[r]===a[i-1]&&a[s]===t[n-1]){const l=t[--n].nextSibling;e.insertBefore(a[s++],t[r++].nextSibling),e.insertBefore(a[--i],l),t[n]=a[i]}else{if(!c){c=new Map;let d=s;for(;d<i;)c.set(a[d],d++)}const l=c.get(t[r]);if(l!=null)if(s<l&&l<i){let d=r,y=1,p;for(;++d<n&&d<i&&!((p=c.get(t[d]))==null||p!==l+y);)y++;if(y>l-s){const v=t[r];for(;s<l;)e.insertBefore(a[s++],v)}else e.replaceChild(a[s++],t[r++])}else r++;else t[r++].remove()}}}const Fe="_$DX_DELEGATE";function Tt(e,t,a){let o;return se(n=>{o=n,t===document?e():u(t,e(),t.firstChild?null:void 0,a)}),()=>{o(),t.textContent=""}}function T(e,t,a){const o=document.createElement("template");o.innerHTML=e;let n=o.content.firstChild;return a&&(n=n.firstChild),n}function pe(e,t=window.document){const a=t[Fe]||(t[Fe]=new Set);for(let o=0,n=e.length;o<n;o++){const i=e[o];a.has(i)||(a.add(i),t.addEventListener(i,kt))}}function ke(e,t,a){a==null?e.removeAttribute(t):e.setAttribute(t,a)}function H(e,t){t==null?e.removeAttribute("class"):e.className=t}function vt(e,t,a,o){if(o)Array.isArray(a)?(e[`$$${t}`]=a[0],e[`$$${t}Data`]=a[1]):e[`$$${t}`]=a;else if(Array.isArray(a)){const n=a[0];e.addEventListener(t,a[0]=i=>n.call(e,a[1],i))}else e.addEventListener(t,a)}function V(e,t,a){return K(()=>e(t,a))}function u(e,t,a,o){if(a!==void 0&&!o&&(o=[]),typeof t!="function")return de(e,t,o,a);N(n=>de(e,t(),n,a),o)}function kt(e){const t=`$$${e.type}`;let a=e.composedPath&&e.composedPath()[0]||e.target;for(e.target!==a&&Object.defineProperty(e,"target",{configurable:!0,value:a}),Object.defineProperty(e,"currentTarget",{configurable:!0,get(){return a||document}}),O.registry&&!O.done&&(O.done=!0,document.querySelectorAll("[id^=pl-]").forEach(o=>o.remove()));a!==null;){const o=a[t];if(o&&!a.disabled){const n=a[`${t}Data`];if(n!==void 0?o.call(a,n,e):o.call(a,e),e.cancelBubble)return}a=a.host&&a.host!==a&&a.host instanceof Node?a.host:a.parentNode}}function de(e,t,a,o,n){for(O.context&&!a&&(a=[...e.childNodes]);typeof a=="function";)a=a();if(t===a)return a;const i=typeof t,r=o!==void 0;if(e=r&&a[0]&&a[0].parentNode||e,i==="string"||i==="number"){if(O.context)return a;if(i==="number"&&(t=t.toString()),r){let s=a[0];s&&s.nodeType===3?s.data=t:s=document.createTextNode(t),a=_(e,a,o,s)}else a!==""&&typeof a=="string"?a=e.firstChild.data=t:a=e.textContent=t}else if(t==null||i==="boolean"){if(O.context)return a;a=_(e,a,o)}else{if(i==="function")return N(()=>{let s=t();for(;typeof s=="function";)s=s();a=de(e,s,a,o)}),()=>a;if(Array.isArray(t)){const s=[],h=a&&Array.isArray(a);if(Se(s,t,a,n))return N(()=>a=de(e,s,a,o,!0)),()=>a;if(O.context){if(!s.length)return a;for(let c=0;c<s.length;c++)if(s[c].parentNode)return a=s}if(s.length===0){if(a=_(e,a,o),r)return a}else h?a.length===0?xe(e,s,o):wt(e,a,s):(a&&_(e),xe(e,s));a=s}else if(t instanceof Node){if(O.context&&t.parentNode)return a=r?[t]:t;if(Array.isArray(a)){if(r)return a=_(e,a,o,t);_(e,a,null,t)}else a==null||a===""||!e.firstChild?e.appendChild(t):e.replaceChild(t,e.firstChild);a=t}}return a}function Se(e,t,a,o){let n=!1;for(let i=0,r=t.length;i<r;i++){let s=t[i],h=a&&a[i];if(s instanceof Node)e.push(s);else if(!(s==null||s===!0||s===!1))if(Array.isArray(s))n=Se(e,s,h)||n;else if(typeof s=="function")if(o){for(;typeof s=="function";)s=s();n=Se(e,Array.isArray(s)?s:[s],Array.isArray(h)?h:[h])||n}else e.push(s),n=!0;else{const c=String(s);h&&h.nodeType===3&&h.data===c?e.push(h):e.push(document.createTextNode(c))}}return n}function xe(e,t,a){for(let o=0,n=t.length;o<n;o++)e.insertBefore(t[o],a)}function _(e,t,a,o){if(a===void 0)return e.textContent="";const n=o||document.createTextNode("");if(t.length){let i=!1;for(let r=t.length-1;r>=0;r--){const s=t[r];if(n!==s){const h=s.parentNode===e;!i&&!r?h?e.replaceChild(n,s):e.insertBefore(n,a):h&&s.remove()}else i=!0}}else e.insertBefore(n,a);return[n]}const Ae=Symbol("store-raw"),ee=Symbol("store-node"),St=Symbol("store-name");function Je(e,t){let a=e[$];if(!a&&(Object.defineProperty(e,$,{value:a=new Proxy(e,It)}),!Array.isArray(e))){const o=Object.keys(e),n=Object.getOwnPropertyDescriptors(e);for(let i=0,r=o.length;i<r;i++){const s=o[i];if(n[s].get){const h=n[s].get.bind(a);Object.defineProperty(e,s,{get:h})}}}return a}function me(e){let t;return e!=null&&typeof e=="object"&&(e[$]||!(t=Object.getPrototypeOf(e))||t===Object.prototype||Array.isArray(e))}function te(e,t=new Set){let a,o,n,i;if(a=e!=null&&e[Ae])return a;if(!me(e)||t.has(e))return e;if(Array.isArray(e)){Object.isFrozen(e)?e=e.slice(0):t.add(e);for(let r=0,s=e.length;r<s;r++)n=e[r],(o=te(n,t))!==n&&(e[r]=o)}else{Object.isFrozen(e)?e=Object.assign({},e):t.add(e);const r=Object.keys(e),s=Object.getOwnPropertyDescriptors(e);for(let h=0,c=r.length;h<c;h++)i=r[h],!s[i].get&&(n=e[i],(o=te(n,t))!==n&&(e[i]=o))}return e}function ye(e){let t=e[ee];return t||Object.defineProperty(e,ee,{value:t={}}),t}function Ee(e,t,a){return e[t]||(e[t]=Xe(a))}function At(e,t){const a=Reflect.getOwnPropertyDescriptor(e,t);return!a||a.get||!a.configurable||t===$||t===ee||t===St||(delete a.value,delete a.writable,a.get=()=>e[$][t]),a}function Ze(e){if(Ue()){const t=ye(e);(t._||(t._=Xe()))()}}function Et(e){return Ze(e),Reflect.ownKeys(e)}function Xe(e){const[t,a]=x(e,{equals:!1,internal:!0});return t.$=a,t}const It={get(e,t,a){if(t===Ae)return e;if(t===$)return a;if(t===ve)return Ze(e),a;const o=ye(e),n=o.hasOwnProperty(t);let i=n?o[t]():e[t];if(t===ee||t==="__proto__")return i;if(!n){const r=Object.getOwnPropertyDescriptor(e,t);Ue()&&(typeof i!="function"||e.hasOwnProperty(t))&&!(r&&r.get)&&(i=Ee(o,t,i)())}return me(i)?Je(i):i},has(e,t){if(t===Ae||t===$||t===ve||t===ee||t==="__proto__")return!0;const a=ye(e)[t];return a&&a(),t in e},set(){return!0},deleteProperty(){return!0},ownKeys:Et,getOwnPropertyDescriptor:At};function fe(e,t,a,o=!1){if(!o&&e[t]===a)return;const n=e[t],i=e.length;a===void 0?delete e[t]:e[t]=a;let r=ye(e),s;(s=Ee(r,t,n))&&s.$(()=>a),Array.isArray(e)&&e.length!==i&&(s=Ee(r,"length",i))&&s.$(e.length),(s=r._)&&s.$()}function Qe(e,t){const a=Object.keys(t);for(let o=0;o<a.length;o+=1){const n=a[o];fe(e,n,t[n])}}function Ct(e,t){if(typeof t=="function"&&(t=t(e)),t=te(t),Array.isArray(t)){if(e===t)return;let a=0,o=t.length;for(;a<o;a++){const n=t[a];e[a]!==n&&fe(e,a,n)}fe(e,"length",o)}else Qe(e,t)}function X(e,t,a=[]){let o,n=e;if(t.length>1){o=t.shift();const r=typeof o,s=Array.isArray(e);if(Array.isArray(o)){for(let h=0;h<o.length;h++)X(e,[o[h]].concat(t),a);return}else if(s&&r==="function"){for(let h=0;h<e.length;h++)o(e[h],h)&&X(e,[h].concat(t),a);return}else if(s&&r==="object"){const{from:h=0,to:c=e.length-1,by:l=1}=o;for(let d=h;d<=c;d+=l)X(e,[d].concat(t),a);return}else if(t.length>1){X(e[o],t,[o].concat(a));return}n=e[o],a=[o].concat(a)}let i=t[0];typeof i=="function"&&(i=i(n,a),i===n)||o===void 0&&i==null||(i=te(i),o===void 0||me(n)&&me(i)&&!Array.isArray(i)?Qe(n,i):fe(e,o,i))}function Mt(...[e,t]){const a=te(e||{}),o=Array.isArray(a),n=Je(a);function i(...r){ut(()=>{o&&r.length===1?Ct(a,r[0]):X(a,r)})}return[n,i]}const Rt={user:{id:"",name:""},connected:!1,lobby:[],room:null,rooms:{},game:void 0,focus:{current:null,hover:null},chatExpanded:!1},ie=new WebSocket(process?.env?.WS_SERVER||"wss://mondo-megabits.herokuapp.com");function G(){const[e,t]=Mt(Rt),a=o=>{ie.send(JSON.stringify(o))};return ie.onopen=()=>{t({connected:!0}),setInterval(()=>{a({type:"ping"})},4e4)},ie.onclose=()=>{t({connected:!1})},ie.onmessage=o=>{const{type:n,params:i}=JSON.parse(o.data);switch(n){case"connected":{t({user:{name:"",id:i.id}});break}case"lobby":{t({lobby:i.users,room:null,rooms:i.otherRooms||[]});break}case"join":{const{roomCode:r,users:s}=i;t(h=>({lobby:h.lobby.filter(c=>c.id!==h.user.id),room:{code:r,users:s,chatMessages:h.room?.chatMessages||[]}}));break}case"leave":{const{userId:r}=i;t({room:r===e.user.id?null:{...e.room,users:e.room.users.filter(s=>s.id!==r)}});break}case"leave-game":{const{roomCode:r,users:s}=i;t({game:null,room:{code:r,users:s,chatMessages:e.room?.chatMessages||[]}});break}case"chat":{if(i.chatMessage.user.id!==e.user.id){t(r=>({room:{...r.room,chatMessages:[...r.room?.chatMessages||[],i.chatMessage]}}));break}break}case"ready":{const{userId:r,status:s}=i;t(h=>({room:{...h.room,users:h.room.users.map(c=>c.id!==r?c:{...c,status:s})}}));break}case"game":{const{game:r}=i;t({game:r});break}default:{console.log("Got unknown message type: ",n);break}}},{state:e,setState:t,sendMessage:a}}const Dt=T('<div class="connect"><div class="video"><video autoplay="true" loop="true" playsinline="true" muted><source type="video/mp4; codecs=&quot;av01.0.13M.10&quot;" src="https://cdn.mondomegabits.com/logo/Mondo flashing logo_r3 - strobe.mp4"></video></div><form class="puppet-master-handle-input"><label>Puppet Master Handle:</label><input type="text"><button class="connect-button button" type="submit">Connect</button></form></div>');function Nt(){let e;const{sendMessage:t,setState:a}=G(),[o,n]=x("");Ce(()=>{e.focus()});const i=r=>{r.preventDefault(),o().length!==0&&(t({type:"lobby",params:{userName:o()}}),a(s=>({user:{...s.user,name:o()}})))};return(()=>{const r=Dt.cloneNode(!0),s=r.firstChild,h=s.nextSibling,c=h.firstChild,l=c.nextSibling;h.addEventListener("submit",i),l.addEventListener("change",y=>n(y.target.value));const d=e;return typeof d=="function"?V(d,l):e=l,N(()=>l.value=o()),r})()}const Ht=T('<button type="button"><div class="circle"></div><div class="label"></div></button>');function q({label:e,onClick:t,disabled:a,color:o,small:n}){const i=()=>{let r="circle-button button";return o&&(r+=` ${o}`),n&&(r+=" small"),a&&(r+=" disabled"),r};return(()=>{const r=Ht.cloneNode(!0),s=r.firstChild,h=s.nextSibling;return vt(r,"click",t,!0),r.disabled=a,u(h,e),N(()=>H(r,i())),r})()}pe(["click"]);const Gt=T('<div class="modal"><div class="join-room panel"><form><label>Room code:</label><input type="text"><div class="modal-footer"><button class="button" type="submit">OK</button><button class="button" type="button">Cancel</button></div></form></div></div>'),Pt=T('<div class="lobby"><div class="rooms"><div class="headers yellow"><div class="header">Code</div><div class="header">Users</div><div class="header">Status</div></div><hr class="tall"></div><div class="users"><span class="yellow">/// </span>Puppet Masters Online:<hr class="top"><ul class="list"></ul><hr class="bottom"></div><div class="footer panel"></div></div>'),Ot=T('<div class="room"><div class="room-code teal"></div><div class="room-users white"> / </div><div></div><div class="room-join"></div></div>'),Bt=T("<li></li>");function Ft(){const{state:e,sendMessage:t}=G(),[a,o]=x(!1),[n,i]=x(""),r=()=>{t({type:"create"})},s=h=>{h.preventDefault();const c=n();!c||t({type:"join",params:{roomCode:c}})};return(()=>{const h=Pt.cloneNode(!0),c=h.firstChild;c.firstChild.nextSibling;const d=c.nextSibling,y=d.firstChild,p=y.nextSibling,v=p.nextSibling,g=v.nextSibling,A=d.nextSibling;return u(c,f(Q,{get each(){return e.rooms},children:m=>(()=>{const b=Ot.cloneNode(!0),w=b.firstChild,k=w.nextSibling,S=k.firstChild,D=k.nextSibling,P=D.nextSibling;return u(w,()=>m.code),u(k,()=>m.users,S),u(k,()=>m.maxUsers,null),u(D,()=>m.status.toUpperCase()),u(P,f(q,{label:"Join",get disabled(){return m.status!=="open"},onClick:()=>{t({type:"join",params:{roomCode:m.code}})},color:"red",small:!0})),N(()=>H(D,`room-status${m.status==="full"?" red":""}`)),b})()}),null),u(g,f(Q,{get each(){return e.lobby},children:m=>(()=>{const b=Bt.cloneNode(!0);return u(b,()=>m.name),N(()=>H(b,m.id===e.user.id?"glow":"white")),b})()})),u(A,f(q,{label:"Create",onClick:r}),null),u(A,f(q,{label:"Join",onClick:()=>{o(!0),i("")}}),null),u(h,f(B,{get when(){return a()},get children(){const m=Gt.cloneNode(!0),b=m.firstChild,w=b.firstChild,k=w.firstChild,S=k.nextSibling,D=S.nextSibling,P=D.firstChild,U=P.nextSibling;return w.addEventListener("submit",s),S.addEventListener("change",Y=>i(Y.target.value)),U.$$click=()=>o(!1),N(()=>P.disabled=n().length===0),N(()=>S.value=n()),m}}),null),h})()}pe(["click"]);const xt=T('<div class="message system"><p class="red italic"><span class="white">[ </span><span class="white"> ]</span></p><div class="message-date yellow"></div></div>'),Lt=T('<div class="chat"><div class="messages"></div><form><input type="text"><button class="button" type="submit">Send</button></form></div>'),Wt=T('<div class="message"><p><span></span> </p><div class="message-date yellow"></div></div>');function et(){let e,t;const{state:a,setState:o,sendMessage:n}=G(),[i,r]=x("");Ce(()=>{t?.focus?.()}),$e(()=>{!e||a.room?.chatMessages.length===0||(e.scrollTop=e.scrollHeight)});const s=c=>{c.preventDefault();const l=i();if(l.length===0)return;const d={message:l,date:new Date().toLocaleTimeString("en-US")};o(y=>({room:{...y.room,chatMessages:[...y.room.chatMessages,{...d,user:y.user}]}})),n({type:"chat",params:{roomCode:a.room.code,chatMessage:d}}),r("")},h=c=>(()=>{const l=xt.cloneNode(!0),d=l.firstChild,y=d.firstChild,p=y.nextSibling,v=d.nextSibling;return u(d,()=>c.message,p),u(v,()=>c.date),l})();return(()=>{const c=Lt.cloneNode(!0),l=c.firstChild,d=l.nextSibling,y=d.firstChild,p=e;typeof p=="function"?V(p,l):e=l,u(l,f(Q,{get each(){return a.room.chatMessages},children:g=>g.user.id==="SYSTEM"?h(g):(()=>{const A=Wt.cloneNode(!0),m=A.firstChild,b=m.firstChild;b.nextSibling;const w=m.nextSibling;return u(b,()=>g.user.name),u(m,()=>g.message,null),u(w,()=>g.date),N(()=>H(b,`message-user ${g.user.id===a.user.id?"teal":"white"}`)),A})()})),d.addEventListener("submit",s),y.addEventListener("change",g=>r(g.target.value));const v=t;return typeof v=="function"?V(v,y):t=y,N(()=>y.value=i()),c})()}const zt=T('<div class="countdown"><h1 class="white">Starting in:</h1><div class="count"><span class="glow"></span></div></div>');function $t({from:e=5,callback:t=()=>{}}){const[a,o]=x(),[n,i]=x(e),r=()=>{!a()&&n()>0&&o(setInterval(s,1e3))},s=()=>{let h=n()-1;i(h),h===0&&(clearInterval(a()),t?.())};return Ce(()=>{r()}),Ke(()=>{clearInterval(a())}),f(B,{get when(){return n()>0},get children(){const h=zt.cloneNode(!0),c=h.firstChild,l=c.nextSibling,d=l.firstChild;return u(d,n),h}})}const Kt=T('<div class="room"><div class="main"><div class="header"><div class="room-name"><hr class="dotted-double"><h1 class="wide color-change"></h1><hr class="dotted-double"></div></div></div><div class="users"><span class="yellow">/// </span>Puppet Masters In Room:<hr class="top"><ul class="list"></ul><hr class="bottom"></div><div class="footer panel"></div></div>'),Ut=T('<li><div class="name"><span></span></div><div class="status"><div class="check"><span class="red">[</span><span class="yellow"></span><span class="red">]</span></div></div></li>');function Yt(){const[e,t]=x(!1),{state:a,sendMessage:o}=G(),n=I(()=>!a.room?.users?.find(c=>c.status!=="ready")),i=I(()=>a.room?.users?.find(c=>c.id===a.user.id&&c.status==="ready")),r=()=>{o({type:"leave"})},s=()=>{o({type:"start"})},h=()=>{const c=!i(),l=c?"ready":"waiting";o({type:"ready",params:{roomCode:a.room.code,status:l}}),t(c)};return(()=>{const c=Kt.cloneNode(!0),l=c.firstChild,d=l.firstChild,y=d.firstChild,p=y.firstChild,v=p.nextSibling,g=l.nextSibling,A=g.firstChild,m=A.nextSibling,b=m.nextSibling,w=b.nextSibling,k=g.nextSibling;return u(v,()=>a.room.code),u(d,f(B,{get when(){return n()},get children(){return f($t,{callback:s})}}),null),u(l,f(et,{}),null),u(w,f(Q,{get each(){return a.room.users},children:S=>(()=>{const D=Ut.cloneNode(!0),P=D.firstChild,U=P.firstChild,Y=P.nextSibling,ge=Y.firstChild,be=ge.firstChild,we=be.nextSibling;return u(U,()=>S.name),u(we,()=>S.status==="ready"?"\u2713":" "),u(Y,()=>S.status.toUpperCase(),null),N(()=>H(U,S.id===a.user.id?"glow":"white")),D})()})),u(k,f(q,{get label(){return i()?"Unready":"Ready"},onClick:h,color:"red"}),null),u(k,f(q,{label:"Leave",onClick:r}),null),c})()}const _t=[{id:1,name:"Wireless Vaccine+-",faction:"FAKE TECH",rarity:4,frameSize:"C",type:"Item",subtype:"Weapon",bodyText:`"Not feeling well? Well, maybe it's 'cause you're always on that phone."
...
Long Warp: Play one round of Rock-Paper-Scissors with your opponent. If you win, receive 1x Teleportation Token, giving you a free instant dodge from an attack of your choice. If you lose, discard the top card of your deck.`,variantId:131,fileStem:"0094a"}],jt=e=>`https://mondomegabits.com/card/img/95/${e.fileStem}.jpg`,qt=e=>{const t=_t.find(a=>a.id.toString()===e.toString());return jt(t)},Vt=e=>e.replace(/-([a-z])/g,t=>t[1].toUpperCase());const tt=""+new URL("card-back.1c57677c.png",import.meta.url).href;const Jt=T("<div draggable><img></div>");function at({card:e,opponent:t,location:a}){const{state:o,setState:n,sendMessage:i}=G(),r=a==="hand"&&t||e.faceDown,s=I(()=>["battle-zone","the-think-tank","buffer-zone"].includes(a)),h=()=>{t||i({type:"tap",params:{cardUuid:e.uuid,gameCode:o.game.id,roomCode:o.room.code}})},c=m=>{t||m.dataTransfer.setData("text",e.uuid)},l=()=>{t&&r||(o.focus.current?.uuid===e.uuid?d():n(m=>({focus:{...m.focus,current:e}})))},d=()=>{t&&r||n(m=>({focus:{...m.focus,current:null}}))},y=()=>{t&&r||n(m=>({focus:{...m.focus,hover:e}}))},p=()=>{t&&r||n(m=>({focus:{...m.focus,hover:null}}))},v=()=>{s()&&h()},g=m=>{switch(m.detail){case 1:l();break;case 2:v();break}},A=()=>{let m="card";return t&&(m+=" opponent"),o.focus.current?.uuid===e.uuid&&(m+=" focus"),e.tapped&&(m+=" tapped"),m};return(()=>{const m=Jt.cloneNode(!0),b=m.firstChild;return m.addEventListener("dragstart",c),m.addEventListener("pointerleave",p),m.addEventListener("pointerenter",y),m.$$click=g,N(w=>{const k=A(),S=e.uuid,D=r?tt:qt(e.id);return k!==w._v$&&H(m,w._v$=k),S!==w._v$2&&ke(b,"id",w._v$2=S),D!==w._v$3&&ke(b,"src",w._v$3=D),w},{_v$:void 0,_v$2:void 0,_v$3:void 0}),m})()}pe(["click"]);const Zt=T("<div></div>");function Le({opponent:e}){const{state:t}=G(),a=I(()=>t.game.puppetMasters.find(({id:n})=>n===t.user.id)?.hand),o=I(()=>t.game.puppetMasters.find(({id:n})=>n!==t.user.id)?.hand);return(()=>{const n=Zt.cloneNode(!0);return H(n,`hand${e?" opponent":""}`),u(n,f(Q,{get each(){return e?o():a()},children:i=>f(at,{card:i,faceDown:e,opponent:e,location:"hand"})})),n})()}const Xt=T('<div class="name teal"></div>'),Qt=T('<div class="cost yellow"><span class="white">Cost:</span> </div>'),ea=T('<div class="type"><span class="white">Type:</span> </div>'),ta=T('<div class="subtype"><span class="white">Subtype:</span> </div>'),aa=T('<div class="faction"><span class="white">Faction:</span> </div>'),na=T('<div class="body-text"></div>'),oa=T('<div class="card-focus"><div class="focused-card"></div></div>');function ia(){const{state:e}=G(),t=I(()=>e.focus.hover||e.focus.current);return(()=>{const a=oa.cloneNode(!0),o=a.firstChild;return u(o,f(B,{get when(){return t()},get children(){return[(()=>{const n=Xt.cloneNode(!0);return u(n,()=>t().name),n})(),(()=>{const n=Qt.cloneNode(!0);return n.firstChild.nextSibling,u(n,()=>t().cost,null),n})(),(()=>{const n=ea.cloneNode(!0);return n.firstChild.nextSibling,u(n,()=>t().type,null),n})(),(()=>{const n=ta.cloneNode(!0);return n.firstChild.nextSibling,u(n,()=>t().subType,null),n})(),(()=>{const n=aa.cloneNode(!0);return n.firstChild.nextSibling,u(n,()=>t().faction,null),n})(),(()=>{const n=na.cloneNode(!0);return u(n,()=>t().bodyText),n})()]}})),a})()}const ra=T("<div></div>");function j({name:e,opponent:t}){let a;const{state:o,sendMessage:n}=G(),i=I(()=>{const c=o.game.puppetMasters.find(y=>t?y.id!==o.user.id:y.id===o.user.id),l=Vt(e);return c.board[l]||[]}),r=c=>{t||(c.preventDefault(),a.classList.add("drag-over"))},s=()=>{t||a.classList.remove("drag-over")},h=c=>{if(t)return;c.preventDefault(),a.classList.remove("drag-over");const l=c.dataTransfer.getData("text");n({type:"play",params:{cardUuid:l,destination:e,gameCode:o.game.id,roomCode:o.room.code}})};return(()=>{const c=ra.cloneNode(!0);c.addEventListener("drop",h),c.addEventListener("dragleave",s),c.addEventListener("dragover",r);const l=a;return typeof l=="function"?V(l,c):a=c,H(c,`zone panel grunge ${e}${t?" opponent":""}`),u(c,()=>i().map(d=>f(at,{card:d,opponent:t,location:e}))),c})()}const sa=T('<div><div class="card-pile-label"></div><div class="card-back"><div class="card-count"></div><img></div></div>');function re({name:e,cards:t,opponent:a,canView:o}){let n;const{state:i,sendMessage:r}=G(),s=d=>{d.preventDefault(),n.classList.add("drag-over")},h=()=>{n.classList.remove("drag-over")},c=d=>{d.preventDefault(),n.classList.remove("drag-over");const y=d.dataTransfer.getData("text");r({type:"move",params:{cardUuid:y,destination:e,gameCode:i.game.id,roomCode:i.room.code}})},l=()=>{switch(e){case"deck":return"Deck";case"discard-pile":return"Discard";default:return""}};return(()=>{const d=sa.cloneNode(!0),y=d.firstChild,p=y.nextSibling,v=p.firstChild,g=v.nextSibling;d.addEventListener("drop",c),d.addEventListener("dragleave",h),d.addEventListener("dragover",s);const A=n;return typeof A=="function"?V(A,d):n=d,H(d,`card-pile ${e}${a?" opponent":""}`),u(y,l),u(v,()=>t.length),ke(g,"src",tt),N(()=>H(g,t.length===0?"empty":"")),d})()}const la=T('<div class="header grunge"></div>'),ca=T('<div class="opponent"><fieldset><legend class="white"></legend><div class="stats"><div class="stat panel"><div class="stat-label">Narrative</div><div class="stat-number"></div></div><div class="stat panel"><div class="stat-label">Funding</div><div class="stat-number"></div></div></div><div class="card-piles"></div></fieldset></div>'),ha=T('<button class="end-turn-button button">End My Turn</button>'),ua=T('<div class="middle grunge"><hr class="dotted-double"></div>'),da=T('<div class="game-board"><div class="left-side-bar grunge"><div class="turn panel"><div class="turn-label"></div><div class="turn-number"></div></div><div class="me"><fieldset><legend class="white"></legend><div class="card-piles"></div><div class="stats"><div class="stat panel"><div class="stat-label">Narrative</div><div class="stat-number"></div></div><div class="stat panel"><div class="stat-label">Funding</div><div class="stat-number"></div></div></div></fieldset></div></div><div></div><div><div class="options"></div><div class="game-chat"><button class="expand-button button"></button></div></div><div class="footer panel grunge"></div></div>');function ma(){let e;const{state:t,setState:a,sendMessage:o}=G(),n=I(()=>t.game.puppetMasters.find(({id:p})=>p===t.user.id)),i=p=>t.room.users.find(v=>v.id===p)?.name,r=I(()=>t.game.puppetMasters.length===1),s=I(()=>r()?null:t.game.puppetMasters.find(({id:p})=>p!==t.user.id)),h=I(()=>{if(r())return null;const p=s()?.id;return i(p)}),c=I(()=>t.game.turn.player===t.user.id),l=()=>{o({type:"leave-game"})},d=()=>{o({type:"end-turn",params:{gameCode:t.game.id,roomCode:t.room.code}})},y=p=>{p.target.id!==t.focus.current?.uuid&&e.contains(p.target)&&a(g=>({focus:{...g.focus,current:null}}))};return(()=>{const p=da.cloneNode(!0),v=p.firstChild,g=v.firstChild,A=g.firstChild,m=A.nextSibling,b=g.nextSibling,w=b.firstChild,k=w.firstChild,S=k.nextSibling,D=S.nextSibling,P=D.firstChild,U=P.firstChild,Y=U.nextSibling,ge=P.nextSibling,be=ge.firstChild,we=be.nextSibling,L=v.nextSibling,ne=L.nextSibling,De=ne.firstChild,Te=De.nextSibling,Ne=Te.firstChild,nt=ne.nextSibling;p.$$click=y,u(p,f(B,{get when(){return!r()},get children(){const C=la.cloneNode(!0);return u(C,f(Le,{opponent:!0})),C}}),v),u(v,f(B,{get when(){return!r()},get children(){const C=ca.cloneNode(!0),oe=C.firstChild,Z=oe.firstChild,Ge=Z.nextSibling,Pe=Ge.firstChild,ot=Pe.firstChild,it=ot.nextSibling,rt=Pe.nextSibling,st=rt.firstChild,lt=st.nextSibling,Oe=Ge.nextSibling;return u(Z,h),u(it,()=>s().narrative),u(lt,()=>s().funding),u(Oe,f(re,{name:"deck",get cards(){return s().deck}}),null),u(Oe,f(re,{name:"discard-pile",get cards(){return s().discardPile}}),null),C}}),g),u(A,(()=>{const C=bt(()=>!!c(),!0);return()=>C()?"Your Turn":`${h()}'s Turn`})()),u(m,()=>t.game.turn.number),u(g,f(B,{get when(){return c()},get children(){const C=ha.cloneNode(!0);return C.$$click=d,C}}),null),u(k,()=>t.user.name),u(S,f(re,{name:"deck",get cards(){return n().deck}}),null),u(S,f(re,{name:"discard-pile",get cards(){return n().discardPile}}),null),u(Y,()=>n().narrative),u(we,()=>n().funding);const He=e;return typeof He=="function"?V(He,L):e=L,u(L,f(B,{get when(){return!r()},get children(){return[f(j,{name:"the-think-tank",opponent:!0}),f(j,{name:"buffer-zone",opponent:!0}),f(j,{name:"battle-zone",opponent:!0}),ua.cloneNode(!0)]}}),null),u(L,f(j,{name:"battle-zone"}),null),u(L,f(j,{name:"buffer-zone"}),null),u(L,f(j,{name:"the-think-tank"}),null),u(De,f(q,{label:"Leave",onClick:l,small:!0})),u(ne,f(ia,{}),Te),Ne.$$click=()=>a({chatExpanded:!t.chatExpanded}),u(Ne,()=>t.chatExpanded?"Hide Chat":"Show Chat"),u(Te,f(B,{get when(){return t.chatExpanded},get children(){return f(et,{})}}),null),u(nt,f(Le,{})),N(C=>{const oe=`main${r()?" solo-play":""}`,Z=`right-side-bar grunge${t.chatExpanded?" chat-expanded":""}`;return oe!==C._v$&&H(L,C._v$=oe),Z!==C._v$2&&H(ne,C._v$2=Z),C},{_v$:void 0,_v$2:void 0}),p})()}pe(["click"]);const ya=T('<div class="app"></div>'),fa=T('<div class="orientation"><h3>Please turn your device sideways to landscape mode.</h3></div>');function pa(){const{state:e}=G();screen?.orientation?.lock?.("landscape");const t=I(()=>!!e.room||!!e.lobby.find(o=>o.id===e.user.id)),a=()=>e.game?f(ma,{}):e.room?f(Yt,{}):f(Ft,{});return[(()=>{const o=ya.cloneNode(!0);return u(o,f(B,{get when(){return t()},get fallback(){return f(Nt,{})},get children(){return a()}})),o})(),fa.cloneNode(!0)]}Tt(()=>f(pa,{}),document.getElementById("root"));
