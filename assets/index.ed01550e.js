(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function a(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerpolicy&&(i.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?i.credentials="include":n.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(n){if(n.ep)return;n.ep=!0;const i=a(n);fetch(n.href,i)}})();const G={};function Je(e){G.context=e}const Ze=(e,t)=>e===t,$=Symbol("solid-proxy"),fe=Symbol("solid-track"),re={equals:Ze};let Re=Be;const x=1,se=2,De={owned:null,cleanups:null,context:null,owner:null};var C=null;let W=null,E=null,M=null,B=null,Te=0;function ie(e,t){const a=E,o=C,n=e.length===0,i=n?De:{owned:null,cleanups:null,context:null,owner:t||o},r=n?e:()=>e(()=>z(()=>Se(i)));C=i,E=null;try{return q(r,!0)}finally{E=a,C=o}}function F(e,t){t=t?Object.assign({},re,t):re;const a={value:e,observers:null,observerSlots:null,comparator:t.equals||void 0},o=n=>(typeof n=="function"&&(n=n(a.value)),Oe(a,n));return[Ge.bind(a),o]}function N(e,t,a){const o=ke(e,t,!1,x);Q(o)}function Ne(e,t,a){Re=tt;const o=ke(e,t,!1,x);o.user=!0,B?B.push(o):Q(o)}function I(e,t,a){a=a?Object.assign({},re,a):re;const o=ke(e,t,!0,0);return o.observers=null,o.observerSlots=null,o.comparator=a.equals||void 0,Q(o),Ge.bind(o)}function Xe(e){return q(e,!1)}function z(e){let t,a=E;return E=null,t=e(),E=a,t}function ve(e){Ne(()=>z(e))}function He(e){return C===null||(C.cleanups===null?C.cleanups=[e]:C.cleanups.push(e)),e}function Pe(){return E}function Ge(){const e=W;if(this.sources&&(this.state||e))if(this.state===x||e)Q(this);else{const t=M;M=null,q(()=>ce(this),!1),M=t}if(E){const t=this.observers?this.observers.length:0;E.sources?(E.sources.push(this),E.sourceSlots.push(t)):(E.sources=[this],E.sourceSlots=[t]),this.observers?(this.observers.push(E),this.observerSlots.push(E.sources.length-1)):(this.observers=[E],this.observerSlots=[E.sources.length-1])}return this.value}function Oe(e,t,a){let o=e.value;return(!e.comparator||!e.comparator(o,t))&&(e.value=t,e.observers&&e.observers.length&&q(()=>{for(let n=0;n<e.observers.length;n+=1){const i=e.observers[n],r=W&&W.running;r&&W.disposed.has(i),(r&&!i.tState||!r&&!i.state)&&(i.pure?M.push(i):B.push(i),i.observers&&Fe(i)),r||(i.state=x)}if(M.length>1e6)throw M=[],new Error},!1)),t}function Q(e){if(!e.fn)return;Se(e);const t=C,a=E,o=Te;E=C=e,Qe(e,e.value,o),E=a,C=t}function Qe(e,t,a){let o;try{o=e.fn(t)}catch(n){e.pure&&(e.state=x),xe(n)}(!e.updatedAt||e.updatedAt<=a)&&(e.updatedAt!=null&&"observers"in e?Oe(e,o):e.value=o,e.updatedAt=a)}function ke(e,t,a,o=x,n){const i={fn:e,state:o,updatedAt:null,owned:null,sources:null,sourceSlots:null,cleanups:null,value:t,owner:C,context:null,pure:a};return C===null||C!==De&&(C.owned?C.owned.push(i):C.owned=[i]),i}function le(e){const t=W;if(e.state===0||t)return;if(e.state===se||t)return ce(e);if(e.suspense&&z(e.suspense.inFallback))return e.suspense.effects.push(e);const a=[e];for(;(e=e.owner)&&(!e.updatedAt||e.updatedAt<Te);)(e.state||t)&&a.push(e);for(let o=a.length-1;o>=0;o--)if(e=a[o],e.state===x||t)Q(e);else if(e.state===se||t){const n=M;M=null,q(()=>ce(e,a[0]),!1),M=n}}function q(e,t){if(M)return e();let a=!1;t||(M=[]),B?a=!0:B=[],Te++;try{const o=e();return et(a),o}catch(o){M||(B=null),xe(o)}}function et(e){if(M&&(Be(M),M=null),e)return;const t=B;B=null,t.length&&q(()=>Re(t),!1)}function Be(e){for(let t=0;t<e.length;t++)le(e[t])}function tt(e){let t,a=0;for(t=0;t<e.length;t++){const o=e[t];o.user?e[a++]=o:le(o)}for(G.context&&Je(),t=0;t<a;t++)le(e[t])}function ce(e,t){const a=W;e.state=0;for(let o=0;o<e.sources.length;o+=1){const n=e.sources[o];n.sources&&(n.state===x||a?n!==t&&le(n):(n.state===se||a)&&ce(n,t))}}function Fe(e){const t=W;for(let a=0;a<e.observers.length;a+=1){const o=e.observers[a];(!o.state||t)&&(o.state=se,o.pure?M.push(o):B.push(o),o.observers&&Fe(o))}}function Se(e){let t;if(e.sources)for(;e.sources.length;){const a=e.sources.pop(),o=e.sourceSlots.pop(),n=a.observers;if(n&&n.length){const i=n.pop(),r=a.observerSlots.pop();o<n.length&&(i.sourceSlots[r]=o,n[o]=i,a.observerSlots[o]=r)}}if(e.owned){for(t=0;t<e.owned.length;t++)Se(e.owned[t]);e.owned=null}if(e.cleanups){for(t=0;t<e.cleanups.length;t++)e.cleanups[t]();e.cleanups=null}e.state=0,e.context=null}function at(e){return e instanceof Error||typeof e=="string"?e:new Error("Unknown error")}function xe(e){throw e=at(e),e}const nt=Symbol("fallback");function Ee(e){for(let t=0;t<e.length;t++)e[t]()}function ot(e,t,a={}){let o=[],n=[],i=[],r=0,s=t.length>1?[]:null;return He(()=>Ee(i)),()=>{let l=e()||[],c,h;return l[fe],z(()=>{let y=l.length,T,v,p,S,m,b,w,k,A;if(y===0)r!==0&&(Ee(i),i=[],o=[],n=[],r=0,s&&(s=[])),a.fallback&&(o=[nt],n[0]=ie(R=>(i[0]=R,a.fallback())),r=1);else if(r===0){for(n=new Array(y),h=0;h<y;h++)o[h]=l[h],n[h]=ie(d);r=y}else{for(p=new Array(y),S=new Array(y),s&&(m=new Array(y)),b=0,w=Math.min(r,y);b<w&&o[b]===l[b];b++);for(w=r-1,k=y-1;w>=b&&k>=b&&o[w]===l[k];w--,k--)p[k]=n[w],S[k]=i[w],s&&(m[k]=s[w]);for(T=new Map,v=new Array(k+1),h=k;h>=b;h--)A=l[h],c=T.get(A),v[h]=c===void 0?-1:c,T.set(A,h);for(c=b;c<=w;c++)A=o[c],h=T.get(A),h!==void 0&&h!==-1?(p[h]=n[c],S[h]=i[c],s&&(m[h]=s[c]),h=v[h],T.set(A,h)):i[c]();for(h=b;h<y;h++)h in p?(n[h]=p[h],i[h]=S[h],s&&(s[h]=m[h],s[h](h))):n[h]=ie(d);n=n.slice(0,r=y),o=l.slice(0)}return n});function d(y){if(i[h]=y,s){const[T,v]=F(h);return s[h]=v,t(l[h],T)}return t(l[h])}}}function f(e,t){return z(()=>e(t||{}))}function J(e){const t="fallback"in e&&{fallback:()=>e.fallback};return I(ot(()=>e.each,e.children,t||void 0))}function O(e){let t=!1;const a=e.keyed,o=I(()=>e.when,void 0,{equals:(n,i)=>t?n===i:!n==!i});return I(()=>{const n=o();if(n){const i=e.children,r=typeof i=="function"&&i.length>0;return t=a||r,r?z(()=>i(n)):i}return e.fallback})}function it(e,t){return I(e,void 0,t?void 0:{equals:t})}function rt(e,t,a){let o=a.length,n=t.length,i=o,r=0,s=0,l=t[n-1].nextSibling,c=null;for(;r<n||s<i;){if(t[r]===a[s]){r++,s++;continue}for(;t[n-1]===a[i-1];)n--,i--;if(n===r){const h=i<o?s?a[s-1].nextSibling:a[i-s]:l;for(;s<i;)e.insertBefore(a[s++],h)}else if(i===s)for(;r<n;)(!c||!c.has(t[r]))&&t[r].remove(),r++;else if(t[r]===a[i-1]&&a[s]===t[n-1]){const h=t[--n].nextSibling;e.insertBefore(a[s++],t[r++].nextSibling),e.insertBefore(a[--i],h),t[n]=a[i]}else{if(!c){c=new Map;let d=s;for(;d<i;)c.set(a[d],d++)}const h=c.get(t[r]);if(h!=null)if(s<h&&h<i){let d=r,y=1,T;for(;++d<n&&d<i&&!((T=c.get(t[d]))==null||T!==h+y);)y++;if(y>h-s){const v=t[r];for(;s<h;)e.insertBefore(a[s++],v)}else e.replaceChild(a[s++],t[r++])}else r++;else t[r++].remove()}}}const Ie="_$DX_DELEGATE";function st(e,t,a){let o;return ie(n=>{o=n,t===document?e():u(t,e(),t.firstChild?null:void 0,a)}),()=>{o(),t.textContent=""}}function g(e,t,a){const o=document.createElement("template");o.innerHTML=e;let n=o.content.firstChild;return a&&(n=n.firstChild),n}function ee(e,t=window.document){const a=t[Ie]||(t[Ie]=new Set);for(let o=0,n=e.length;o<n;o++){const i=e[o];a.has(i)||(a.add(i),t.addEventListener(i,ct))}}function pe(e,t,a){a==null?e.removeAttribute(t):e.setAttribute(t,a)}function H(e,t){t==null?e.removeAttribute("class"):e.className=t}function lt(e,t,a,o){if(o)Array.isArray(a)?(e[`$$${t}`]=a[0],e[`$$${t}Data`]=a[1]):e[`$$${t}`]=a;else if(Array.isArray(a)){const n=a[0];e.addEventListener(t,a[0]=i=>n.call(e,a[1],i))}else e.addEventListener(t,a)}function j(e,t,a){return z(()=>e(t,a))}function u(e,t,a,o){if(a!==void 0&&!o&&(o=[]),typeof t!="function")return he(e,t,o,a);N(n=>he(e,t(),n,a),o)}function ct(e){const t=`$$${e.type}`;let a=e.composedPath&&e.composedPath()[0]||e.target;for(e.target!==a&&Object.defineProperty(e,"target",{configurable:!0,value:a}),Object.defineProperty(e,"currentTarget",{configurable:!0,get(){return a||document}}),G.registry&&!G.done&&(G.done=!0,document.querySelectorAll("[id^=pl-]").forEach(o=>o.remove()));a!==null;){const o=a[t];if(o&&!a.disabled){const n=a[`${t}Data`];if(n!==void 0?o.call(a,n,e):o.call(a,e),e.cancelBubble)return}a=a.host&&a.host!==a&&a.host instanceof Node?a.host:a.parentNode}}function he(e,t,a,o,n){for(G.context&&!a&&(a=[...e.childNodes]);typeof a=="function";)a=a();if(t===a)return a;const i=typeof t,r=o!==void 0;if(e=r&&a[0]&&a[0].parentNode||e,i==="string"||i==="number"){if(G.context)return a;if(i==="number"&&(t=t.toString()),r){let s=a[0];s&&s.nodeType===3?s.data=t:s=document.createTextNode(t),a=U(e,a,o,s)}else a!==""&&typeof a=="string"?a=e.firstChild.data=t:a=e.textContent=t}else if(t==null||i==="boolean"){if(G.context)return a;a=U(e,a,o)}else{if(i==="function")return N(()=>{let s=t();for(;typeof s=="function";)s=s();a=he(e,s,a,o)}),()=>a;if(Array.isArray(t)){const s=[],l=a&&Array.isArray(a);if(ge(s,t,a,n))return N(()=>a=he(e,s,a,o,!0)),()=>a;if(G.context){if(!s.length)return a;for(let c=0;c<s.length;c++)if(s[c].parentNode)return a=s}if(s.length===0){if(a=U(e,a,o),r)return a}else l?a.length===0?Ce(e,s,o):rt(e,a,s):(a&&U(e),Ce(e,s));a=s}else if(t instanceof Node){if(G.context&&t.parentNode)return a=r?[t]:t;if(Array.isArray(a)){if(r)return a=U(e,a,o,t);U(e,a,null,t)}else a==null||a===""||!e.firstChild?e.appendChild(t):e.replaceChild(t,e.firstChild);a=t}}return a}function ge(e,t,a,o){let n=!1;for(let i=0,r=t.length;i<r;i++){let s=t[i],l=a&&a[i];if(s instanceof Node)e.push(s);else if(!(s==null||s===!0||s===!1))if(Array.isArray(s))n=ge(e,s,l)||n;else if(typeof s=="function")if(o){for(;typeof s=="function";)s=s();n=ge(e,Array.isArray(s)?s:[s],Array.isArray(l)?l:[l])||n}else e.push(s),n=!0;else{const c=String(s);l&&l.nodeType===3&&l.data===c?e.push(l):e.push(document.createTextNode(c))}}return n}function Ce(e,t,a){for(let o=0,n=t.length;o<n;o++)e.insertBefore(t[o],a)}function U(e,t,a,o){if(a===void 0)return e.textContent="";const n=o||document.createTextNode("");if(t.length){let i=!1;for(let r=t.length-1;r>=0;r--){const s=t[r];if(n!==s){const l=s.parentNode===e;!i&&!r?l?e.replaceChild(n,s):e.insertBefore(n,a):l&&s.remove()}else i=!0}}else e.insertBefore(n,a);return[n]}const be=Symbol("store-raw"),Z=Symbol("store-node"),ht=Symbol("store-name");function Le(e,t){let a=e[$];if(!a&&(Object.defineProperty(e,$,{value:a=new Proxy(e,mt)}),!Array.isArray(e))){const o=Object.keys(e),n=Object.getOwnPropertyDescriptors(e);for(let i=0,r=o.length;i<r;i++){const s=o[i];if(n[s].get){const l=n[s].get.bind(a);Object.defineProperty(e,s,{get:l})}}}return a}function ue(e){let t;return e!=null&&typeof e=="object"&&(e[$]||!(t=Object.getPrototypeOf(e))||t===Object.prototype||Array.isArray(e))}function X(e,t=new Set){let a,o,n,i;if(a=e!=null&&e[be])return a;if(!ue(e)||t.has(e))return e;if(Array.isArray(e)){Object.isFrozen(e)?e=e.slice(0):t.add(e);for(let r=0,s=e.length;r<s;r++)n=e[r],(o=X(n,t))!==n&&(e[r]=o)}else{Object.isFrozen(e)?e=Object.assign({},e):t.add(e);const r=Object.keys(e),s=Object.getOwnPropertyDescriptors(e);for(let l=0,c=r.length;l<c;l++)i=r[l],!s[i].get&&(n=e[i],(o=X(n,t))!==n&&(e[i]=o))}return e}function de(e){let t=e[Z];return t||Object.defineProperty(e,Z,{value:t={}}),t}function we(e,t,a){return e[t]||(e[t]=$e(a))}function ut(e,t){const a=Reflect.getOwnPropertyDescriptor(e,t);return!a||a.get||!a.configurable||t===$||t===Z||t===ht||(delete a.value,delete a.writable,a.get=()=>e[$][t]),a}function We(e){if(Pe()){const t=de(e);(t._||(t._=$e()))()}}function dt(e){return We(e),Reflect.ownKeys(e)}function $e(e){const[t,a]=F(e,{equals:!1,internal:!0});return t.$=a,t}const mt={get(e,t,a){if(t===be)return e;if(t===$)return a;if(t===fe)return We(e),a;const o=de(e),n=o.hasOwnProperty(t);let i=n?o[t]():e[t];if(t===Z||t==="__proto__")return i;if(!n){const r=Object.getOwnPropertyDescriptor(e,t);Pe()&&(typeof i!="function"||e.hasOwnProperty(t))&&!(r&&r.get)&&(i=we(o,t,i)())}return ue(i)?Le(i):i},has(e,t){if(t===be||t===$||t===fe||t===Z||t==="__proto__")return!0;const a=de(e)[t];return a&&a(),t in e},set(){return!0},deleteProperty(){return!0},ownKeys:dt,getOwnPropertyDescriptor:ut};function me(e,t,a,o=!1){if(!o&&e[t]===a)return;const n=e[t],i=e.length;a===void 0?delete e[t]:e[t]=a;let r=de(e),s;(s=we(r,t,n))&&s.$(()=>a),Array.isArray(e)&&e.length!==i&&(s=we(r,"length",i))&&s.$(e.length),(s=r._)&&s.$()}function ze(e,t){const a=Object.keys(t);for(let o=0;o<a.length;o+=1){const n=a[o];me(e,n,t[n])}}function yt(e,t){if(typeof t=="function"&&(t=t(e)),t=X(t),Array.isArray(t)){if(e===t)return;let a=0,o=t.length;for(;a<o;a++){const n=t[a];e[a]!==n&&me(e,a,n)}me(e,"length",o)}else ze(e,t)}function V(e,t,a=[]){let o,n=e;if(t.length>1){o=t.shift();const r=typeof o,s=Array.isArray(e);if(Array.isArray(o)){for(let l=0;l<o.length;l++)V(e,[o[l]].concat(t),a);return}else if(s&&r==="function"){for(let l=0;l<e.length;l++)o(e[l],l)&&V(e,[l].concat(t),a);return}else if(s&&r==="object"){const{from:l=0,to:c=e.length-1,by:h=1}=o;for(let d=l;d<=c;d+=h)V(e,[d].concat(t),a);return}else if(t.length>1){V(e[o],t,[o].concat(a));return}n=e[o],a=[o].concat(a)}let i=t[0];typeof i=="function"&&(i=i(n,a),i===n)||o===void 0&&i==null||(i=X(i),o===void 0||ue(n)&&ue(i)&&!Array.isArray(i)?ze(n,i):me(e,o,i))}function ft(...[e,t]){const a=X(e||{}),o=Array.isArray(a),n=Le(a);function i(...r){Xe(()=>{o&&r.length===1?yt(a,r[0]):V(a,r)})}return[n,i]}const pt={user:{id:"",name:""},connected:!1,lobby:[],room:null,rooms:{},game:void 0,focus:{current:null,hover:null},chatExpanded:!1},ne=new WebSocket("wss://mondo-megabits.herokuapp.com");function P(){const[e,t]=ft(pt),a=o=>{ne.send(JSON.stringify(o))};return ne.onopen=()=>{t({connected:!0}),setInterval(()=>{a({type:"ping"})},4e4)},ne.onclose=()=>{t({connected:!1})},ne.onmessage=o=>{const{type:n,params:i}=JSON.parse(o.data);switch(n){case"connected":{t({user:{name:"",id:i.id}});break}case"lobby":{t({lobby:i.users,room:null,rooms:i.otherRooms||[]});break}case"join":{const{roomCode:r,users:s}=i;t(l=>({lobby:l.lobby.filter(c=>c.id!==l.user.id),room:{code:r,users:s,chatMessages:l.room?.chatMessages||[]}}));break}case"leave":{const{userId:r}=i;t({room:r===e.user.id?null:{...e.room,users:e.room.users.filter(s=>s.id!==r)}});break}case"leave-game":{const{roomCode:r,users:s}=i;t({game:null,room:{code:r,users:s,chatMessages:e.room?.chatMessages||[]}});break}case"chat":{if(i.chatMessage.user.id!==e.user.id){t(r=>({room:{...r.room,chatMessages:[...r.room?.chatMessages||[],i.chatMessage]}}));break}break}case"ready":{const{userId:r,status:s}=i;t(l=>({room:{...l.room,users:l.room.users.map(c=>c.id!==r?c:{...c,status:s})}}));break}case"game":{const{game:r}=i;t({game:r});break}default:{console.log("Got unknown message type: ",n);break}}},{state:e,setState:t,sendMessage:a}}const gt=g('<div class="connect"><div class="video"><video autoplay="true" loop="true" playsinline="true" muted><source type="video/mp4; codecs=&quot;av01.0.13M.10&quot;" src="https://cdn.mondomegabits.com/logo/Mondo flashing logo_r3 - strobe.mp4"></video></div><form class="puppet-master-handle-input"><label>Puppet Master Handle:</label><input type="text"><button class="connect-button button" type="submit">Connect</button></form></div>');function bt(){let e;const{sendMessage:t,setState:a}=P(),[o,n]=F("");ve(()=>{e.focus()});const i=r=>{r.preventDefault(),o().length!==0&&(t({type:"lobby",params:{userName:o()}}),a(s=>({user:{...s.user,name:o()}})))};return(()=>{const r=gt.cloneNode(!0),s=r.firstChild,l=s.nextSibling,c=l.firstChild,h=c.nextSibling;l.addEventListener("submit",i),h.addEventListener("change",y=>n(y.target.value));const d=e;return typeof d=="function"?j(d,h):e=h,N(()=>h.value=o()),r})()}const wt=g('<button type="button"><div class="circle"></div><div class="label"></div></button>');function _({label:e,onClick:t,disabled:a,color:o,small:n}){const i=()=>{let r="circle-button button";return o&&(r+=` ${o}`),n&&(r+=" small"),a&&(r+=" disabled"),r};return(()=>{const r=wt.cloneNode(!0),s=r.firstChild,l=s.nextSibling;return lt(r,"click",t,!0),r.disabled=a,u(l,e),N(()=>H(r,i())),r})()}ee(["click"]);const Tt=g('<div class="modal"><div class="join-room panel"><form><label>Room code:</label><input type="text"><div class="modal-footer"><button class="button" type="submit">OK</button><button class="button" type="button">Cancel</button></div></form></div></div>'),vt=g('<div class="lobby"><div class="rooms grunge"><div class="headers yellow"><div class="header">Code</div><div class="header">Users</div><div class="header">Status</div></div><hr class="tall"></div><div class="users"><span class="yellow">/// </span>Puppet Masters Online:<hr class="top"><ul class="list"></ul><hr class="bottom"></div><div class="footer panel"></div></div>'),kt=g('<div class="room"><div class="room-code teal"></div><div class="room-users white"> / </div><div></div><div class="room-join"></div></div>'),St=g("<li></li>");function At(){const{state:e,sendMessage:t}=P(),[a,o]=F(!1),[n,i]=F(""),r=()=>{t({type:"create"})},s=l=>{l.preventDefault();const c=n();!c||t({type:"join",params:{roomCode:c}})};return(()=>{const l=vt.cloneNode(!0),c=l.firstChild;c.firstChild.nextSibling;const d=c.nextSibling,y=d.firstChild,T=y.nextSibling,v=T.nextSibling,p=v.nextSibling,S=d.nextSibling;return u(c,f(J,{get each(){return e.rooms},children:m=>(()=>{const b=kt.cloneNode(!0),w=b.firstChild,k=w.nextSibling,A=k.firstChild,R=k.nextSibling,D=R.nextSibling;return u(w,()=>m.code),u(k,()=>m.users,A),u(k,()=>m.maxUsers,null),u(R,()=>m.status.toUpperCase()),u(D,f(_,{label:"Join",get disabled(){return m.status!=="open"},onClick:()=>{t({type:"join",params:{roomCode:m.code}})},color:"red",small:!0})),N(()=>H(R,`room-status${m.status==="full"?" red":""}`)),b})()}),null),u(p,f(J,{get each(){return e.lobby},children:m=>(()=>{const b=St.cloneNode(!0);return u(b,()=>m.name),N(()=>H(b,m.id===e.user.id?"glow":"white")),b})()})),u(S,f(_,{label:"Create",onClick:r}),null),u(S,f(_,{label:"Join",onClick:()=>{o(!0),i("")}}),null),u(l,f(O,{get when(){return a()},get children(){const m=Tt.cloneNode(!0),b=m.firstChild,w=b.firstChild,k=w.firstChild,A=k.nextSibling,R=A.nextSibling,D=R.firstChild,K=D.nextSibling;return w.addEventListener("submit",s),A.addEventListener("change",L=>i(L.target.value)),K.$$click=()=>o(!1),N(()=>D.disabled=n().length===0),N(()=>A.value=n()),m}}),null),l})()}ee(["click"]);const Et=g('<div class="message system"><p class="red italic"><span class="white">[ </span><span class="white"> ]</span></p><div class="message-date yellow"></div></div>'),It=g('<div class="chat"><div class="messages grunge"></div><form><input type="text"><button class="button" type="submit">Send</button></form></div>'),Ct=g('<div class="message"><p><span></span> </p><div class="message-date yellow"></div></div>');function Ke(){let e,t;const{state:a,setState:o,sendMessage:n}=P(),[i,r]=F("");ve(()=>{t?.focus?.()}),Ne(()=>{!e||a.room?.chatMessages.length===0||(e.scrollTop=e.scrollHeight)});const s=c=>{c.preventDefault();const h=i();if(h.length===0)return;const d={message:h,date:new Date().toLocaleTimeString("en-US")};o(y=>({room:{...y.room,chatMessages:[...y.room.chatMessages,{...d,user:y.user}]}})),n({type:"chat",params:{roomCode:a.room.code,chatMessage:d}}),r("")},l=c=>(()=>{const h=Et.cloneNode(!0),d=h.firstChild,y=d.firstChild,T=y.nextSibling,v=d.nextSibling;return u(d,()=>c.message,T),u(v,()=>c.date),h})();return(()=>{const c=It.cloneNode(!0),h=c.firstChild,d=h.nextSibling,y=d.firstChild,T=e;typeof T=="function"?j(T,h):e=h,u(h,f(J,{get each(){return a.room.chatMessages},children:p=>p.user.id==="SYSTEM"?l(p):(()=>{const S=Ct.cloneNode(!0),m=S.firstChild,b=m.firstChild;b.nextSibling;const w=m.nextSibling;return u(b,()=>p.user.name),u(m,()=>p.message,null),u(w,()=>p.date),N(()=>H(b,`message-user ${p.user.id===a.user.id?"teal":"white"}`)),S})()})),d.addEventListener("submit",s),y.addEventListener("change",p=>r(p.target.value));const v=t;return typeof v=="function"?j(v,y):t=y,N(()=>y.value=i()),c})()}const Mt=g('<div class="countdown"><h1 class="white">Starting in:</h1><div class="count"><span class="glow"></span></div></div>');function Rt({from:e=5,callback:t=()=>{}}){const[a,o]=F(),[n,i]=F(e),r=()=>{!a()&&n()>0&&o(setInterval(s,1e3))},s=()=>{let l=n()-1;i(l),l===0&&(clearInterval(a()),t?.())};return ve(()=>{r()}),He(()=>{clearInterval(a())}),f(O,{get when(){return n()>0},get children(){const l=Mt.cloneNode(!0),c=l.firstChild,h=c.nextSibling,d=h.firstChild;return u(d,n),l}})}const Dt=g('<div class="room"><div class="main"><div class="header"><div class="room-name"><hr class="dotted-double"><h1 class="wide color-change"></h1><hr class="dotted-double"></div></div></div><div class="users"><span class="yellow">/// </span>Puppet Masters In Room:<hr class="top"><ul class="list"></ul><hr class="bottom"></div><div class="footer panel"></div></div>'),Nt=g('<li><div class="name"><span></span></div><div class="status"><div class="check"><span class="red">[</span><span class="yellow"></span><span class="red">]</span></div></div></li>');function Ht(){const[e,t]=F(!1),{state:a,sendMessage:o}=P(),n=I(()=>!a.room?.users?.find(c=>c.status!=="ready")),i=I(()=>a.room?.users?.find(c=>c.id===a.user.id&&c.status==="ready")),r=()=>{o({type:"leave"})},s=()=>{o({type:"start"})},l=()=>{const c=!i(),h=c?"ready":"waiting";o({type:"ready",params:{roomCode:a.room.code,status:h}}),t(c)};return(()=>{const c=Dt.cloneNode(!0),h=c.firstChild,d=h.firstChild,y=d.firstChild,T=y.firstChild,v=T.nextSibling,p=h.nextSibling,S=p.firstChild,m=S.nextSibling,b=m.nextSibling,w=b.nextSibling,k=p.nextSibling;return u(v,()=>a.room.code),u(d,f(O,{get when(){return n()},get children(){return f(Rt,{callback:s})}}),null),u(h,f(Ke,{}),null),u(w,f(J,{get each(){return a.room.users},children:A=>(()=>{const R=Nt.cloneNode(!0),D=R.firstChild,K=D.firstChild,L=D.nextSibling,te=L.firstChild,ae=te.firstChild,ye=ae.nextSibling;return u(K,()=>A.name),u(ye,()=>A.status==="ready"?"\u2713":" "),u(L,()=>A.status.toUpperCase(),null),N(()=>H(K,A.id===a.user.id?"glow":"white")),R})()})),u(k,f(_,{get label(){return i()?"Unready":"Ready"},onClick:l,color:"red"}),null),u(k,f(_,{label:"Leave",onClick:r}),null),c})()}const Pt=g('<div class="name teal"></div>'),Gt=g('<div class="cost yellow"><span class="white">Cost:</span> </div>'),Ot=g('<div class="type"><span class="white">Type:</span> </div>'),Bt=g('<div class="subtype"><span class="white">Subtype:</span> </div>'),Ft=g('<div class="faction"><span class="white">Faction:</span> </div>'),xt=g('<div class="body-text"></div>'),Lt=g('<div class="card-focus"><div class="focused-card"></div></div>');function Wt(){const{state:e}=P(),t=I(()=>e.focus.hover||e.focus.current);return(()=>{const a=Lt.cloneNode(!0),o=a.firstChild;return u(o,f(O,{get when(){return t()},get children(){return[(()=>{const n=Pt.cloneNode(!0);return u(n,()=>t().name),n})(),(()=>{const n=Gt.cloneNode(!0);return n.firstChild.nextSibling,u(n,()=>t().cost,null),n})(),(()=>{const n=Ot.cloneNode(!0);return n.firstChild.nextSibling,u(n,()=>t().type,null),n})(),(()=>{const n=Bt.cloneNode(!0);return n.firstChild.nextSibling,u(n,()=>t().subType,null),n})(),(()=>{const n=Ft.cloneNode(!0);return n.firstChild.nextSibling,u(n,()=>t().faction,null),n})(),(()=>{const n=xt.cloneNode(!0);return u(n,()=>t().bodyText),n})()]}})),a})()}const Ue=""+new URL("card-back.1c57677c.png",import.meta.url).href;const $t=g('<div><div class="card-pile-label"></div><div class="card-back"><div class="card-count"></div><img></div></div>');function oe({name:e,cards:t,opponent:a,canView:o}){let n;const{state:i,sendMessage:r}=P(),s=d=>{d.preventDefault(),n.classList.add("drag-over")},l=()=>{n.classList.remove("drag-over")},c=d=>{d.preventDefault(),n.classList.remove("drag-over");const y=d.dataTransfer.getData("text");r({type:"move",params:{cardUuid:y,destination:e,gameCode:i.game.id,roomCode:i.room.code}})},h=()=>{switch(e){case"deck":return"Deck";case"discard-pile":return"Discard";default:return""}};return(()=>{const d=$t.cloneNode(!0),y=d.firstChild,T=y.nextSibling,v=T.firstChild,p=v.nextSibling;d.addEventListener("drop",c),d.addEventListener("dragleave",l),d.addEventListener("dragover",s);const S=n;return typeof S=="function"?j(S,d):n=d,H(d,`card-pile ${e}${a?" opponent":""}`),u(y,h),u(v,()=>t.length),pe(p,"src",Ue),N(()=>H(p,t.length===0?"empty":"")),d})()}const zt=g('<div class="plasma"></div>'),Kt=g("<div></div>");function Ut(){return(()=>{const t=zt.cloneNode(!0);return u(t,()=>[...Array(10)].map((a,o)=>(()=>{const n=Kt.cloneNode(!0);return H(n,`bubble x${o+1}`),n})())),t})()}const Yt=[{id:1,name:"Wireless Vaccine+-",faction:"FAKE TECH",rarity:4,frameSize:"C",type:"Item",subtype:"Weapon",bodyText:`"Not feeling well? Well, maybe it's 'cause you're always on that phone."
...
Long Warp: Play one round of Rock-Paper-Scissors with your opponent. If you win, receive 1x Teleportation Token, giving you a free instant dodge from an attack of your choice. If you lose, discard the top card of your deck.`,variantId:131,fileStem:"0094a"}],_t=e=>`https://mondomegabits.com/card/img/95/${e.fileStem}.jpg`,jt=e=>{const t=Yt.find(a=>a.id.toString()===e.toString());return _t(t)},qt=e=>e.replace(/-([a-z])/g,t=>t[1].toUpperCase());const Vt=g("<div draggable><img></div>");function Ye({card:e,opponent:t,location:a}){const{state:o,setState:n,sendMessage:i}=P(),r=a==="hand"&&t||e.faceDown,s=I(()=>["battle-zone","the-think-tank","buffer-zone"].includes(a)),l=()=>{t||i({type:"tap",params:{cardUuid:e.uuid,gameCode:o.game.id,roomCode:o.room.code}})},c=m=>{t||m.dataTransfer.setData("text",e.uuid)},h=()=>{t&&r||(o.focus.current?.uuid===e.uuid?d():n(m=>({focus:{...m.focus,current:e}})))},d=()=>{t&&r||n(m=>({focus:{...m.focus,current:null}}))},y=()=>{t&&r||n(m=>({focus:{...m.focus,hover:e}}))},T=()=>{t&&r||n(m=>({focus:{...m.focus,hover:null}}))},v=()=>{s()&&l()},p=m=>{switch(m.detail){case 1:h();break;case 2:v();break}},S=()=>{let m="card";return t&&(m+=" opponent"),o.focus.current?.uuid===e.uuid&&(m+=" focus"),e.tapped&&(m+=" tapped"),m};return(()=>{const m=Vt.cloneNode(!0),b=m.firstChild;return m.addEventListener("dragstart",c),m.addEventListener("pointerleave",T),m.addEventListener("pointerenter",y),m.$$click=p,N(w=>{const k=S(),A=e.uuid,R=r?Ue:jt(e.id);return k!==w._v$&&H(m,w._v$=k),A!==w._v$2&&pe(b,"id",w._v$2=A),R!==w._v$3&&pe(b,"src",w._v$3=R),w},{_v$:void 0,_v$2:void 0,_v$3:void 0}),m})()}ee(["click"]);const Jt=g("<div></div>");function Me({opponent:e}){const{state:t}=P(),a=I(()=>t.game.puppetMasters.find(({id:n})=>n===t.user.id)?.hand),o=I(()=>t.game.puppetMasters.find(({id:n})=>n!==t.user.id)?.hand);return(()=>{const n=Jt.cloneNode(!0);return H(n,`hand${e?" opponent":""}`),u(n,f(J,{get each(){return e?o():a()},children:i=>f(Ye,{card:i,faceDown:e,opponent:e,location:"hand"})})),n})()}const Zt=g("<div></div>");function Y({name:e,opponent:t}){let a;const{state:o,sendMessage:n}=P(),i=I(()=>{const c=o.game.puppetMasters.find(y=>t?y.id!==o.user.id:y.id===o.user.id),h=qt(e);return c.board[h]||[]}),r=c=>{t||(c.preventDefault(),a.classList.add("drag-over"))},s=()=>{t||a.classList.remove("drag-over")},l=c=>{if(t)return;c.preventDefault(),a.classList.remove("drag-over");const h=c.dataTransfer.getData("text");n({type:"play",params:{cardUuid:h,destination:e,gameCode:o.game.id,roomCode:o.room.code}})};return(()=>{const c=Zt.cloneNode(!0);c.addEventListener("drop",l),c.addEventListener("dragleave",s),c.addEventListener("dragover",r);const h=a;return typeof h=="function"?j(h,c):a=c,H(c,`zone panel grunge ${e}${t?" opponent":""}`),u(c,()=>i().map(d=>f(Ye,{card:d,opponent:t,location:e}))),c})()}const Xt=g('<div class="opponent"><fieldset><legend class="white"></legend><div class="stats"><div class="stat panel"><div class="stat-label">Narrative</div><div class="stat-number"></div></div><div class="stat panel"><div class="stat-label">Funding</div><div class="stat-number"></div></div></div><div class="card-piles"></div></fieldset></div>'),Qt=g('<button class="end-turn-button button">End My Turn</button>'),ea=g('<div class="left-side-bar grunge"><div class="turn panel"><div class="turn-label"></div><div class="turn-number"></div></div><div class="me"><fieldset><legend class="white"></legend><div class="card-piles"></div><div class="stats"><div class="stat panel"><div class="stat-label">Narrative</div><div class="stat-number"></div></div><div class="stat panel"><div class="stat-label">Funding</div><div class="stat-number"></div></div></div></fieldset></div></div>');function ta(){const{state:e,sendMessage:t}=P(),a=I(()=>e.game.puppetMasters.find(({id:l})=>l===e.user.id)),o=I(()=>e.game.puppetMasters.length===1),n=I(()=>e.game.turn.player===e.user.id),i=I(()=>o()?null:e.game.puppetMasters.find(({id:l})=>l!==e.user.id)),r=I(()=>{if(o())return null;const l=i()?.id;return getPuppetMasterName(l)}),s=()=>{t({type:"end-turn",params:{gameCode:e.game.id,roomCode:e.room.code}})};return(()=>{const l=ea.cloneNode(!0),c=l.firstChild,h=c.firstChild,d=h.nextSibling,y=c.nextSibling,T=y.firstChild,v=T.firstChild,p=v.nextSibling,S=p.nextSibling,m=S.firstChild,b=m.firstChild,w=b.nextSibling,k=m.nextSibling,A=k.firstChild,R=A.nextSibling;return u(l,f(O,{get when(){return!o()},get children(){const D=Xt.cloneNode(!0),K=D.firstChild,L=K.firstChild,te=L.nextSibling,ae=te.firstChild,ye=ae.firstChild,_e=ye.nextSibling,je=ae.nextSibling,qe=je.firstChild,Ve=qe.nextSibling,Ae=te.nextSibling;return u(L,r),u(_e,()=>i().narrative),u(Ve,()=>i().funding),u(Ae,f(oe,{name:"deck",get cards(){return i().deck}}),null),u(Ae,f(oe,{name:"discard-pile",get cards(){return i().discardPile}}),null),D}}),c),u(h,(()=>{const D=it(()=>!!n(),!0);return()=>D()?"Your Turn":`${r()}'s Turn`})()),u(d,()=>e.game.turn.number),u(c,f(O,{get when(){return n()},get children(){const D=Qt.cloneNode(!0);return D.$$click=s,D}}),null),u(v,()=>e.user.name),u(p,f(oe,{name:"deck",get cards(){return a().deck}}),null),u(p,f(oe,{name:"discard-pile",get cards(){return a().discardPile}}),null),u(w,()=>a().narrative),u(R,()=>a().funding),l})()}ee(["click"]);const aa=g('<div class="header grunge"></div>'),na=g('<div class="middle grunge"></div>'),oa=g('<div class="game-board"><div></div><div><div class="options"></div><div class="game-chat"><button class="expand-button button"></button></div></div><div class="footer panel grunge"></div></div>');function ia(){let e;const{state:t,setState:a,sendMessage:o}=P(),n=I(()=>t.game.puppetMasters.length===1),i=()=>{o({type:"leave-game"})},r=s=>{s.target.id!==t.focus.current?.uuid&&e.contains(s.target)&&a(c=>({focus:{...c.focus,current:null}}))};return(()=>{const s=oa.cloneNode(!0),l=s.firstChild,c=l.nextSibling,h=c.firstChild,d=h.nextSibling,y=d.firstChild,T=c.nextSibling;s.$$click=r,u(s,f(O,{get when(){return!n()},get children(){const p=aa.cloneNode(!0);return u(p,f(Me,{opponent:!0})),p}}),l),u(s,f(ta,{}),l);const v=e;return typeof v=="function"?j(v,l):e=l,u(l,f(O,{get when(){return!n()},get children(){return[f(Y,{name:"the-think-tank",opponent:!0}),f(Y,{name:"buffer-zone",opponent:!0}),f(Y,{name:"battle-zone",opponent:!0}),(()=>{const p=na.cloneNode(!0);return u(p,f(Ut,{})),p})()]}}),null),u(l,f(Y,{name:"battle-zone"}),null),u(l,f(Y,{name:"buffer-zone"}),null),u(l,f(Y,{name:"the-think-tank"}),null),u(h,f(_,{label:"Leave",onClick:i,small:!0})),u(c,f(Wt,{}),d),y.$$click=()=>a({chatExpanded:!t.chatExpanded}),u(y,()=>t.chatExpanded?"Hide Chat":"Show Chat"),u(d,f(O,{get when(){return t.chatExpanded},get children(){return f(Ke,{})}}),null),u(T,f(Me,{})),N(p=>{const S=`main${n()?" solo-play":""}`,m=`right-side-bar grunge${t.chatExpanded?" chat-expanded":""}`;return S!==p._v$&&H(l,p._v$=S),m!==p._v$2&&H(c,p._v$2=m),p},{_v$:void 0,_v$2:void 0}),s})()}ee(["click"]);const ra=g('<div class="app"></div>'),sa=g('<div class="orientation"><h3>Please turn your device sideways to landscape mode.</h3></div>');function la(){const{state:e}=P();screen?.orientation?.lock?.("landscape");const t=I(()=>!!e.room||!!e.lobby.find(o=>o.id===e.user.id)),a=()=>e.game?f(ia,{}):e.room?f(Ht,{}):f(At,{});return[(()=>{const o=ra.cloneNode(!0);return u(o,f(O,{get when(){return t()},get fallback(){return f(bt,{})},get children(){return a()}})),o})(),sa.cloneNode(!0)]}st(()=>f(la,{}),document.getElementById("root"));
