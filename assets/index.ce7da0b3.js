(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerpolicy&&(i.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?i.credentials="include":o.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(o){if(o.ep)return;o.ep=!0;const i=a(o);fetch(o.href,i)}})();const P={};function Ze(e){P.context=e}const Xe=(e,t)=>e===t,$=Symbol("solid-proxy"),fe=Symbol("solid-track"),se={equals:Xe};let Me=Oe;const L=1,le=2,Re={owned:null,cleanups:null,context:null,owner:null};var C=null;let W=null,E=null,R=null,F=null,Te=0;function re(e,t){const a=E,n=C,o=e.length===0,i=o?Re:{owned:null,cleanups:null,context:null,owner:t||n},r=o?e:()=>e(()=>z(()=>Se(i)));C=i,E=null;try{return q(r,!0)}finally{E=a,C=n}}function x(e,t){t=t?Object.assign({},se,t):se;const a={value:e,observers:null,observerSlots:null,comparator:t.equals||void 0},n=o=>(typeof o=="function"&&(o=o(a.value)),Pe(a,o));return[Ge.bind(a),n]}function M(e,t,a){const n=ke(e,t,!1,L);ee(n)}function De(e,t,a){Me=at;const n=ke(e,t,!1,L);n.user=!0,F?F.push(n):ee(n)}function I(e,t,a){a=a?Object.assign({},se,a):se;const n=ke(e,t,!0,0);return n.observers=null,n.observerSlots=null,n.comparator=a.equals||void 0,ee(n),Ge.bind(n)}function Qe(e){return q(e,!1)}function z(e){let t,a=E;return E=null,t=e(),E=a,t}function ve(e){De(()=>z(e))}function Ne(e){return C===null||(C.cleanups===null?C.cleanups=[e]:C.cleanups.push(e)),e}function He(){return E}function Ge(){const e=W;if(this.sources&&(this.state||e))if(this.state===L||e)ee(this);else{const t=R;R=null,q(()=>he(this),!1),R=t}if(E){const t=this.observers?this.observers.length:0;E.sources?(E.sources.push(this),E.sourceSlots.push(t)):(E.sources=[this],E.sourceSlots=[t]),this.observers?(this.observers.push(E),this.observerSlots.push(E.sources.length-1)):(this.observers=[E],this.observerSlots=[E.sources.length-1])}return this.value}function Pe(e,t,a){let n=e.value;return(!e.comparator||!e.comparator(n,t))&&(e.value=t,e.observers&&e.observers.length&&q(()=>{for(let o=0;o<e.observers.length;o+=1){const i=e.observers[o],r=W&&W.running;r&&W.disposed.has(i),(r&&!i.tState||!r&&!i.state)&&(i.pure?R.push(i):F.push(i),i.observers&&Be(i)),r||(i.state=L)}if(R.length>1e6)throw R=[],new Error},!1)),t}function ee(e){if(!e.fn)return;Se(e);const t=C,a=E,n=Te;E=C=e,et(e,e.value,n),E=a,C=t}function et(e,t,a){let n;try{n=e.fn(t)}catch(o){e.pure&&(e.state=L),Fe(o)}(!e.updatedAt||e.updatedAt<=a)&&(e.updatedAt!=null&&"observers"in e?Pe(e,n):e.value=n,e.updatedAt=a)}function ke(e,t,a,n=L,o){const i={fn:e,state:n,updatedAt:null,owned:null,sources:null,sourceSlots:null,cleanups:null,value:t,owner:C,context:null,pure:a};return C===null||C!==Re&&(C.owned?C.owned.push(i):C.owned=[i]),i}function ce(e){const t=W;if(e.state===0||t)return;if(e.state===le||t)return he(e);if(e.suspense&&z(e.suspense.inFallback))return e.suspense.effects.push(e);const a=[e];for(;(e=e.owner)&&(!e.updatedAt||e.updatedAt<Te);)(e.state||t)&&a.push(e);for(let n=a.length-1;n>=0;n--)if(e=a[n],e.state===L||t)ee(e);else if(e.state===le||t){const o=R;R=null,q(()=>he(e,a[0]),!1),R=o}}function q(e,t){if(R)return e();let a=!1;t||(R=[]),F?a=!0:F=[],Te++;try{const n=e();return tt(a),n}catch(n){R||(F=null),Fe(n)}}function tt(e){if(R&&(Oe(R),R=null),e)return;const t=F;F=null,t.length&&q(()=>Me(t),!1)}function Oe(e){for(let t=0;t<e.length;t++)ce(e[t])}function at(e){let t,a=0;for(t=0;t<e.length;t++){const n=e[t];n.user?e[a++]=n:ce(n)}for(P.context&&Ze(),t=0;t<a;t++)ce(e[t])}function he(e,t){const a=W;e.state=0;for(let n=0;n<e.sources.length;n+=1){const o=e.sources[n];o.sources&&(o.state===L||a?o!==t&&ce(o):(o.state===le||a)&&he(o,t))}}function Be(e){const t=W;for(let a=0;a<e.observers.length;a+=1){const n=e.observers[a];(!n.state||t)&&(n.state=le,n.pure?R.push(n):F.push(n),n.observers&&Be(n))}}function Se(e){let t;if(e.sources)for(;e.sources.length;){const a=e.sources.pop(),n=e.sourceSlots.pop(),o=a.observers;if(o&&o.length){const i=o.pop(),r=a.observerSlots.pop();n<o.length&&(i.sourceSlots[r]=n,o[n]=i,a.observerSlots[n]=r)}}if(e.owned){for(t=0;t<e.owned.length;t++)Se(e.owned[t]);e.owned=null}if(e.cleanups){for(t=0;t<e.cleanups.length;t++)e.cleanups[t]();e.cleanups=null}e.state=0,e.context=null}function nt(e){return e instanceof Error||typeof e=="string"?e:new Error("Unknown error")}function Fe(e){throw e=nt(e),e}const ot=Symbol("fallback");function Ee(e){for(let t=0;t<e.length;t++)e[t]()}function it(e,t,a={}){let n=[],o=[],i=[],r=0,s=t.length>1?[]:null;return Ne(()=>Ee(i)),()=>{let h=e()||[],l,c;return h[fe],z(()=>{let f=h.length,T,k,w,A,m,g,b,v,S;if(f===0)r!==0&&(Ee(i),i=[],n=[],o=[],r=0,s&&(s=[])),a.fallback&&(n=[ot],o[0]=re(D=>(i[0]=D,a.fallback())),r=1);else if(r===0){for(o=new Array(f),c=0;c<f;c++)n[c]=h[c],o[c]=re(d);r=f}else{for(w=new Array(f),A=new Array(f),s&&(m=new Array(f)),g=0,b=Math.min(r,f);g<b&&n[g]===h[g];g++);for(b=r-1,v=f-1;b>=g&&v>=g&&n[b]===h[v];b--,v--)w[v]=o[b],A[v]=i[b],s&&(m[v]=s[b]);for(T=new Map,k=new Array(v+1),c=v;c>=g;c--)S=h[c],l=T.get(S),k[c]=l===void 0?-1:l,T.set(S,c);for(l=g;l<=b;l++)S=n[l],c=T.get(S),c!==void 0&&c!==-1?(w[c]=o[l],A[c]=i[l],s&&(m[c]=s[l]),c=k[c],T.set(S,c)):i[l]();for(c=g;c<f;c++)c in w?(o[c]=w[c],i[c]=A[c],s&&(s[c]=m[c],s[c](c))):o[c]=re(d);o=o.slice(0,r=f),n=h.slice(0)}return o});function d(f){if(i[c]=f,s){const[T,k]=x(c);return s[c]=k,t(h[c],T)}return t(h[c])}}}function y(e,t){return z(()=>e(t||{}))}function Z(e){const t="fallback"in e&&{fallback:()=>e.fallback};return I(it(()=>e.each,e.children,t||void 0))}function O(e){let t=!1;const a=e.keyed,n=I(()=>e.when,void 0,{equals:(o,i)=>t?o===i:!o==!i});return I(()=>{const o=n();if(o){const i=e.children,r=typeof i=="function"&&i.length>0;return t=a||r,r?z(()=>i(o)):i}return e.fallback})}function rt(e,t){return I(e,void 0,t?void 0:{equals:t})}function st(e,t,a){let n=a.length,o=t.length,i=n,r=0,s=0,h=t[o-1].nextSibling,l=null;for(;r<o||s<i;){if(t[r]===a[s]){r++,s++;continue}for(;t[o-1]===a[i-1];)o--,i--;if(o===r){const c=i<n?s?a[s-1].nextSibling:a[i-s]:h;for(;s<i;)e.insertBefore(a[s++],c)}else if(i===s)for(;r<o;)(!l||!l.has(t[r]))&&t[r].remove(),r++;else if(t[r]===a[i-1]&&a[s]===t[o-1]){const c=t[--o].nextSibling;e.insertBefore(a[s++],t[r++].nextSibling),e.insertBefore(a[--i],c),t[o]=a[i]}else{if(!l){l=new Map;let d=s;for(;d<i;)l.set(a[d],d++)}const c=l.get(t[r]);if(c!=null)if(s<c&&c<i){let d=r,f=1,T;for(;++d<o&&d<i&&!((T=l.get(t[d]))==null||T!==c+f);)f++;if(f>c-s){const k=t[r];for(;s<c;)e.insertBefore(a[s++],k)}else e.replaceChild(a[s++],t[r++])}else r++;else t[r++].remove()}}}const Ie="_$DX_DELEGATE";function lt(e,t,a){let n;return re(o=>{n=o,t===document?e():u(t,e(),t.firstChild?null:void 0,a)}),()=>{n(),t.textContent=""}}function p(e,t,a){const n=document.createElement("template");n.innerHTML=e;let o=n.content.firstChild;return a&&(o=o.firstChild),o}function V(e,t=window.document){const a=t[Ie]||(t[Ie]=new Set);for(let n=0,o=e.length;n<o;n++){const i=e[n];a.has(i)||(a.add(i),t.addEventListener(i,ht))}}function pe(e,t,a){a==null?e.removeAttribute(t):e.setAttribute(t,a)}function H(e,t){t==null?e.removeAttribute("class"):e.className=t}function ct(e,t,a,n){if(n)Array.isArray(a)?(e[`$$${t}`]=a[0],e[`$$${t}Data`]=a[1]):e[`$$${t}`]=a;else if(Array.isArray(a)){const o=a[0];e.addEventListener(t,a[0]=i=>o.call(e,a[1],i))}else e.addEventListener(t,a)}function j(e,t,a){return z(()=>e(t,a))}function u(e,t,a,n){if(a!==void 0&&!n&&(n=[]),typeof t!="function")return ue(e,t,n,a);M(o=>ue(e,t(),o,a),n)}function ht(e){const t=`$$${e.type}`;let a=e.composedPath&&e.composedPath()[0]||e.target;for(e.target!==a&&Object.defineProperty(e,"target",{configurable:!0,value:a}),Object.defineProperty(e,"currentTarget",{configurable:!0,get(){return a||document}}),P.registry&&!P.done&&(P.done=!0,document.querySelectorAll("[id^=pl-]").forEach(n=>n.remove()));a!==null;){const n=a[t];if(n&&!a.disabled){const o=a[`${t}Data`];if(o!==void 0?n.call(a,o,e):n.call(a,e),e.cancelBubble)return}a=a.host&&a.host!==a&&a.host instanceof Node?a.host:a.parentNode}}function ue(e,t,a,n,o){for(P.context&&!a&&(a=[...e.childNodes]);typeof a=="function";)a=a();if(t===a)return a;const i=typeof t,r=n!==void 0;if(e=r&&a[0]&&a[0].parentNode||e,i==="string"||i==="number"){if(P.context)return a;if(i==="number"&&(t=t.toString()),r){let s=a[0];s&&s.nodeType===3?s.data=t:s=document.createTextNode(t),a=U(e,a,n,s)}else a!==""&&typeof a=="string"?a=e.firstChild.data=t:a=e.textContent=t}else if(t==null||i==="boolean"){if(P.context)return a;a=U(e,a,n)}else{if(i==="function")return M(()=>{let s=t();for(;typeof s=="function";)s=s();a=ue(e,s,a,n)}),()=>a;if(Array.isArray(t)){const s=[],h=a&&Array.isArray(a);if(ge(s,t,a,o))return M(()=>a=ue(e,s,a,n,!0)),()=>a;if(P.context){if(!s.length)return a;for(let l=0;l<s.length;l++)if(s[l].parentNode)return a=s}if(s.length===0){if(a=U(e,a,n),r)return a}else h?a.length===0?Ce(e,s,n):st(e,a,s):(a&&U(e),Ce(e,s));a=s}else if(t instanceof Node){if(P.context&&t.parentNode)return a=r?[t]:t;if(Array.isArray(a)){if(r)return a=U(e,a,n,t);U(e,a,null,t)}else a==null||a===""||!e.firstChild?e.appendChild(t):e.replaceChild(t,e.firstChild);a=t}}return a}function ge(e,t,a,n){let o=!1;for(let i=0,r=t.length;i<r;i++){let s=t[i],h=a&&a[i];if(s instanceof Node)e.push(s);else if(!(s==null||s===!0||s===!1))if(Array.isArray(s))o=ge(e,s,h)||o;else if(typeof s=="function")if(n){for(;typeof s=="function";)s=s();o=ge(e,Array.isArray(s)?s:[s],Array.isArray(h)?h:[h])||o}else e.push(s),o=!0;else{const l=String(s);h&&h.nodeType===3&&h.data===l?e.push(h):e.push(document.createTextNode(l))}}return o}function Ce(e,t,a){for(let n=0,o=t.length;n<o;n++)e.insertBefore(t[n],a)}function U(e,t,a,n){if(a===void 0)return e.textContent="";const o=n||document.createTextNode("");if(t.length){let i=!1;for(let r=t.length-1;r>=0;r--){const s=t[r];if(o!==s){const h=s.parentNode===e;!i&&!r?h?e.replaceChild(o,s):e.insertBefore(o,a):h&&s.remove()}else i=!0}}else e.insertBefore(o,a);return[o]}const be=Symbol("store-raw"),X=Symbol("store-node"),ut=Symbol("store-name");function xe(e,t){let a=e[$];if(!a&&(Object.defineProperty(e,$,{value:a=new Proxy(e,yt)}),!Array.isArray(e))){const n=Object.keys(e),o=Object.getOwnPropertyDescriptors(e);for(let i=0,r=n.length;i<r;i++){const s=n[i];if(o[s].get){const h=o[s].get.bind(a);Object.defineProperty(e,s,{get:h})}}}return a}function de(e){let t;return e!=null&&typeof e=="object"&&(e[$]||!(t=Object.getPrototypeOf(e))||t===Object.prototype||Array.isArray(e))}function Q(e,t=new Set){let a,n,o,i;if(a=e!=null&&e[be])return a;if(!de(e)||t.has(e))return e;if(Array.isArray(e)){Object.isFrozen(e)?e=e.slice(0):t.add(e);for(let r=0,s=e.length;r<s;r++)o=e[r],(n=Q(o,t))!==o&&(e[r]=n)}else{Object.isFrozen(e)?e=Object.assign({},e):t.add(e);const r=Object.keys(e),s=Object.getOwnPropertyDescriptors(e);for(let h=0,l=r.length;h<l;h++)i=r[h],!s[i].get&&(o=e[i],(n=Q(o,t))!==o&&(e[i]=n))}return e}function me(e){let t=e[X];return t||Object.defineProperty(e,X,{value:t={}}),t}function we(e,t,a){return e[t]||(e[t]=We(a))}function dt(e,t){const a=Reflect.getOwnPropertyDescriptor(e,t);return!a||a.get||!a.configurable||t===$||t===X||t===ut||(delete a.value,delete a.writable,a.get=()=>e[$][t]),a}function Le(e){if(He()){const t=me(e);(t._||(t._=We()))()}}function mt(e){return Le(e),Reflect.ownKeys(e)}function We(e){const[t,a]=x(e,{equals:!1,internal:!0});return t.$=a,t}const yt={get(e,t,a){if(t===be)return e;if(t===$)return a;if(t===fe)return Le(e),a;const n=me(e),o=n.hasOwnProperty(t);let i=o?n[t]():e[t];if(t===X||t==="__proto__")return i;if(!o){const r=Object.getOwnPropertyDescriptor(e,t);He()&&(typeof i!="function"||e.hasOwnProperty(t))&&!(r&&r.get)&&(i=we(n,t,i)())}return de(i)?xe(i):i},has(e,t){if(t===be||t===$||t===fe||t===X||t==="__proto__")return!0;const a=me(e)[t];return a&&a(),t in e},set(){return!0},deleteProperty(){return!0},ownKeys:mt,getOwnPropertyDescriptor:dt};function ye(e,t,a,n=!1){if(!n&&e[t]===a)return;const o=e[t],i=e.length;a===void 0?delete e[t]:e[t]=a;let r=me(e),s;(s=we(r,t,o))&&s.$(()=>a),Array.isArray(e)&&e.length!==i&&(s=we(r,"length",i))&&s.$(e.length),(s=r._)&&s.$()}function $e(e,t){const a=Object.keys(t);for(let n=0;n<a.length;n+=1){const o=a[n];ye(e,o,t[o])}}function ft(e,t){if(typeof t=="function"&&(t=t(e)),t=Q(t),Array.isArray(t)){if(e===t)return;let a=0,n=t.length;for(;a<n;a++){const o=t[a];e[a]!==o&&ye(e,a,o)}ye(e,"length",n)}else $e(e,t)}function J(e,t,a=[]){let n,o=e;if(t.length>1){n=t.shift();const r=typeof n,s=Array.isArray(e);if(Array.isArray(n)){for(let h=0;h<n.length;h++)J(e,[n[h]].concat(t),a);return}else if(s&&r==="function"){for(let h=0;h<e.length;h++)n(e[h],h)&&J(e,[h].concat(t),a);return}else if(s&&r==="object"){const{from:h=0,to:l=e.length-1,by:c=1}=n;for(let d=h;d<=l;d+=c)J(e,[d].concat(t),a);return}else if(t.length>1){J(e[n],t,[n].concat(a));return}o=e[n],a=[n].concat(a)}let i=t[0];typeof i=="function"&&(i=i(o,a),i===o)||n===void 0&&i==null||(i=Q(i),n===void 0||de(o)&&de(i)&&!Array.isArray(i)?$e(o,i):ye(e,n,i))}function pt(...[e,t]){const a=Q(e||{}),n=Array.isArray(a),o=xe(a);function i(...r){Qe(()=>{n&&r.length===1?ft(a,r[0]):J(a,r)})}return[o,i]}const gt={user:{id:"",name:""},connected:!1,lobby:[],room:null,rooms:{},game:void 0,focus:{current:null,hover:null},chatExpanded:!1},oe=new WebSocket("wss://mondo-megabits.herokuapp.com");function N(){const[e,t]=pt(gt),a=n=>{oe.send(JSON.stringify(n))};return oe.onopen=()=>{t({connected:!0}),setInterval(()=>{a({type:"ping"})},4e4)},oe.onclose=()=>{t({connected:!1})},oe.onmessage=n=>{const{type:o,params:i}=JSON.parse(n.data);switch(o){case"connected":{t({user:{name:"",id:i.id}});break}case"lobby":{t({lobby:i.users,room:null,rooms:i.otherRooms||[]});break}case"join":{const{roomCode:r,users:s}=i;t(h=>({lobby:h.lobby.filter(l=>l.id!==h.user.id),room:{code:r,users:s,chatMessages:h.room?.chatMessages||[]}}));break}case"leave":{const{userId:r}=i;t({room:r===e.user.id?null:{...e.room,users:e.room.users.filter(s=>s.id!==r)}});break}case"leave-game":{const{roomCode:r,users:s}=i;t({game:null,room:{code:r,users:s,chatMessages:e.room?.chatMessages||[]}});break}case"chat":{if(i.chatMessage.user.id!==e.user.id){t(r=>({room:{...r.room,chatMessages:[...r.room?.chatMessages||[],i.chatMessage]}}));break}break}case"ready":{const{userId:r,status:s}=i;t(h=>({room:{...h.room,users:h.room.users.map(l=>l.id!==r?l:{...l,status:s})}}));break}case"game":{const{game:r}=i;t({game:r});break}default:{console.log("Got unknown message type: ",o);break}}},{state:e,setState:t,sendMessage:a}}const bt=p('<div class="connect"><div class="video"><video autoplay="true" loop="true" playsinline="true" muted><source type="video/mp4; codecs=&quot;av01.0.13M.10&quot;" src="https://cdn.mondomegabits.com/logo/Mondo flashing logo_r3 - strobe.mp4"></video></div><form class="puppet-master-handle-input"><label>Puppet Master Handle:</label><input type="text"><button class="connect-button button" type="submit">Connect</button></form></div>');function wt(){let e;const{sendMessage:t,setState:a}=N(),[n,o]=x("");ve(()=>{e.focus()});const i=r=>{r.preventDefault(),n().length!==0&&(t({type:"lobby",params:{userName:n()}}),a(s=>({user:{...s.user,name:n()}})))};return(()=>{const r=bt.cloneNode(!0),s=r.firstChild,h=s.nextSibling,l=h.firstChild,c=l.nextSibling;h.addEventListener("submit",i),c.addEventListener("change",f=>o(f.target.value));const d=e;return typeof d=="function"?j(d,c):e=c,M(()=>c.value=n()),r})()}const Tt=p('<button type="button"><div class="circle"></div><div class="label"></div></button>');function _({label:e,onClick:t,disabled:a,color:n,small:o}){const i=()=>{let r="circle-button button";return n&&(r+=` ${n}`),o&&(r+=" small"),a&&(r+=" disabled"),r};return(()=>{const r=Tt.cloneNode(!0),s=r.firstChild,h=s.nextSibling;return ct(r,"click",t,!0),r.disabled=a,u(h,e),M(()=>H(r,i())),r})()}V(["click"]);const vt=p('<div class="modal"><div class="join-room panel"><form><label>Room code:</label><input type="text"><div class="modal-footer"><button class="button" type="submit">OK</button><button class="button" type="button">Cancel</button></div></form></div></div>'),kt=p('<div class="lobby"><div class="rooms grunge"><div class="headers yellow"><div class="header">Code</div><div class="header">Users</div><div class="header">Status</div></div><hr class="tall"></div><div class="users"><span class="yellow">/// </span>Puppet Masters Online:<hr class="top"><ul class="list"></ul><hr class="bottom"></div><div class="footer panel"></div></div>'),St=p('<div class="room"><div class="room-code teal"></div><div class="room-users white"> / </div><div></div><div class="room-join"></div></div>'),At=p("<li></li>");function Et(){const{state:e,sendMessage:t}=N(),[a,n]=x(!1),[o,i]=x(""),r=()=>{t({type:"create"})},s=h=>{h.preventDefault();const l=o();!l||t({type:"join",params:{roomCode:l}})};return(()=>{const h=kt.cloneNode(!0),l=h.firstChild;l.firstChild.nextSibling;const d=l.nextSibling,f=d.firstChild,T=f.nextSibling,k=T.nextSibling,w=k.nextSibling,A=d.nextSibling;return u(l,y(Z,{get each(){return e.rooms},children:m=>(()=>{const g=St.cloneNode(!0),b=g.firstChild,v=b.nextSibling,S=v.firstChild,D=v.nextSibling,B=D.nextSibling;return u(b,()=>m.code),u(v,()=>m.users,S),u(v,()=>m.maxUsers,null),u(D,()=>m.status.toUpperCase()),u(B,y(_,{label:"Join",get disabled(){return m.status!=="open"},onClick:()=>{t({type:"join",params:{roomCode:m.code}})},color:"red",small:!0})),M(()=>H(D,`room-status${m.status==="full"?" red":""}`)),g})()}),null),u(w,y(Z,{get each(){return e.lobby},children:m=>(()=>{const g=At.cloneNode(!0);return u(g,()=>m.name),M(()=>H(g,m.id===e.user.id?"glow":"white")),g})()})),u(A,y(_,{label:"Create",onClick:r}),null),u(A,y(_,{label:"Join",onClick:()=>{n(!0),i("")}}),null),u(h,y(O,{get when(){return a()},get children(){const m=vt.cloneNode(!0),g=m.firstChild,b=g.firstChild,v=b.firstChild,S=v.nextSibling,D=S.nextSibling,B=D.firstChild,G=B.nextSibling;return b.addEventListener("submit",s),S.addEventListener("change",K=>i(K.target.value)),G.$$click=()=>n(!1),M(()=>B.disabled=o().length===0),M(()=>S.value=o()),m}}),null),h})()}V(["click"]);const It=p('<div class="message system"><p class="red italic"><span class="white">[ </span><span class="white"> ]</span></p><div class="message-date yellow"></div></div>'),Ct=p('<div class="chat"><div class="messages grunge"></div><form><input type="text"><button class="button" type="submit">Send</button></form></div>'),Mt=p('<div class="message"><p><span></span> </p><div class="message-date yellow"></div></div>');function ze(){let e,t;const{state:a,setState:n,sendMessage:o}=N(),[i,r]=x("");ve(()=>{t?.focus?.()}),De(()=>{!e||a.room?.chatMessages.length===0||(e.scrollTop=e.scrollHeight)});const s=l=>{l.preventDefault();const c=i();if(c.length===0)return;const d={message:c,date:new Date().toLocaleTimeString("en-US")};n(f=>({room:{...f.room,chatMessages:[...f.room.chatMessages,{...d,user:f.user}]}})),o({type:"chat",params:{roomCode:a.room.code,chatMessage:d}}),r("")},h=l=>(()=>{const c=It.cloneNode(!0),d=c.firstChild,f=d.firstChild,T=f.nextSibling,k=d.nextSibling;return u(d,()=>l.message,T),u(k,()=>l.date),c})();return(()=>{const l=Ct.cloneNode(!0),c=l.firstChild,d=c.nextSibling,f=d.firstChild,T=e;typeof T=="function"?j(T,c):e=c,u(c,y(Z,{get each(){return a.room.chatMessages},children:w=>w.user.id==="SYSTEM"?h(w):(()=>{const A=Mt.cloneNode(!0),m=A.firstChild,g=m.firstChild;g.nextSibling;const b=m.nextSibling;return u(g,()=>w.user.name),u(m,()=>w.message,null),u(b,()=>w.date),M(()=>H(g,`message-user ${w.user.id===a.user.id?"teal":"white"}`)),A})()})),d.addEventListener("submit",s),f.addEventListener("change",w=>r(w.target.value));const k=t;return typeof k=="function"?j(k,f):t=f,M(()=>f.value=i()),l})()}const Rt=p('<div class="countdown"><h1 class="white">Starting in:</h1><div class="count"><span class="glow"></span></div></div>');function Dt({from:e=5,callback:t=()=>{}}){const[a,n]=x(),[o,i]=x(e),r=()=>{!a()&&o()>0&&n(setInterval(s,1e3))},s=()=>{let h=o()-1;i(h),h===0&&(clearInterval(a()),t?.())};return ve(()=>{r()}),Ne(()=>{clearInterval(a())}),y(O,{get when(){return o()>0},get children(){const h=Rt.cloneNode(!0),l=h.firstChild,c=l.nextSibling,d=c.firstChild;return u(d,o),h}})}const Nt=p('<div class="room"><div class="main"><div class="header"><div class="room-name"><hr class="dotted-double"><h1 class="wide color-change"></h1><hr class="dotted-double"></div></div></div><div class="users"><span class="yellow">/// </span>Puppet Masters In Room:<hr class="top"><ul class="list"></ul><hr class="bottom"></div><div class="footer panel"></div></div>'),Ht=p('<li><div class="name"><span></span></div><div class="status"><div class="check"><span class="red">[</span><span class="yellow"></span><span class="red">]</span></div></div></li>');function Gt(){const[e,t]=x(!1),{state:a,sendMessage:n}=N(),o=I(()=>!a.room?.users?.find(l=>l.status!=="ready")),i=I(()=>a.room?.users?.find(l=>l.id===a.user.id&&l.status==="ready")),r=()=>{n({type:"leave"})},s=()=>{n({type:"start"})},h=()=>{const l=!i(),c=l?"ready":"waiting";n({type:"ready",params:{roomCode:a.room.code,status:c}}),t(l)};return(()=>{const l=Nt.cloneNode(!0),c=l.firstChild,d=c.firstChild,f=d.firstChild,T=f.firstChild,k=T.nextSibling,w=c.nextSibling,A=w.firstChild,m=A.nextSibling,g=m.nextSibling,b=g.nextSibling,v=w.nextSibling;return u(k,()=>a.room.code),u(d,y(O,{get when(){return o()},get children(){return y(Dt,{callback:s})}}),null),u(c,y(ze,{}),null),u(b,y(Z,{get each(){return a.room.users},children:S=>(()=>{const D=Ht.cloneNode(!0),B=D.firstChild,G=B.firstChild,K=B.nextSibling,te=K.firstChild,ae=te.firstChild,ne=ae.nextSibling;return u(G,()=>S.name),u(ne,()=>S.status==="ready"?"\u2713":" "),u(K,()=>S.status.toUpperCase(),null),M(()=>H(G,S.id===a.user.id?"glow":"white")),D})()})),u(v,y(_,{get label(){return i()?"Unready":"Ready"},onClick:h,color:"red"}),null),u(v,y(_,{label:"Leave",onClick:r}),null),l})()}const Ke=""+new URL("card-back.1c57677c.png",import.meta.url).href,Pt=[{id:1,name:"Wireless Vaccine+-",faction:"FAKE TECH",rarity:4,frameSize:"C",type:"Item",subtype:"Weapon",bodyText:`"Not feeling well? Well, maybe it's 'cause you're always on that phone."
...
Long Warp: Play one round of Rock-Paper-Scissors with your opponent. If you win, receive 1x Teleportation Token, giving you a free instant dodge from an attack of your choice. If you lose, discard the top card of your deck.`,variantId:131,fileStem:"0094a"}],Ot=e=>`https://mondomegabits.com/card/img/95/${e.fileStem}.jpg`,Bt=e=>{const t=Pt.find(a=>a.id.toString()===e.toString());return Ot(t)},Ft=e=>e.replace(/-([a-z])/g,t=>t[1].toUpperCase());const xt=p("<div draggable><img></div>");function Ue({card:e,opponent:t,location:a}){const{state:n,setState:o,sendMessage:i}=N(),r=a==="hand"&&t||e.faceDown,s=I(()=>["battle-zone","the-think-tank","buffer-zone"].includes(a)),h=()=>{t||i({type:"tap",params:{cardUuid:e.uuid,gameCode:n.game.id,roomCode:n.room.code}})},l=m=>{t||m.dataTransfer.setData("text",e.uuid)},c=()=>{t&&r||(n.focus.current?.uuid===e.uuid?d():o(m=>({focus:{...m.focus,current:e}})))},d=()=>{t&&r||o(m=>({focus:{...m.focus,current:null}}))},f=()=>{t&&r||o(m=>({focus:{...m.focus,hover:e}}))},T=()=>{t&&r||o(m=>({focus:{...m.focus,hover:null}}))},k=()=>{s()&&h()},w=m=>{switch(m.detail){case 1:c();break;case 2:k();break}},A=()=>{let m="card";return t&&(m+=" opponent"),n.focus.current?.uuid===e.uuid&&(m+=" focus"),e.tapped&&(m+=" tapped"),m};return(()=>{const m=xt.cloneNode(!0),g=m.firstChild;return m.addEventListener("dragstart",l),m.addEventListener("pointerleave",T),m.addEventListener("pointerenter",f),m.$$click=w,M(b=>{const v=A(),S=e.uuid,D=r?Ke:Bt(e.id);return v!==b._v$&&H(m,b._v$=v),S!==b._v$2&&pe(g,"id",b._v$2=S),D!==b._v$3&&pe(g,"src",b._v$3=D),b},{_v$:void 0,_v$2:void 0,_v$3:void 0}),m})()}V(["click"]);const Lt=p("<div></div>");function Ye({opponent:e}){const{state:t}=N(),a=I(()=>t.game.puppetMasters.find(({id:o})=>o===t.user.id)?.hand),n=I(()=>t.game.puppetMasters.find(({id:o})=>o!==t.user.id)?.hand);return(()=>{const o=Lt.cloneNode(!0);return H(o,`hand${e?" opponent":""}`),u(o,y(Z,{get each(){return e?n():a()},children:i=>y(Ue,{card:i,faceDown:e,opponent:e,location:"hand"})})),o})()}const Wt=p('<div class="game-header grunge"></div>');function $t(){const{state:e}=N(),t=I(()=>e.game.puppetMasters.length===1);return y(O,{get when(){return!t()},get children(){const a=Wt.cloneNode(!0);return u(a,y(Ye,{opponent:!0})),a}})}const zt=p('<div><div class="card-pile-label"></div><div class="card-back"><div class="card-count"></div><img></div></div>');function ie({name:e,cards:t,opponent:a,canView:n}){let o;const{state:i,sendMessage:r}=N(),s=d=>{d.preventDefault(),o.classList.add("drag-over")},h=()=>{o.classList.remove("drag-over")},l=d=>{d.preventDefault(),o.classList.remove("drag-over");const f=d.dataTransfer.getData("text");r({type:"move",params:{cardUuid:f,destination:e,gameCode:i.game.id,roomCode:i.room.code}})},c=()=>{switch(e){case"deck":return"Deck";case"discard-pile":return"Discard";default:return""}};return(()=>{const d=zt.cloneNode(!0),f=d.firstChild,T=f.nextSibling,k=T.firstChild,w=k.nextSibling;d.addEventListener("drop",l),d.addEventListener("dragleave",h),d.addEventListener("dragover",s);const A=o;return typeof A=="function"?j(A,d):o=d,H(d,`card-pile ${e}${a?" opponent":""}`),u(f,c),u(k,()=>t.length),pe(w,"src",Ke),M(()=>H(w,t.length===0?"empty":"")),d})()}const Kt=p('<div class="opponent"><fieldset><legend class="white"></legend><div class="stats"><div class="stat panel"><div class="stat-label">Narrative</div><div class="stat-number"></div></div><div class="stat panel"><div class="stat-label">Funding</div><div class="stat-number"></div></div></div><div class="card-piles"></div></fieldset></div>'),Ut=p('<button class="end-turn-button button">End My Turn</button>'),Yt=p('<div class="left-side-bar grunge"><div class="turn panel"><div class="turn-label"></div><div class="turn-number"></div></div><div class="me"><fieldset><legend class="white"></legend><div class="card-piles"></div><div class="stats"><div class="stat panel"><div class="stat-label">Narrative</div><div class="stat-number"></div></div><div class="stat panel"><div class="stat-label">Funding</div><div class="stat-number"></div></div></div></fieldset></div></div>');function _t(){const{state:e,sendMessage:t}=N(),a=I(()=>e.game.puppetMasters.find(({id:l})=>l===e.user.id)),n=I(()=>e.game.puppetMasters.length===1),o=I(()=>e.game.turn.player===e.user.id),i=I(()=>n()?null:e.game.puppetMasters.find(({id:l})=>l!==e.user.id)),r=l=>e.room.users.find(c=>c.id===l)?.name,s=I(()=>{if(n())return null;const l=i()?.id;return r(l)}),h=()=>{t({type:"end-turn",params:{gameCode:e.game.id,roomCode:e.room.code}})};return(()=>{const l=Yt.cloneNode(!0),c=l.firstChild,d=c.firstChild,f=d.nextSibling,T=c.nextSibling,k=T.firstChild,w=k.firstChild,A=w.nextSibling,m=A.nextSibling,g=m.firstChild,b=g.firstChild,v=b.nextSibling,S=g.nextSibling,D=S.firstChild,B=D.nextSibling;return u(l,y(O,{get when(){return!n()},get children(){const G=Kt.cloneNode(!0),K=G.firstChild,te=K.firstChild,ae=te.nextSibling,ne=ae.firstChild,_e=ne.firstChild,je=_e.nextSibling,qe=ne.nextSibling,Ve=qe.firstChild,Je=Ve.nextSibling,Ae=ae.nextSibling;return u(te,s),u(je,()=>i().narrative),u(Je,()=>i().funding),u(Ae,y(ie,{name:"deck",get cards(){return i().deck}}),null),u(Ae,y(ie,{name:"discard-pile",get cards(){return i().discardPile}}),null),G}}),c),u(d,(()=>{const G=rt(()=>!!o(),!0);return()=>G()?"Your Turn":`${s()}'s Turn`})()),u(f,()=>e.game.turn.number),u(c,y(O,{get when(){return o()},get children(){const G=Ut.cloneNode(!0);return G.$$click=h,G}}),null),u(w,()=>e.user.name),u(A,y(ie,{name:"deck",get cards(){return a().deck}}),null),u(A,y(ie,{name:"discard-pile",get cards(){return a().discardPile}}),null),u(v,()=>a().narrative),u(B,()=>a().funding),l})()}V(["click"]);const jt=p('<div class="name teal"></div>'),qt=p('<div class="cost yellow"><span class="white">Cost:</span> </div>'),Vt=p('<div class="type"><span class="white">Type:</span> </div>'),Jt=p('<div class="subtype"><span class="white">Subtype:</span> </div>'),Zt=p('<div class="faction"><span class="white">Faction:</span> </div>'),Xt=p('<div class="body-text"></div>'),Qt=p('<div class="card-focus"><div class="focused-card"></div></div>');function ea(){const{state:e}=N(),t=I(()=>e.focus.hover||e.focus.current);return(()=>{const a=Qt.cloneNode(!0),n=a.firstChild;return u(n,y(O,{get when(){return t()},get children(){return[(()=>{const o=jt.cloneNode(!0);return u(o,()=>t().name),o})(),(()=>{const o=qt.cloneNode(!0);return o.firstChild.nextSibling,u(o,()=>t().cost,null),o})(),(()=>{const o=Vt.cloneNode(!0);return o.firstChild.nextSibling,u(o,()=>t().type,null),o})(),(()=>{const o=Jt.cloneNode(!0);return o.firstChild.nextSibling,u(o,()=>t().subType,null),o})(),(()=>{const o=Zt.cloneNode(!0);return o.firstChild.nextSibling,u(o,()=>t().faction,null),o})(),(()=>{const o=Xt.cloneNode(!0);return u(o,()=>t().bodyText),o})()]}})),a})()}const ta=p('<div><div class="options"></div><div class="game-chat"><button class="expand-button button"></button></div></div>');function aa(){const{state:e,setState:t,sendMessage:a}=N(),n=()=>{a({type:"leave-game"})};return(()=>{const o=ta.cloneNode(!0),i=o.firstChild,r=i.nextSibling,s=r.firstChild;return u(i,y(_,{label:"Leave",onClick:n,small:!0})),u(o,y(ea,{}),r),s.$$click=()=>t({chatExpanded:!e.chatExpanded}),u(s,()=>e.chatExpanded?"Hide Chat":"Show Chat"),u(r,y(O,{get when(){return e.chatExpanded},get children(){return y(ze,{})}}),null),M(()=>H(o,`right-side-bar grunge${e.chatExpanded?" chat-expanded":""}`)),o})()}V(["click"]);const na=p('<div class="plasma"></div>'),oa=p("<div></div>");function ia(){return(()=>{const t=na.cloneNode(!0);return u(t,()=>[...Array(10)].map((a,n)=>(()=>{const o=oa.cloneNode(!0);return H(o,`bubble x${n+1}`),o})())),t})()}const ra=p("<div></div>");function Y({name:e,opponent:t}){let a;const{state:n,sendMessage:o}=N(),i=I(()=>{const l=n.game.puppetMasters.find(f=>t?f.id!==n.user.id:f.id===n.user.id),c=Ft(e);return l.board[c]||[]}),r=l=>{t||(l.preventDefault(),a.classList.add("drag-over"))},s=()=>{t||a.classList.remove("drag-over")},h=l=>{if(t)return;l.preventDefault(),a.classList.remove("drag-over");const c=l.dataTransfer.getData("text");o({type:"play",params:{cardUuid:c,destination:e,gameCode:n.game.id,roomCode:n.room.code}})};return(()=>{const l=ra.cloneNode(!0);l.addEventListener("drop",h),l.addEventListener("dragleave",s),l.addEventListener("dragover",r);const c=a;return typeof c=="function"?j(c,l):a=l,H(l,`zone panel grunge ${e}${t?" opponent":""}`),u(l,()=>i().map(d=>y(Ue,{card:d,opponent:t,location:e}))),l})()}const sa=p('<div class="middle grunge"></div>'),la=p("<div></div>");function ca(){let e;const{state:t}=N(),a=I(()=>t.game.puppetMasters.length===1);return(()=>{const n=la.cloneNode(!0),o=e;return typeof o=="function"?j(o,n):e=n,u(n,y(O,{get when(){return!a()},get children(){return[y(Y,{name:"the-think-tank",opponent:!0}),y(Y,{name:"buffer-zone",opponent:!0}),y(Y,{name:"battle-zone",opponent:!0}),(()=>{const i=sa.cloneNode(!0);return u(i,y(ia,{})),i})()]}}),null),u(n,y(Y,{name:"battle-zone"}),null),u(n,y(Y,{name:"buffer-zone"}),null),u(n,y(Y,{name:"the-think-tank"}),null),M(()=>H(n,`main-board ${a()?" solo-play":""}`)),n})()}const ha=p('<div class="game-footer panel grunge"></div>');function ua(){return(()=>{const e=ha.cloneNode(!0);return u(e,y(Ye,{})),e})()}const da=p('<div class="game-board"></div>');function ma(){const{state:e,setState:t}=N(),a=n=>{n.target.id!==e.focus.current?.uuid&&mainRef.contains(n.target)&&t(i=>({focus:{...i.focus,current:null}}))};return(()=>{const n=da.cloneNode(!0);return n.$$click=a,u(n,y($t,{}),null),u(n,y(_t,{}),null),u(n,y(ca,{}),null),u(n,y(aa,{}),null),u(n,y(ua,{}),null),n})()}V(["click"]);const ya=p('<div class="app"></div>'),fa=p('<div class="orientation"><h3>Please turn your device sideways to landscape mode.</h3></div>');function pa(){const{state:e}=N();screen?.orientation?.lock?.("landscape");const t=I(()=>!!e.room||!!e.lobby.find(n=>n.id===e.user.id)),a=()=>e.game?y(ma,{}):e.room?y(Gt,{}):y(Et,{});return[(()=>{const n=ya.cloneNode(!0);return u(n,y(O,{get when(){return t()},get fallback(){return y(wt,{})},get children(){return a()}})),n})(),fa.cloneNode(!0)]}lt(()=>y(pa,{}),document.getElementById("root"));
